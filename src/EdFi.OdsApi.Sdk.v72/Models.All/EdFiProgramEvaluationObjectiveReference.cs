...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_programEvaluationObjectiveReference")]
    public partial class EdFiProgramEvaluationObjectiveReference : IValidatableObject
    {
        ...
        protected EdFiProgramEvaluationObjectiveReference() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProgramEvaluationObjectiveReference" /> class.
        /// </summary>
        ...
        public EdFiProgramEvaluationObjectiveReference(long programEducationOrganizationId = default, string programEvaluationObjectiveTitle = default, string programEvaluationPeriodDescriptor = default, string programEvaluationTitle = default, string programEvaluationTypeDescriptor = default, string programName = default, string programTypeDescriptor = default, Link link = default)
        {
            ...
            {
                throw new ArgumentNullException("programEvaluationObjectiveTitle is a required property for EdFiProgramEvaluationObjectiveReference and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("programEvaluationPeriodDescriptor is a required property for EdFiProgramEvaluationObjectiveReference and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("programEvaluationTitle is a required property for EdFiProgramEvaluationObjectiveReference and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("programEvaluationTypeDescriptor is a required property for EdFiProgramEvaluationObjectiveReference and cannot be null");
            }
            this.ProgramEvaluationTypeDescriptor = programEvaluationTypeDescriptor;
            // to ensure "programName" is required (not null)
            if (programName == null)
            {
                throw new ArgumentNullException("programName is a required property for EdFiProgramEvaluationObjectiveReference and cannot be null");
            }
            this.ProgramName = programName;
            // to ensure "programTypeDescriptor" is required (not null)
            if (programTypeDescriptor == null)
            {
                throw new ArgumentNullException("programTypeDescriptor is a required property for EdFiProgramEvaluationObjectiveReference and cannot be null");
            }
