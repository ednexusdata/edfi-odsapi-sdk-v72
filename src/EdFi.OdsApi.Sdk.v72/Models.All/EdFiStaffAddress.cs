...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// EdFiStaffAddress
    /// </summary>
    public partial class EdFiStaffAddress : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ext">Extensions to the StaffAddress entity.</param>
        [JsonConstructor]
        public EdFiStaffAddress(string addressTypeDescriptor, string stateAbbreviationDescriptor, string city, string postalCode, string streetNumberName, Option<string?> localeDescriptor = default, Option<string?> apartmentRoomSuiteNumber = default, Option<string?> buildingSiteNumber = default, Option<string?> congressionalDistrict = default, Option<string?> countyFIPSCode = default, Option<bool?> doNotPublishIndicator = default, Option<string?> latitude = default, Option<string?> longitude = default, Option<string?> nameOfCounty = default, Option<List<EdFiStaffAddressPeriod>?> periods = default, Option<Object?> ext = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<EdFiStaffAddressPeriod>?> PeriodsOption { get; private set; }
        ...
        public List<EdFiStaffAddressPeriod>? Periods { get { return this.PeriodsOption; } set { this.PeriodsOption = new(value); } }
        ...
        /// <summary>
        /// Extensions to the StaffAddress entity.
        /// </summary>
        /// <value>Extensions to the StaffAddress entity.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiStaffAddress" />
    /// </summary>
    public class EdFiStaffAddressJsonConverter : JsonConverter<EdFiStaffAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="EdFiStaffAddress" />
        /// </summary>
        ...
        public override EdFiStaffAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<EdFiStaffAddressPeriod>?> periods = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "nameOfCounty":
                            ...
                            break;
                        case "periods":
                            periods = new Option<List<EdFiStaffAddressPeriod>?>(JsonSerializer.Deserialize<List<EdFiStaffAddressPeriod>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "_ext":
            ...
            if (!addressTypeDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiStaffAddress.", nameof(addressTypeDescriptor));

            if (!stateAbbreviationDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiStaffAddress.", nameof(stateAbbreviationDescriptor));

            if (!city.IsSet)
                throw new ArgumentException("Property is required for class EdFiStaffAddress.", nameof(city));

            if (!postalCode.IsSet)
                throw new ArgumentException("Property is required for class EdFiStaffAddress.", nameof(postalCode));

            if (!streetNumberName.IsSet)
                throw new ArgumentException("Property is required for class EdFiStaffAddress.", nameof(streetNumberName));

            if (addressTypeDescriptor.IsSet && addressTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(addressTypeDescriptor), "Property is not nullable for class EdFiStaffAddress.");

            if (stateAbbreviationDescriptor.IsSet && stateAbbreviationDescriptor.Value == null)
                throw new ArgumentNullException(nameof(stateAbbreviationDescriptor), "Property is not nullable for class EdFiStaffAddress.");

            if (city.IsSet && city.Value == null)
                throw new ArgumentNullException(nameof(city), "Property is not nullable for class EdFiStaffAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class EdFiStaffAddress.");

            if (streetNumberName.IsSet && streetNumberName.Value == null)
                throw new ArgumentNullException(nameof(streetNumberName), "Property is not nullable for class EdFiStaffAddress.");

            if (periods.IsSet && periods.Value == null)
                throw new ArgumentNullException(nameof(periods), "Property is not nullable for class EdFiStaffAddress.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiStaffAddress.");

            return new EdFiStaffAddress(addressTypeDescriptor.Value!, stateAbbreviationDescriptor.Value!, city.Value!, postalCode.Value!, streetNumberName.Value!, localeDescriptor, apartmentRoomSuiteNumber, buildingSiteNumber, congressionalDistrict, countyFIPSCode, doNotPublishIndicator, latitude, longitude, nameOfCounty, periods, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiStaffAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiStaffAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiStaffAddress edFiStaffAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiStaffAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiStaffAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiStaffAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiStaffAddress edFiStaffAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiStaffAddress.AddressTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStaffAddress.AddressTypeDescriptor), "Property is required for class EdFiStaffAddress.");

            if (edFiStaffAddress.StateAbbreviationDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStaffAddress.StateAbbreviationDescriptor), "Property is required for class EdFiStaffAddress.");

            if (edFiStaffAddress.City == null)
                throw new ArgumentNullException(nameof(edFiStaffAddress.City), "Property is required for class EdFiStaffAddress.");

            if (edFiStaffAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(edFiStaffAddress.PostalCode), "Property is required for class EdFiStaffAddress.");

            if (edFiStaffAddress.StreetNumberName == null)
                throw new ArgumentNullException(nameof(edFiStaffAddress.StreetNumberName), "Property is required for class EdFiStaffAddress.");

            if (edFiStaffAddress.PeriodsOption.IsSet && edFiStaffAddress.Periods == null)
                throw new ArgumentNullException(nameof(edFiStaffAddress.Periods), "Property is required for class EdFiStaffAddress.");

            if (edFiStaffAddress.ExtOption.IsSet && edFiStaffAddress.Ext == null)
                throw new ArgumentNullException(nameof(edFiStaffAddress.Ext), "Property is required for class EdFiStaffAddress.");

            writer.WriteString("addressTypeDescriptor", edFiStaffAddress.AddressTypeDescriptor);

            writer.WriteString("stateAbbreviationDescriptor", edFiStaffAddress.StateAbbreviationDescriptor);

            writer.WriteString("city", edFiStaffAddress.City);

            writer.WriteString("postalCode", edFiStaffAddress.PostalCode);

            writer.WriteString("streetNumberName", edFiStaffAddress.StreetNumberName);

            if (edFiStaffAddress.LocaleDescriptorOption.IsSet)
                if (edFiStaffAddress.LocaleDescriptorOption.Value != null)
                    writer.WriteString("localeDescriptor", edFiStaffAddress.LocaleDescriptor);
                else
                    writer.WriteNull("localeDescriptor");

            if (edFiStaffAddress.ApartmentRoomSuiteNumberOption.IsSet)
                if (edFiStaffAddress.ApartmentRoomSuiteNumberOption.Value != null)
                    writer.WriteString("apartmentRoomSuiteNumber", edFiStaffAddress.ApartmentRoomSuiteNumber);
                else
                    writer.WriteNull("apartmentRoomSuiteNumber");

            if (edFiStaffAddress.BuildingSiteNumberOption.IsSet)
                if (edFiStaffAddress.BuildingSiteNumberOption.Value != null)
                    writer.WriteString("buildingSiteNumber", edFiStaffAddress.BuildingSiteNumber);
                else
                    writer.WriteNull("buildingSiteNumber");

            if (edFiStaffAddress.CongressionalDistrictOption.IsSet)
                if (edFiStaffAddress.CongressionalDistrictOption.Value != null)
                    writer.WriteString("congressionalDistrict", edFiStaffAddress.CongressionalDistrict);
                else
                    writer.WriteNull("congressionalDistrict");

            if (edFiStaffAddress.CountyFIPSCodeOption.IsSet)
                if (edFiStaffAddress.CountyFIPSCodeOption.Value != null)
                    writer.WriteString("countyFIPSCode", edFiStaffAddress.CountyFIPSCode);
                else
                    writer.WriteNull("countyFIPSCode");

            if (edFiStaffAddress.DoNotPublishIndicatorOption.IsSet)
                if (edFiStaffAddress.DoNotPublishIndicatorOption.Value != null)
                    writer.WriteBoolean("doNotPublishIndicator", edFiStaffAddress.DoNotPublishIndicatorOption.Value!.Value);
                else
                    writer.WriteNull("doNotPublishIndicator");

            if (edFiStaffAddress.LatitudeOption.IsSet)
                if (edFiStaffAddress.LatitudeOption.Value != null)
                    writer.WriteString("latitude", edFiStaffAddress.Latitude);
                else
                    writer.WriteNull("latitude");

            if (edFiStaffAddress.LongitudeOption.IsSet)
                if (edFiStaffAddress.LongitudeOption.Value != null)
                    writer.WriteString("longitude", edFiStaffAddress.Longitude);
                else
                    writer.WriteNull("longitude");

            if (edFiStaffAddress.NameOfCountyOption.IsSet)
                if (edFiStaffAddress.NameOfCountyOption.Value != null)
                    writer.WriteString("nameOfCounty", edFiStaffAddress.NameOfCounty);
                else
                    writer.WriteNull("nameOfCounty");

            if (edFiStaffAddress.PeriodsOption.IsSet)
            {
                writer.WritePropertyName("periods");
                JsonSerializer.Serialize(writer, edFiStaffAddress.Periods, jsonSerializerOptions);
            }
            if (edFiStaffAddress.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiStaffAddress.Ext, jsonSerializerOptions);
            }
        }
    }
}
