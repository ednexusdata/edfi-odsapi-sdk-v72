...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    public partial class TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey(Option<DateOnly?> beginDate = default, Option<long?> educationOrganizationId = default, Option<long?> programEducationOrganizationId = default, Option<string?> programName = default, Option<string?> programTypeDescriptor = default, Option<string?> studentUniqueId = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey" />
    /// </summary>
    public class TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKeyJsonConverter : JsonConverter<TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey" />
        /// </summary>
        ...
        public override TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (beginDate.IsSet && beginDate.Value == null)
                throw new ArgumentNullException(nameof(beginDate), "Property is not nullable for class TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.");

            if (educationOrganizationId.IsSet && educationOrganizationId.Value == null)
                throw new ArgumentNullException(nameof(educationOrganizationId), "Property is not nullable for class TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.");

            if (programEducationOrganizationId.IsSet && programEducationOrganizationId.Value == null)
                throw new ArgumentNullException(nameof(programEducationOrganizationId), "Property is not nullable for class TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.");

            if (programName.IsSet && programName.Value == null)
                throw new ArgumentNullException(nameof(programName), "Property is not nullable for class TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.");

            if (programTypeDescriptor.IsSet && programTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(programTypeDescriptor), "Property is not nullable for class TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.");

            if (studentUniqueId.IsSet && studentUniqueId.Value == null)
                throw new ArgumentNullException(nameof(studentUniqueId), "Property is not nullable for class TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.");

            return new TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey(beginDate, educationOrganizationId, programEducationOrganizationId, programName, programTypeDescriptor, studentUniqueId);
        }

        /// <summary>
        /// Serializes a <see cref="TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey, JsonSerializerOptions jsonSerializerOptions)
        {
            if (trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.ProgramNameOption.IsSet && trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.ProgramName == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.ProgramName), "Property is required for class TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.");

            if (trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.ProgramTypeDescriptorOption.IsSet && trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.ProgramTypeDescriptor == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.ProgramTypeDescriptor), "Property is required for class TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.");

            if (trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.StudentUniqueIdOption.IsSet && trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.StudentUniqueId == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.StudentUniqueId), "Property is required for class TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.");

            if (trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.BeginDateOption.IsSet)
                writer.WriteString("beginDate", trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.BeginDateOption.Value!.Value.ToString(BeginDateFormat));

            if (trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.EducationOrganizationIdOption.IsSet)
                writer.WriteNumber("educationOrganizationId", trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.EducationOrganizationIdOption.Value!.Value);

            if (trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.ProgramEducationOrganizationIdOption.IsSet)
                writer.WriteNumber("programEducationOrganizationId", trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.ProgramEducationOrganizationIdOption.Value!.Value);

            if (trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.ProgramNameOption.IsSet)
                writer.WriteString("programName", trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.ProgramName);

            if (trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.ProgramTypeDescriptorOption.IsSet)
                writer.WriteString("programTypeDescriptor", trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.ProgramTypeDescriptor);

            if (trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.StudentUniqueIdOption.IsSet)
                writer.WriteString("studentUniqueId", trackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKey.StudentUniqueId);
        }
    }
}
