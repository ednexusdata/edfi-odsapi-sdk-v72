...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    public partial class EdFiStudentAcademicRecordRecognition : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Extensions to the StudentAcademicRecordRecognition entity.
        /// </summary>
        /// <value>Extensions to the StudentAcademicRecordRecognition entity.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiStudentAcademicRecordRecognition" />
    /// </summary>
    public class EdFiStudentAcademicRecordRecognitionJsonConverter : JsonConverter<EdFiStudentAcademicRecordRecognition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="EdFiStudentAcademicRecordRecognition" />
        /// </summary>
        ...
        public override EdFiStudentAcademicRecordRecognition Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!recognitionTypeDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiStudentAcademicRecordRecognition.", nameof(recognitionTypeDescriptor));

            if (recognitionTypeDescriptor.IsSet && recognitionTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(recognitionTypeDescriptor), "Property is not nullable for class EdFiStudentAcademicRecordRecognition.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiStudentAcademicRecordRecognition.");

            return new EdFiStudentAcademicRecordRecognition(recognitionTypeDescriptor.Value!, achievementCategoryDescriptor, achievementCategorySystem, achievementTitle, criteria, criteriaURL, evidenceStatement, imageURL, issuerName, issuerOriginURL, recognitionAwardDate, recognitionAwardExpiresDate, recognitionDescription, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiStudentAcademicRecordRecognition" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiStudentAcademicRecordRecognition"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiStudentAcademicRecordRecognition edFiStudentAcademicRecordRecognition, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiStudentAcademicRecordRecognition, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiStudentAcademicRecordRecognition" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiStudentAcademicRecordRecognition"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentAcademicRecordRecognition edFiStudentAcademicRecordRecognition, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiStudentAcademicRecordRecognition.RecognitionTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentAcademicRecordRecognition.RecognitionTypeDescriptor), "Property is required for class EdFiStudentAcademicRecordRecognition.");

            if (edFiStudentAcademicRecordRecognition.ExtOption.IsSet && edFiStudentAcademicRecordRecognition.Ext == null)
                throw new ArgumentNullException(nameof(edFiStudentAcademicRecordRecognition.Ext), "Property is required for class EdFiStudentAcademicRecordRecognition.");

            writer.WriteString("recognitionTypeDescriptor", edFiStudentAcademicRecordRecognition.RecognitionTypeDescriptor);

            if (edFiStudentAcademicRecordRecognition.AchievementCategoryDescriptorOption.IsSet)
                if (edFiStudentAcademicRecordRecognition.AchievementCategoryDescriptorOption.Value != null)
                    writer.WriteString("achievementCategoryDescriptor", edFiStudentAcademicRecordRecognition.AchievementCategoryDescriptor);
                else
                    writer.WriteNull("achievementCategoryDescriptor");

            if (edFiStudentAcademicRecordRecognition.AchievementCategorySystemOption.IsSet)
                if (edFiStudentAcademicRecordRecognition.AchievementCategorySystemOption.Value != null)
                    writer.WriteString("achievementCategorySystem", edFiStudentAcademicRecordRecognition.AchievementCategorySystem);
                else
                    writer.WriteNull("achievementCategorySystem");

            if (edFiStudentAcademicRecordRecognition.AchievementTitleOption.IsSet)
                if (edFiStudentAcademicRecordRecognition.AchievementTitleOption.Value != null)
                    writer.WriteString("achievementTitle", edFiStudentAcademicRecordRecognition.AchievementTitle);
                else
                    writer.WriteNull("achievementTitle");

            if (edFiStudentAcademicRecordRecognition.CriteriaOption.IsSet)
                if (edFiStudentAcademicRecordRecognition.CriteriaOption.Value != null)
                    writer.WriteString("criteria", edFiStudentAcademicRecordRecognition.Criteria);
                else
                    writer.WriteNull("criteria");

            if (edFiStudentAcademicRecordRecognition.CriteriaURLOption.IsSet)
                if (edFiStudentAcademicRecordRecognition.CriteriaURLOption.Value != null)
                    writer.WriteString("criteriaURL", edFiStudentAcademicRecordRecognition.CriteriaURL);
                else
                    writer.WriteNull("criteriaURL");

            if (edFiStudentAcademicRecordRecognition.EvidenceStatementOption.IsSet)
                if (edFiStudentAcademicRecordRecognition.EvidenceStatementOption.Value != null)
                    writer.WriteString("evidenceStatement", edFiStudentAcademicRecordRecognition.EvidenceStatement);
                else
                    writer.WriteNull("evidenceStatement");

            if (edFiStudentAcademicRecordRecognition.ImageURLOption.IsSet)
                if (edFiStudentAcademicRecordRecognition.ImageURLOption.Value != null)
                    writer.WriteString("imageURL", edFiStudentAcademicRecordRecognition.ImageURL);
                else
                    writer.WriteNull("imageURL");

            if (edFiStudentAcademicRecordRecognition.IssuerNameOption.IsSet)
                if (edFiStudentAcademicRecordRecognition.IssuerNameOption.Value != null)
                    writer.WriteString("issuerName", edFiStudentAcademicRecordRecognition.IssuerName);
                else
                    writer.WriteNull("issuerName");

            if (edFiStudentAcademicRecordRecognition.IssuerOriginURLOption.IsSet)
                if (edFiStudentAcademicRecordRecognition.IssuerOriginURLOption.Value != null)
                    writer.WriteString("issuerOriginURL", edFiStudentAcademicRecordRecognition.IssuerOriginURL);
                else
                    writer.WriteNull("issuerOriginURL");

            if (edFiStudentAcademicRecordRecognition.RecognitionAwardDateOption.IsSet)
                if (edFiStudentAcademicRecordRecognition.RecognitionAwardDateOption.Value != null)
                    writer.WriteString("recognitionAwardDate", edFiStudentAcademicRecordRecognition.RecognitionAwardDateOption.Value!.Value.ToString(RecognitionAwardDateFormat));
                else
                    writer.WriteNull("recognitionAwardDate");

            if (edFiStudentAcademicRecordRecognition.RecognitionAwardExpiresDateOption.IsSet)
                if (edFiStudentAcademicRecordRecognition.RecognitionAwardExpiresDateOption.Value != null)
                    writer.WriteString("recognitionAwardExpiresDate", edFiStudentAcademicRecordRecognition.RecognitionAwardExpiresDateOption.Value!.Value.ToString(RecognitionAwardExpiresDateFormat));
                else
                    writer.WriteNull("recognitionAwardExpiresDate");

            if (edFiStudentAcademicRecordRecognition.RecognitionDescriptionOption.IsSet)
                if (edFiStudentAcademicRecordRecognition.RecognitionDescriptionOption.Value != null)
                    writer.WriteString("recognitionDescription", edFiStudentAcademicRecordRecognition.RecognitionDescription);
                else
                    writer.WriteNull("recognitionDescription");

            if (edFiStudentAcademicRecordRecognition.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiStudentAcademicRecordRecognition.Ext, jsonSerializerOptions);
            }
        }
    }
}
