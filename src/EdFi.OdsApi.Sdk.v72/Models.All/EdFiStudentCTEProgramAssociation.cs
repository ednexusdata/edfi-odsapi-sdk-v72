...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiStudentCTEProgramAssociation : IValidatableObject
    {
        ...
        public EdFiStudentCTEProgramAssociation(string id = default, DateOnly beginDate = default, EdFiEducationOrganizationReference educationOrganizationReference = default, EdFiProgramReference programReference = default, EdFiStudentReference studentReference = default, List<EdFiStudentCTEProgramAssociationCTEProgramService> cteProgramServices = default, DateOnly? endDate = default, bool? nonTraditionalGenderStatus = default, bool? privateCTEProgram = default, List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus> programParticipationStatuses = default, string reasonExitedDescriptor = default, bool? servedOutsideOfRegularSession = default, string technicalSkillsAssessmentDescriptor = default, string etag = default, DateTime lastModifiedDate = default, Object ext = default)
        {
