...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    public partial class TrackedChangesEdFiCourseOfferingKey : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public TrackedChangesEdFiCourseOfferingKey(Option<string?> localCourseCode = default, Option<long?> schoolId = default, Option<int?> schoolYear = default, Option<string?> sessionName = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="TrackedChangesEdFiCourseOfferingKey" />
    /// </summary>
    public class TrackedChangesEdFiCourseOfferingKeyJsonConverter : JsonConverter<TrackedChangesEdFiCourseOfferingKey>
    {
        /// <summary>
        /// Deserializes json to <see cref="TrackedChangesEdFiCourseOfferingKey" />
        /// </summary>
        ...
        public override TrackedChangesEdFiCourseOfferingKey Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (localCourseCode.IsSet && localCourseCode.Value == null)
                throw new ArgumentNullException(nameof(localCourseCode), "Property is not nullable for class TrackedChangesEdFiCourseOfferingKey.");

            if (schoolId.IsSet && schoolId.Value == null)
                throw new ArgumentNullException(nameof(schoolId), "Property is not nullable for class TrackedChangesEdFiCourseOfferingKey.");

            if (schoolYear.IsSet && schoolYear.Value == null)
                throw new ArgumentNullException(nameof(schoolYear), "Property is not nullable for class TrackedChangesEdFiCourseOfferingKey.");

            if (sessionName.IsSet && sessionName.Value == null)
                throw new ArgumentNullException(nameof(sessionName), "Property is not nullable for class TrackedChangesEdFiCourseOfferingKey.");

            return new TrackedChangesEdFiCourseOfferingKey(localCourseCode, schoolId, schoolYear, sessionName);
        }

        /// <summary>
        /// Serializes a <see cref="TrackedChangesEdFiCourseOfferingKey" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="trackedChangesEdFiCourseOfferingKey"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TrackedChangesEdFiCourseOfferingKey trackedChangesEdFiCourseOfferingKey, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, trackedChangesEdFiCourseOfferingKey, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TrackedChangesEdFiCourseOfferingKey" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="trackedChangesEdFiCourseOfferingKey"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TrackedChangesEdFiCourseOfferingKey trackedChangesEdFiCourseOfferingKey, JsonSerializerOptions jsonSerializerOptions)
        {
            if (trackedChangesEdFiCourseOfferingKey.LocalCourseCodeOption.IsSet && trackedChangesEdFiCourseOfferingKey.LocalCourseCode == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiCourseOfferingKey.LocalCourseCode), "Property is required for class TrackedChangesEdFiCourseOfferingKey.");

            if (trackedChangesEdFiCourseOfferingKey.SessionNameOption.IsSet && trackedChangesEdFiCourseOfferingKey.SessionName == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiCourseOfferingKey.SessionName), "Property is required for class TrackedChangesEdFiCourseOfferingKey.");

            if (trackedChangesEdFiCourseOfferingKey.LocalCourseCodeOption.IsSet)
                writer.WriteString("localCourseCode", trackedChangesEdFiCourseOfferingKey.LocalCourseCode);

            if (trackedChangesEdFiCourseOfferingKey.SchoolIdOption.IsSet)
                writer.WriteNumber("schoolId", trackedChangesEdFiCourseOfferingKey.SchoolIdOption.Value!.Value);

            if (trackedChangesEdFiCourseOfferingKey.SchoolYearOption.IsSet)
                writer.WriteNumber("schoolYear", trackedChangesEdFiCourseOfferingKey.SchoolYearOption.Value!.Value);

            if (trackedChangesEdFiCourseOfferingKey.SessionNameOption.IsSet)
                writer.WriteString("sessionName", trackedChangesEdFiCourseOfferingKey.SessionName);
        }
    }
}
