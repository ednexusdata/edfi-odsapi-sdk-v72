...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    public partial class EdFiStudentAssessmentPerformanceLevel : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ext">Extensions to the StudentAssessmentPerformanceLevel entity.</param>
        [JsonConstructor]
        public EdFiStudentAssessmentPerformanceLevel(string assessmentReportingMethodDescriptor, string performanceLevelDescriptor, Option<string?> performanceLevelIndicatorName = default, Option<Object?> ext = default)
        {
        ...
        /// <summary>
        /// Extensions to the StudentAssessmentPerformanceLevel entity.
        /// </summary>
        /// <value>Extensions to the StudentAssessmentPerformanceLevel entity.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiStudentAssessmentPerformanceLevel" />
    /// </summary>
    public class EdFiStudentAssessmentPerformanceLevelJsonConverter : JsonConverter<EdFiStudentAssessmentPerformanceLevel>
    {
        /// <summary>
        /// Deserializes json to <see cref="EdFiStudentAssessmentPerformanceLevel" />
        /// </summary>
        ...
        public override EdFiStudentAssessmentPerformanceLevel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!assessmentReportingMethodDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiStudentAssessmentPerformanceLevel.", nameof(assessmentReportingMethodDescriptor));

            if (!performanceLevelDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiStudentAssessmentPerformanceLevel.", nameof(performanceLevelDescriptor));

            if (assessmentReportingMethodDescriptor.IsSet && assessmentReportingMethodDescriptor.Value == null)
                throw new ArgumentNullException(nameof(assessmentReportingMethodDescriptor), "Property is not nullable for class EdFiStudentAssessmentPerformanceLevel.");

            if (performanceLevelDescriptor.IsSet && performanceLevelDescriptor.Value == null)
                throw new ArgumentNullException(nameof(performanceLevelDescriptor), "Property is not nullable for class EdFiStudentAssessmentPerformanceLevel.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiStudentAssessmentPerformanceLevel.");

            return new EdFiStudentAssessmentPerformanceLevel(assessmentReportingMethodDescriptor.Value!, performanceLevelDescriptor.Value!, performanceLevelIndicatorName, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiStudentAssessmentPerformanceLevel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiStudentAssessmentPerformanceLevel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiStudentAssessmentPerformanceLevel edFiStudentAssessmentPerformanceLevel, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiStudentAssessmentPerformanceLevel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiStudentAssessmentPerformanceLevel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiStudentAssessmentPerformanceLevel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentAssessmentPerformanceLevel edFiStudentAssessmentPerformanceLevel, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiStudentAssessmentPerformanceLevel.AssessmentReportingMethodDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentAssessmentPerformanceLevel.AssessmentReportingMethodDescriptor), "Property is required for class EdFiStudentAssessmentPerformanceLevel.");

            if (edFiStudentAssessmentPerformanceLevel.PerformanceLevelDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentAssessmentPerformanceLevel.PerformanceLevelDescriptor), "Property is required for class EdFiStudentAssessmentPerformanceLevel.");

            if (edFiStudentAssessmentPerformanceLevel.ExtOption.IsSet && edFiStudentAssessmentPerformanceLevel.Ext == null)
                throw new ArgumentNullException(nameof(edFiStudentAssessmentPerformanceLevel.Ext), "Property is required for class EdFiStudentAssessmentPerformanceLevel.");

            writer.WriteString("assessmentReportingMethodDescriptor", edFiStudentAssessmentPerformanceLevel.AssessmentReportingMethodDescriptor);

            writer.WriteString("performanceLevelDescriptor", edFiStudentAssessmentPerformanceLevel.PerformanceLevelDescriptor);

            if (edFiStudentAssessmentPerformanceLevel.PerformanceLevelIndicatorNameOption.IsSet)
                if (edFiStudentAssessmentPerformanceLevel.PerformanceLevelIndicatorNameOption.Value != null)
                    writer.WriteString("performanceLevelIndicatorName", edFiStudentAssessmentPerformanceLevel.PerformanceLevelIndicatorName);
                else
                    writer.WriteNull("performanceLevelIndicatorName");

            if (edFiStudentAssessmentPerformanceLevel.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiStudentAssessmentPerformanceLevel.Ext, jsonSerializerOptions);
            }
        }
    }
}
