...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiCommunityOrganization : IValidatableObject
    {
        ...
        /// <param name="communityOrganizationId">The identifier assigned to a community organization. It must be distinct from any other identifier assigned to educational organizations, such as a LocalEducationAgencyId, to prevent duplication. (required).</param>
        ...
        public EdFiCommunityOrganization(string id = default, List<EdFiEducationOrganizationCategory> categories = default, long communityOrganizationId = default, List<EdFiEducationOrganizationAddress> addresses = default, List<EdFiEducationOrganizationIdentificationCode> identificationCodes = default, List<EdFiEducationOrganizationIndicator> indicators = default, List<EdFiEducationOrganizationInstitutionTelephone> institutionTelephones = default, List<EdFiEducationOrganizationInternationalAddress> internationalAddresses = default, string nameOfInstitution = default, string operationalStatusDescriptor = default, string shortNameOfInstitution = default, string webSite = default, string etag = default, DateTime lastModifiedDate = default, Object ext = default)
        {
