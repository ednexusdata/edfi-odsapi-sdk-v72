...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class TrackedChangesEdFiSurveySectionResponseKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiSurveySectionResponseKey(string varNamespace = default, string surveyIdentifier = default, string surveyResponseIdentifier = default, string surveySectionTitle = default)
        {
