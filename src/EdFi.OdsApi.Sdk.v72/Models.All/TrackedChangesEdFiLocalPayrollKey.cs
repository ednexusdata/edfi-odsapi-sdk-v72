...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class TrackedChangesEdFiLocalPayrollKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiLocalPayrollKey(DateOnly asOfDate = default, string accountIdentifier = default, long educationOrganizationId = default, int fiscalYear = default, string staffUniqueId = default)
        {
