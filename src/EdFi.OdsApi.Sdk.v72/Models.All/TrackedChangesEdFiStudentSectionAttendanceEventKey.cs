...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentSectionAttendanceEventKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiStudentSectionAttendanceEventKey(string attendanceEventCategoryDescriptor = default, DateOnly eventDate = default, string localCourseCode = default, long schoolId = default, int schoolYear = default, string sectionIdentifier = default, string sessionName = default, string studentUniqueId = default)
        {
