...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// <summary>
    /// A Json converter for type <see cref="TrackedChangesEdFiStudentSectionAttendanceEventKey" />
    /// </summary>
    public class TrackedChangesEdFiStudentSectionAttendanceEventKeyJsonConverter : JsonConverter<TrackedChangesEdFiStudentSectionAttendanceEventKey>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="TrackedChangesEdFiStudentSectionAttendanceEventKey" />
        /// </summary>
        ...
        public override TrackedChangesEdFiStudentSectionAttendanceEventKey Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (attendanceEventCategoryDescriptor.IsSet && attendanceEventCategoryDescriptor.Value == null)
                throw new ArgumentNullException(nameof(attendanceEventCategoryDescriptor), "Property is not nullable for class TrackedChangesEdFiStudentSectionAttendanceEventKey.");

            if (eventDate.IsSet && eventDate.Value == null)
                throw new ArgumentNullException(nameof(eventDate), "Property is not nullable for class TrackedChangesEdFiStudentSectionAttendanceEventKey.");

            if (localCourseCode.IsSet && localCourseCode.Value == null)
                throw new ArgumentNullException(nameof(localCourseCode), "Property is not nullable for class TrackedChangesEdFiStudentSectionAttendanceEventKey.");

            if (schoolId.IsSet && schoolId.Value == null)
                throw new ArgumentNullException(nameof(schoolId), "Property is not nullable for class TrackedChangesEdFiStudentSectionAttendanceEventKey.");

            if (schoolYear.IsSet && schoolYear.Value == null)
                throw new ArgumentNullException(nameof(schoolYear), "Property is not nullable for class TrackedChangesEdFiStudentSectionAttendanceEventKey.");

            if (sectionIdentifier.IsSet && sectionIdentifier.Value == null)
                throw new ArgumentNullException(nameof(sectionIdentifier), "Property is not nullable for class TrackedChangesEdFiStudentSectionAttendanceEventKey.");

            if (sessionName.IsSet && sessionName.Value == null)
                throw new ArgumentNullException(nameof(sessionName), "Property is not nullable for class TrackedChangesEdFiStudentSectionAttendanceEventKey.");

            if (studentUniqueId.IsSet && studentUniqueId.Value == null)
                throw new ArgumentNullException(nameof(studentUniqueId), "Property is not nullable for class TrackedChangesEdFiStudentSectionAttendanceEventKey.");

            return new TrackedChangesEdFiStudentSectionAttendanceEventKey(attendanceEventCategoryDescriptor, eventDate, localCourseCode, schoolId, schoolYear, sectionIdentifier, sessionName, studentUniqueId);
        }

        /// <summary>
        /// Serializes a <see cref="TrackedChangesEdFiStudentSectionAttendanceEventKey" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="trackedChangesEdFiStudentSectionAttendanceEventKey"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TrackedChangesEdFiStudentSectionAttendanceEventKey trackedChangesEdFiStudentSectionAttendanceEventKey, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, trackedChangesEdFiStudentSectionAttendanceEventKey, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TrackedChangesEdFiStudentSectionAttendanceEventKey" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="trackedChangesEdFiStudentSectionAttendanceEventKey"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TrackedChangesEdFiStudentSectionAttendanceEventKey trackedChangesEdFiStudentSectionAttendanceEventKey, JsonSerializerOptions jsonSerializerOptions)
        {
            if (trackedChangesEdFiStudentSectionAttendanceEventKey.AttendanceEventCategoryDescriptorOption.IsSet && trackedChangesEdFiStudentSectionAttendanceEventKey.AttendanceEventCategoryDescriptor == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiStudentSectionAttendanceEventKey.AttendanceEventCategoryDescriptor), "Property is required for class TrackedChangesEdFiStudentSectionAttendanceEventKey.");

            if (trackedChangesEdFiStudentSectionAttendanceEventKey.LocalCourseCodeOption.IsSet && trackedChangesEdFiStudentSectionAttendanceEventKey.LocalCourseCode == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiStudentSectionAttendanceEventKey.LocalCourseCode), "Property is required for class TrackedChangesEdFiStudentSectionAttendanceEventKey.");

            if (trackedChangesEdFiStudentSectionAttendanceEventKey.SectionIdentifierOption.IsSet && trackedChangesEdFiStudentSectionAttendanceEventKey.SectionIdentifier == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiStudentSectionAttendanceEventKey.SectionIdentifier), "Property is required for class TrackedChangesEdFiStudentSectionAttendanceEventKey.");

            if (trackedChangesEdFiStudentSectionAttendanceEventKey.SessionNameOption.IsSet && trackedChangesEdFiStudentSectionAttendanceEventKey.SessionName == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiStudentSectionAttendanceEventKey.SessionName), "Property is required for class TrackedChangesEdFiStudentSectionAttendanceEventKey.");

            if (trackedChangesEdFiStudentSectionAttendanceEventKey.StudentUniqueIdOption.IsSet && trackedChangesEdFiStudentSectionAttendanceEventKey.StudentUniqueId == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiStudentSectionAttendanceEventKey.StudentUniqueId), "Property is required for class TrackedChangesEdFiStudentSectionAttendanceEventKey.");

            if (trackedChangesEdFiStudentSectionAttendanceEventKey.AttendanceEventCategoryDescriptorOption.IsSet)
                writer.WriteString("attendanceEventCategoryDescriptor", trackedChangesEdFiStudentSectionAttendanceEventKey.AttendanceEventCategoryDescriptor);

            if (trackedChangesEdFiStudentSectionAttendanceEventKey.EventDateOption.IsSet)
                writer.WriteString("eventDate", trackedChangesEdFiStudentSectionAttendanceEventKey.EventDateOption.Value!.Value.ToString(EventDateFormat));

            if (trackedChangesEdFiStudentSectionAttendanceEventKey.LocalCourseCodeOption.IsSet)
                writer.WriteString("localCourseCode", trackedChangesEdFiStudentSectionAttendanceEventKey.LocalCourseCode);

            if (trackedChangesEdFiStudentSectionAttendanceEventKey.SchoolIdOption.IsSet)
                writer.WriteNumber("schoolId", trackedChangesEdFiStudentSectionAttendanceEventKey.SchoolIdOption.Value!.Value);

            if (trackedChangesEdFiStudentSectionAttendanceEventKey.SchoolYearOption.IsSet)
                writer.WriteNumber("schoolYear", trackedChangesEdFiStudentSectionAttendanceEventKey.SchoolYearOption.Value!.Value);

            if (trackedChangesEdFiStudentSectionAttendanceEventKey.SectionIdentifierOption.IsSet)
                writer.WriteString("sectionIdentifier", trackedChangesEdFiStudentSectionAttendanceEventKey.SectionIdentifier);

            if (trackedChangesEdFiStudentSectionAttendanceEventKey.SessionNameOption.IsSet)
                writer.WriteString("sessionName", trackedChangesEdFiStudentSectionAttendanceEventKey.SessionName);

            if (trackedChangesEdFiStudentSectionAttendanceEventKey.StudentUniqueIdOption.IsSet)
                writer.WriteString("studentUniqueId", trackedChangesEdFiStudentSectionAttendanceEventKey.StudentUniqueId);
        }
    }
}
