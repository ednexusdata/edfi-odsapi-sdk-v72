...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    public partial class EdFiStaffElectronicMail : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ext">Extensions to the StaffElectronicMail entity.</param>
        [JsonConstructor]
        public EdFiStaffElectronicMail(string electronicMailTypeDescriptor, string electronicMailAddress, Option<bool?> doNotPublishIndicator = default, Option<bool?> primaryEmailAddressIndicator = default, Option<Object?> ext = default)
        {
        ...
        /// <summary>
        /// Extensions to the StaffElectronicMail entity.
        /// </summary>
        /// <value>Extensions to the StaffElectronicMail entity.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiStaffElectronicMail" />
    /// </summary>
    public class EdFiStaffElectronicMailJsonConverter : JsonConverter<EdFiStaffElectronicMail>
    {
        /// <summary>
        /// Deserializes json to <see cref="EdFiStaffElectronicMail" />
        /// </summary>
        ...
        public override EdFiStaffElectronicMail Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!electronicMailTypeDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiStaffElectronicMail.", nameof(electronicMailTypeDescriptor));

            if (!electronicMailAddress.IsSet)
                throw new ArgumentException("Property is required for class EdFiStaffElectronicMail.", nameof(electronicMailAddress));

            if (electronicMailTypeDescriptor.IsSet && electronicMailTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(electronicMailTypeDescriptor), "Property is not nullable for class EdFiStaffElectronicMail.");

            if (electronicMailAddress.IsSet && electronicMailAddress.Value == null)
                throw new ArgumentNullException(nameof(electronicMailAddress), "Property is not nullable for class EdFiStaffElectronicMail.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiStaffElectronicMail.");

            return new EdFiStaffElectronicMail(electronicMailTypeDescriptor.Value!, electronicMailAddress.Value!, doNotPublishIndicator, primaryEmailAddressIndicator, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiStaffElectronicMail" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiStaffElectronicMail"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiStaffElectronicMail edFiStaffElectronicMail, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiStaffElectronicMail, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiStaffElectronicMail" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiStaffElectronicMail"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiStaffElectronicMail edFiStaffElectronicMail, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiStaffElectronicMail.ElectronicMailTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStaffElectronicMail.ElectronicMailTypeDescriptor), "Property is required for class EdFiStaffElectronicMail.");

            if (edFiStaffElectronicMail.ElectronicMailAddress == null)
                throw new ArgumentNullException(nameof(edFiStaffElectronicMail.ElectronicMailAddress), "Property is required for class EdFiStaffElectronicMail.");

            if (edFiStaffElectronicMail.ExtOption.IsSet && edFiStaffElectronicMail.Ext == null)
                throw new ArgumentNullException(nameof(edFiStaffElectronicMail.Ext), "Property is required for class EdFiStaffElectronicMail.");

            writer.WriteString("electronicMailTypeDescriptor", edFiStaffElectronicMail.ElectronicMailTypeDescriptor);

            writer.WriteString("electronicMailAddress", edFiStaffElectronicMail.ElectronicMailAddress);

            if (edFiStaffElectronicMail.DoNotPublishIndicatorOption.IsSet)
                if (edFiStaffElectronicMail.DoNotPublishIndicatorOption.Value != null)
                    writer.WriteBoolean("doNotPublishIndicator", edFiStaffElectronicMail.DoNotPublishIndicatorOption.Value!.Value);
                else
                    writer.WriteNull("doNotPublishIndicator");

            if (edFiStaffElectronicMail.PrimaryEmailAddressIndicatorOption.IsSet)
                if (edFiStaffElectronicMail.PrimaryEmailAddressIndicatorOption.Value != null)
                    writer.WriteBoolean("primaryEmailAddressIndicator", edFiStaffElectronicMail.PrimaryEmailAddressIndicatorOption.Value!.Value);
                else
                    writer.WriteNull("primaryEmailAddressIndicator");

            if (edFiStaffElectronicMail.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiStaffElectronicMail.Ext, jsonSerializerOptions);
            }
        }
    }
}
