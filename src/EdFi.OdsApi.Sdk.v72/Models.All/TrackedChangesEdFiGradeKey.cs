...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class TrackedChangesEdFiGradeKey : IValidatableObject
    {
        ...
        /// <summary>
        /// Used to track the state of GradeTypeDescriptor
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> GradeTypeDescriptorOption { get; private set; }
        ...
        public string? GradeTypeDescriptor { get { return this.GradeTypeDescriptorOption; } set { this.GradeTypeDescriptorOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="TrackedChangesEdFiGradeKey" />
    /// </summary>
    public class TrackedChangesEdFiGradeKeyJsonConverter : JsonConverter<TrackedChangesEdFiGradeKey>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="TrackedChangesEdFiGradeKey" />
        /// </summary>
        ...
        public override TrackedChangesEdFiGradeKey Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (gradeTypeDescriptor.IsSet && gradeTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(gradeTypeDescriptor), "Property is not nullable for class TrackedChangesEdFiGradeKey.");

            if (gradingPeriodDescriptor.IsSet && gradingPeriodDescriptor.Value == null)
                throw new ArgumentNullException(nameof(gradingPeriodDescriptor), "Property is not nullable for class TrackedChangesEdFiGradeKey.");

            if (gradingPeriodName.IsSet && gradingPeriodName.Value == null)
                throw new ArgumentNullException(nameof(gradingPeriodName), "Property is not nullable for class TrackedChangesEdFiGradeKey.");

            if (schoolId.IsSet && schoolId.Value == null)
                throw new ArgumentNullException(nameof(schoolId), "Property is not nullable for class TrackedChangesEdFiGradeKey.");

            if (gradingPeriodSchoolYear.IsSet && gradingPeriodSchoolYear.Value == null)
                throw new ArgumentNullException(nameof(gradingPeriodSchoolYear), "Property is not nullable for class TrackedChangesEdFiGradeKey.");

            if (beginDate.IsSet && beginDate.Value == null)
                throw new ArgumentNullException(nameof(beginDate), "Property is not nullable for class TrackedChangesEdFiGradeKey.");

            if (localCourseCode.IsSet && localCourseCode.Value == null)
                throw new ArgumentNullException(nameof(localCourseCode), "Property is not nullable for class TrackedChangesEdFiGradeKey.");

            if (schoolYear.IsSet && schoolYear.Value == null)
                throw new ArgumentNullException(nameof(schoolYear), "Property is not nullable for class TrackedChangesEdFiGradeKey.");

            if (sectionIdentifier.IsSet && sectionIdentifier.Value == null)
                throw new ArgumentNullException(nameof(sectionIdentifier), "Property is not nullable for class TrackedChangesEdFiGradeKey.");

            if (sessionName.IsSet && sessionName.Value == null)
                throw new ArgumentNullException(nameof(sessionName), "Property is not nullable for class TrackedChangesEdFiGradeKey.");

            if (studentUniqueId.IsSet && studentUniqueId.Value == null)
                throw new ArgumentNullException(nameof(studentUniqueId), "Property is not nullable for class TrackedChangesEdFiGradeKey.");

            return new TrackedChangesEdFiGradeKey(gradeTypeDescriptor, gradingPeriodDescriptor, gradingPeriodName, schoolId, gradingPeriodSchoolYear, beginDate, localCourseCode, schoolYear, sectionIdentifier, sessionName, studentUniqueId);
        }

        /// <summary>
        /// Serializes a <see cref="TrackedChangesEdFiGradeKey" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="trackedChangesEdFiGradeKey"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TrackedChangesEdFiGradeKey trackedChangesEdFiGradeKey, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, trackedChangesEdFiGradeKey, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TrackedChangesEdFiGradeKey" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="trackedChangesEdFiGradeKey"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TrackedChangesEdFiGradeKey trackedChangesEdFiGradeKey, JsonSerializerOptions jsonSerializerOptions)
        {
            if (trackedChangesEdFiGradeKey.GradeTypeDescriptorOption.IsSet && trackedChangesEdFiGradeKey.GradeTypeDescriptor == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiGradeKey.GradeTypeDescriptor), "Property is required for class TrackedChangesEdFiGradeKey.");

            if (trackedChangesEdFiGradeKey.GradingPeriodDescriptorOption.IsSet && trackedChangesEdFiGradeKey.GradingPeriodDescriptor == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiGradeKey.GradingPeriodDescriptor), "Property is required for class TrackedChangesEdFiGradeKey.");

            if (trackedChangesEdFiGradeKey.GradingPeriodNameOption.IsSet && trackedChangesEdFiGradeKey.GradingPeriodName == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiGradeKey.GradingPeriodName), "Property is required for class TrackedChangesEdFiGradeKey.");

            if (trackedChangesEdFiGradeKey.LocalCourseCodeOption.IsSet && trackedChangesEdFiGradeKey.LocalCourseCode == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiGradeKey.LocalCourseCode), "Property is required for class TrackedChangesEdFiGradeKey.");

            if (trackedChangesEdFiGradeKey.SectionIdentifierOption.IsSet && trackedChangesEdFiGradeKey.SectionIdentifier == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiGradeKey.SectionIdentifier), "Property is required for class TrackedChangesEdFiGradeKey.");

            if (trackedChangesEdFiGradeKey.SessionNameOption.IsSet && trackedChangesEdFiGradeKey.SessionName == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiGradeKey.SessionName), "Property is required for class TrackedChangesEdFiGradeKey.");

            if (trackedChangesEdFiGradeKey.StudentUniqueIdOption.IsSet && trackedChangesEdFiGradeKey.StudentUniqueId == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiGradeKey.StudentUniqueId), "Property is required for class TrackedChangesEdFiGradeKey.");

            if (trackedChangesEdFiGradeKey.GradeTypeDescriptorOption.IsSet)
                writer.WriteString("gradeTypeDescriptor", trackedChangesEdFiGradeKey.GradeTypeDescriptor);

            if (trackedChangesEdFiGradeKey.GradingPeriodDescriptorOption.IsSet)
                writer.WriteString("gradingPeriodDescriptor", trackedChangesEdFiGradeKey.GradingPeriodDescriptor);

            if (trackedChangesEdFiGradeKey.GradingPeriodNameOption.IsSet)
                writer.WriteString("gradingPeriodName", trackedChangesEdFiGradeKey.GradingPeriodName);

            if (trackedChangesEdFiGradeKey.SchoolIdOption.IsSet)
                writer.WriteNumber("schoolId", trackedChangesEdFiGradeKey.SchoolIdOption.Value!.Value);

            if (trackedChangesEdFiGradeKey.GradingPeriodSchoolYearOption.IsSet)
                writer.WriteNumber("gradingPeriodSchoolYear", trackedChangesEdFiGradeKey.GradingPeriodSchoolYearOption.Value!.Value);

            if (trackedChangesEdFiGradeKey.BeginDateOption.IsSet)
                writer.WriteString("beginDate", trackedChangesEdFiGradeKey.BeginDateOption.Value!.Value.ToString(BeginDateFormat));

            if (trackedChangesEdFiGradeKey.LocalCourseCodeOption.IsSet)
                writer.WriteString("localCourseCode", trackedChangesEdFiGradeKey.LocalCourseCode);

            if (trackedChangesEdFiGradeKey.SchoolYearOption.IsSet)
                writer.WriteNumber("schoolYear", trackedChangesEdFiGradeKey.SchoolYearOption.Value!.Value);

            if (trackedChangesEdFiGradeKey.SectionIdentifierOption.IsSet)
                writer.WriteString("sectionIdentifier", trackedChangesEdFiGradeKey.SectionIdentifier);

            if (trackedChangesEdFiGradeKey.SessionNameOption.IsSet)
                writer.WriteString("sessionName", trackedChangesEdFiGradeKey.SessionName);

            if (trackedChangesEdFiGradeKey.StudentUniqueIdOption.IsSet)
                writer.WriteString("studentUniqueId", trackedChangesEdFiGradeKey.StudentUniqueId);
        }
    }
}
