...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiStudentSectionAssociationReference : IValidatableObject
    {
        ...
        public EdFiStudentSectionAssociationReference(DateOnly beginDate = default, string localCourseCode = default, long schoolId = default, int schoolYear = default, string sectionIdentifier = default, string sessionName = default, string studentUniqueId = default, Link link = default)
        {
