...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiStudentProgramAssociation : IValidatableObject
    {
        ...
        public EdFiStudentProgramAssociation(string id = default, DateOnly beginDate = default, EdFiEducationOrganizationReference educationOrganizationReference = default, EdFiProgramReference programReference = default, EdFiStudentReference studentReference = default, DateOnly? endDate = default, List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus> programParticipationStatuses = default, string reasonExitedDescriptor = default, bool? servedOutsideOfRegularSession = default, List<EdFiStudentProgramAssociationService> services = default, string etag = default, DateTime lastModifiedDate = default, Object ext = default)
        {
