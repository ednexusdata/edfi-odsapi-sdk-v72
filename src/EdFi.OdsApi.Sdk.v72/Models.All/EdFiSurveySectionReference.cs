...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiSurveySectionReference : IValidatableObject
    {
        ...
        public EdFiSurveySectionReference(string varNamespace = default, string surveyIdentifier = default, string surveySectionTitle = default, Link link = default)
        {
            // to ensure "varNamespace" is required (not null)
            if (varNamespace == null)
            {
                throw new ArgumentNullException("varNamespace is a required property for EdFiSurveySectionReference and cannot be null");
            }
