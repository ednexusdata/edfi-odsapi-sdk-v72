...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiSurveyResponseReference : IValidatableObject
    {
        ...
        public EdFiSurveyResponseReference(string varNamespace = default, string surveyIdentifier = default, string surveyResponseIdentifier = default, Link link = default)
        {
            // to ensure "varNamespace" is required (not null)
            if (varNamespace == null)
            {
                throw new ArgumentNullException("varNamespace is a required property for EdFiSurveyResponseReference and cannot be null");
            }
