...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiContactAddress : IValidatableObject
    {
        ...
        public EdFiContactAddress(string addressTypeDescriptor = default, string stateAbbreviationDescriptor = default, string city = default, string postalCode = default, string streetNumberName = default, string localeDescriptor = default, string apartmentRoomSuiteNumber = default, string buildingSiteNumber = default, string congressionalDistrict = default, string countyFIPSCode = default, bool? doNotPublishIndicator = default, string latitude = default, string longitude = default, string nameOfCounty = default, List<EdFiContactAddressPeriod> periods = default, Object ext = default)
        {
