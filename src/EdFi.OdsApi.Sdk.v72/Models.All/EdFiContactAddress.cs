...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// EdFiContactAddress
    /// </summary>
    public partial class EdFiContactAddress : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ext">Extensions to the ContactAddress entity.</param>
        [JsonConstructor]
        public EdFiContactAddress(string addressTypeDescriptor, string stateAbbreviationDescriptor, string city, string postalCode, string streetNumberName, Option<string?> localeDescriptor = default, Option<string?> apartmentRoomSuiteNumber = default, Option<string?> buildingSiteNumber = default, Option<string?> congressionalDistrict = default, Option<string?> countyFIPSCode = default, Option<bool?> doNotPublishIndicator = default, Option<string?> latitude = default, Option<string?> longitude = default, Option<string?> nameOfCounty = default, Option<List<EdFiContactAddressPeriod>?> periods = default, Option<Object?> ext = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<EdFiContactAddressPeriod>?> PeriodsOption { get; private set; }
        ...
        public List<EdFiContactAddressPeriod>? Periods { get { return this.PeriodsOption; } set { this.PeriodsOption = new(value); } }
        ...
        /// <summary>
        /// Extensions to the ContactAddress entity.
        /// </summary>
        /// <value>Extensions to the ContactAddress entity.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiContactAddress" />
    /// </summary>
    public class EdFiContactAddressJsonConverter : JsonConverter<EdFiContactAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="EdFiContactAddress" />
        /// </summary>
        ...
        public override EdFiContactAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<EdFiContactAddressPeriod>?> periods = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "nameOfCounty":
                            ...
                            break;
                        case "periods":
                            periods = new Option<List<EdFiContactAddressPeriod>?>(JsonSerializer.Deserialize<List<EdFiContactAddressPeriod>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "_ext":
            ...
            if (!addressTypeDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiContactAddress.", nameof(addressTypeDescriptor));

            if (!stateAbbreviationDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiContactAddress.", nameof(stateAbbreviationDescriptor));

            if (!city.IsSet)
                throw new ArgumentException("Property is required for class EdFiContactAddress.", nameof(city));

            if (!postalCode.IsSet)
                throw new ArgumentException("Property is required for class EdFiContactAddress.", nameof(postalCode));

            if (!streetNumberName.IsSet)
                throw new ArgumentException("Property is required for class EdFiContactAddress.", nameof(streetNumberName));

            if (addressTypeDescriptor.IsSet && addressTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(addressTypeDescriptor), "Property is not nullable for class EdFiContactAddress.");

            if (stateAbbreviationDescriptor.IsSet && stateAbbreviationDescriptor.Value == null)
                throw new ArgumentNullException(nameof(stateAbbreviationDescriptor), "Property is not nullable for class EdFiContactAddress.");

            if (city.IsSet && city.Value == null)
                throw new ArgumentNullException(nameof(city), "Property is not nullable for class EdFiContactAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class EdFiContactAddress.");

            if (streetNumberName.IsSet && streetNumberName.Value == null)
                throw new ArgumentNullException(nameof(streetNumberName), "Property is not nullable for class EdFiContactAddress.");

            if (periods.IsSet && periods.Value == null)
                throw new ArgumentNullException(nameof(periods), "Property is not nullable for class EdFiContactAddress.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiContactAddress.");

            return new EdFiContactAddress(addressTypeDescriptor.Value!, stateAbbreviationDescriptor.Value!, city.Value!, postalCode.Value!, streetNumberName.Value!, localeDescriptor, apartmentRoomSuiteNumber, buildingSiteNumber, congressionalDistrict, countyFIPSCode, doNotPublishIndicator, latitude, longitude, nameOfCounty, periods, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiContactAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiContactAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiContactAddress edFiContactAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiContactAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiContactAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiContactAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiContactAddress edFiContactAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiContactAddress.AddressTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiContactAddress.AddressTypeDescriptor), "Property is required for class EdFiContactAddress.");

            if (edFiContactAddress.StateAbbreviationDescriptor == null)
                throw new ArgumentNullException(nameof(edFiContactAddress.StateAbbreviationDescriptor), "Property is required for class EdFiContactAddress.");

            if (edFiContactAddress.City == null)
                throw new ArgumentNullException(nameof(edFiContactAddress.City), "Property is required for class EdFiContactAddress.");

            if (edFiContactAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(edFiContactAddress.PostalCode), "Property is required for class EdFiContactAddress.");

            if (edFiContactAddress.StreetNumberName == null)
                throw new ArgumentNullException(nameof(edFiContactAddress.StreetNumberName), "Property is required for class EdFiContactAddress.");

            if (edFiContactAddress.PeriodsOption.IsSet && edFiContactAddress.Periods == null)
                throw new ArgumentNullException(nameof(edFiContactAddress.Periods), "Property is required for class EdFiContactAddress.");

            if (edFiContactAddress.ExtOption.IsSet && edFiContactAddress.Ext == null)
                throw new ArgumentNullException(nameof(edFiContactAddress.Ext), "Property is required for class EdFiContactAddress.");

            writer.WriteString("addressTypeDescriptor", edFiContactAddress.AddressTypeDescriptor);

            writer.WriteString("stateAbbreviationDescriptor", edFiContactAddress.StateAbbreviationDescriptor);

            writer.WriteString("city", edFiContactAddress.City);

            writer.WriteString("postalCode", edFiContactAddress.PostalCode);

            writer.WriteString("streetNumberName", edFiContactAddress.StreetNumberName);

            if (edFiContactAddress.LocaleDescriptorOption.IsSet)
                if (edFiContactAddress.LocaleDescriptorOption.Value != null)
                    writer.WriteString("localeDescriptor", edFiContactAddress.LocaleDescriptor);
                else
                    writer.WriteNull("localeDescriptor");

            if (edFiContactAddress.ApartmentRoomSuiteNumberOption.IsSet)
                if (edFiContactAddress.ApartmentRoomSuiteNumberOption.Value != null)
                    writer.WriteString("apartmentRoomSuiteNumber", edFiContactAddress.ApartmentRoomSuiteNumber);
                else
                    writer.WriteNull("apartmentRoomSuiteNumber");

            if (edFiContactAddress.BuildingSiteNumberOption.IsSet)
                if (edFiContactAddress.BuildingSiteNumberOption.Value != null)
                    writer.WriteString("buildingSiteNumber", edFiContactAddress.BuildingSiteNumber);
                else
                    writer.WriteNull("buildingSiteNumber");

            if (edFiContactAddress.CongressionalDistrictOption.IsSet)
                if (edFiContactAddress.CongressionalDistrictOption.Value != null)
                    writer.WriteString("congressionalDistrict", edFiContactAddress.CongressionalDistrict);
                else
                    writer.WriteNull("congressionalDistrict");

            if (edFiContactAddress.CountyFIPSCodeOption.IsSet)
                if (edFiContactAddress.CountyFIPSCodeOption.Value != null)
                    writer.WriteString("countyFIPSCode", edFiContactAddress.CountyFIPSCode);
                else
                    writer.WriteNull("countyFIPSCode");

            if (edFiContactAddress.DoNotPublishIndicatorOption.IsSet)
                if (edFiContactAddress.DoNotPublishIndicatorOption.Value != null)
                    writer.WriteBoolean("doNotPublishIndicator", edFiContactAddress.DoNotPublishIndicatorOption.Value!.Value);
                else
                    writer.WriteNull("doNotPublishIndicator");

            if (edFiContactAddress.LatitudeOption.IsSet)
                if (edFiContactAddress.LatitudeOption.Value != null)
                    writer.WriteString("latitude", edFiContactAddress.Latitude);
                else
                    writer.WriteNull("latitude");

            if (edFiContactAddress.LongitudeOption.IsSet)
                if (edFiContactAddress.LongitudeOption.Value != null)
                    writer.WriteString("longitude", edFiContactAddress.Longitude);
                else
                    writer.WriteNull("longitude");

            if (edFiContactAddress.NameOfCountyOption.IsSet)
                if (edFiContactAddress.NameOfCountyOption.Value != null)
                    writer.WriteString("nameOfCounty", edFiContactAddress.NameOfCounty);
                else
                    writer.WriteNull("nameOfCounty");

            if (edFiContactAddress.PeriodsOption.IsSet)
            {
                writer.WritePropertyName("periods");
                JsonSerializer.Serialize(writer, edFiContactAddress.Periods, jsonSerializerOptions);
            }
            if (edFiContactAddress.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiContactAddress.Ext, jsonSerializerOptions);
            }
        }
    }
}
