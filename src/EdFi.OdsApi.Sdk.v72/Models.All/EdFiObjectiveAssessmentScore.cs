...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    public partial class EdFiObjectiveAssessmentScore : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ext">Extensions to the ObjectiveAssessmentScore entity.</param>
        [JsonConstructor]
        public EdFiObjectiveAssessmentScore(string assessmentReportingMethodDescriptor, Option<string?> resultDatatypeTypeDescriptor = default, Option<string?> maximumScore = default, Option<string?> minimumScore = default, Option<Object?> ext = default)
        {
        ...
        /// <summary>
        /// Extensions to the ObjectiveAssessmentScore entity.
        /// </summary>
        /// <value>Extensions to the ObjectiveAssessmentScore entity.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiObjectiveAssessmentScore" />
    /// </summary>
    public class EdFiObjectiveAssessmentScoreJsonConverter : JsonConverter<EdFiObjectiveAssessmentScore>
    {
        /// <summary>
        /// Deserializes json to <see cref="EdFiObjectiveAssessmentScore" />
        /// </summary>
        ...
        public override EdFiObjectiveAssessmentScore Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!assessmentReportingMethodDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiObjectiveAssessmentScore.", nameof(assessmentReportingMethodDescriptor));

            if (assessmentReportingMethodDescriptor.IsSet && assessmentReportingMethodDescriptor.Value == null)
                throw new ArgumentNullException(nameof(assessmentReportingMethodDescriptor), "Property is not nullable for class EdFiObjectiveAssessmentScore.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiObjectiveAssessmentScore.");

            return new EdFiObjectiveAssessmentScore(assessmentReportingMethodDescriptor.Value!, resultDatatypeTypeDescriptor, maximumScore, minimumScore, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiObjectiveAssessmentScore" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiObjectiveAssessmentScore"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiObjectiveAssessmentScore edFiObjectiveAssessmentScore, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiObjectiveAssessmentScore, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiObjectiveAssessmentScore" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiObjectiveAssessmentScore"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiObjectiveAssessmentScore edFiObjectiveAssessmentScore, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiObjectiveAssessmentScore.AssessmentReportingMethodDescriptor == null)
                throw new ArgumentNullException(nameof(edFiObjectiveAssessmentScore.AssessmentReportingMethodDescriptor), "Property is required for class EdFiObjectiveAssessmentScore.");

            if (edFiObjectiveAssessmentScore.ExtOption.IsSet && edFiObjectiveAssessmentScore.Ext == null)
                throw new ArgumentNullException(nameof(edFiObjectiveAssessmentScore.Ext), "Property is required for class EdFiObjectiveAssessmentScore.");

            writer.WriteString("assessmentReportingMethodDescriptor", edFiObjectiveAssessmentScore.AssessmentReportingMethodDescriptor);

            if (edFiObjectiveAssessmentScore.ResultDatatypeTypeDescriptorOption.IsSet)
                if (edFiObjectiveAssessmentScore.ResultDatatypeTypeDescriptorOption.Value != null)
                    writer.WriteString("resultDatatypeTypeDescriptor", edFiObjectiveAssessmentScore.ResultDatatypeTypeDescriptor);
                else
                    writer.WriteNull("resultDatatypeTypeDescriptor");

            if (edFiObjectiveAssessmentScore.MaximumScoreOption.IsSet)
                if (edFiObjectiveAssessmentScore.MaximumScoreOption.Value != null)
                    writer.WriteString("maximumScore", edFiObjectiveAssessmentScore.MaximumScore);
                else
                    writer.WriteNull("maximumScore");

            if (edFiObjectiveAssessmentScore.MinimumScoreOption.IsSet)
                if (edFiObjectiveAssessmentScore.MinimumScoreOption.Value != null)
                    writer.WriteString("minimumScore", edFiObjectiveAssessmentScore.MinimumScore);
                else
                    writer.WriteNull("minimumScore");

            if (edFiObjectiveAssessmentScore.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiObjectiveAssessmentScore.Ext, jsonSerializerOptions);
            }
        }
    }
}
