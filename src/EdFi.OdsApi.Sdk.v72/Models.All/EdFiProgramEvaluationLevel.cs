...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiProgramEvaluationLevel : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiProgramEvaluationLevel(string ratingLevelDescriptor, Option<double?> maxNumericRating = default, Option<double?> minNumericRating = default, Option<Object?> ext = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiProgramEvaluationLevel" />
    /// </summary>
    public class EdFiProgramEvaluationLevelJsonConverter : JsonConverter<EdFiProgramEvaluationLevel>
    {
        /// <summary>
        /// Deserializes json to <see cref="EdFiProgramEvaluationLevel" />
        /// </summary>
        ...
        public override EdFiProgramEvaluationLevel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!ratingLevelDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiProgramEvaluationLevel.", nameof(ratingLevelDescriptor));

            if (ratingLevelDescriptor.IsSet && ratingLevelDescriptor.Value == null)
                throw new ArgumentNullException(nameof(ratingLevelDescriptor), "Property is not nullable for class EdFiProgramEvaluationLevel.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiProgramEvaluationLevel.");

            return new EdFiProgramEvaluationLevel(ratingLevelDescriptor.Value!, maxNumericRating, minNumericRating, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiProgramEvaluationLevel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiProgramEvaluationLevel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiProgramEvaluationLevel edFiProgramEvaluationLevel, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiProgramEvaluationLevel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiProgramEvaluationLevel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiProgramEvaluationLevel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiProgramEvaluationLevel edFiProgramEvaluationLevel, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiProgramEvaluationLevel.RatingLevelDescriptor == null)
                throw new ArgumentNullException(nameof(edFiProgramEvaluationLevel.RatingLevelDescriptor), "Property is required for class EdFiProgramEvaluationLevel.");

            if (edFiProgramEvaluationLevel.ExtOption.IsSet && edFiProgramEvaluationLevel.Ext == null)
                throw new ArgumentNullException(nameof(edFiProgramEvaluationLevel.Ext), "Property is required for class EdFiProgramEvaluationLevel.");

            writer.WriteString("ratingLevelDescriptor", edFiProgramEvaluationLevel.RatingLevelDescriptor);

            if (edFiProgramEvaluationLevel.MaxNumericRatingOption.IsSet)
                if (edFiProgramEvaluationLevel.MaxNumericRatingOption.Value != null)
                    writer.WriteNumber("maxNumericRating", edFiProgramEvaluationLevel.MaxNumericRatingOption.Value!.Value);
                else
                    writer.WriteNull("maxNumericRating");

            if (edFiProgramEvaluationLevel.MinNumericRatingOption.IsSet)
                if (edFiProgramEvaluationLevel.MinNumericRatingOption.Value != null)
                    writer.WriteNumber("minNumericRating", edFiProgramEvaluationLevel.MinNumericRatingOption.Value!.Value);
                else
                    writer.WriteNull("minNumericRating");

            if (edFiProgramEvaluationLevel.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiProgramEvaluationLevel.Ext, jsonSerializerOptions);
            }
        }
    }
}
