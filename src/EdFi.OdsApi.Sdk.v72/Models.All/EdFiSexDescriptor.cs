...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// EdFiSexDescriptor
    /// </summary>
    public partial class EdFiSexDescriptor : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public EdFiSexDescriptor(string codeValue, string @namespace, string shortDescription, Option<string?> id = default, Option<string?> description = default, Option<DateOnly?> effectiveBeginDate = default, Option<DateOnly?> effectiveEndDate = default, Option<string?> etag = default, Option<DateTime?> lastModifiedDate = default)
        {
            CodeValue = codeValue;
            Namespace = @namespace;
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiSexDescriptor" />
    /// </summary>
    public class EdFiSexDescriptorJsonConverter : JsonConverter<EdFiSexDescriptor>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="EdFiSexDescriptor" />
        /// </summary>
        ...
        public override EdFiSexDescriptor Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!codeValue.IsSet)
                throw new ArgumentException("Property is required for class EdFiSexDescriptor.", nameof(codeValue));

            if (!varNamespace.IsSet)
                throw new ArgumentException("Property is required for class EdFiSexDescriptor.", nameof(varNamespace));

            if (!shortDescription.IsSet)
                throw new ArgumentException("Property is required for class EdFiSexDescriptor.", nameof(shortDescription));

            if (codeValue.IsSet && codeValue.Value == null)
                throw new ArgumentNullException(nameof(codeValue), "Property is not nullable for class EdFiSexDescriptor.");

            if (varNamespace.IsSet && varNamespace.Value == null)
                throw new ArgumentNullException(nameof(varNamespace), "Property is not nullable for class EdFiSexDescriptor.");

            if (shortDescription.IsSet && shortDescription.Value == null)
                throw new ArgumentNullException(nameof(shortDescription), "Property is not nullable for class EdFiSexDescriptor.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class EdFiSexDescriptor.");

            if (etag.IsSet && etag.Value == null)
                throw new ArgumentNullException(nameof(etag), "Property is not nullable for class EdFiSexDescriptor.");

            if (lastModifiedDate.IsSet && lastModifiedDate.Value == null)
                throw new ArgumentNullException(nameof(lastModifiedDate), "Property is not nullable for class EdFiSexDescriptor.");

            return new EdFiSexDescriptor(codeValue.Value!, varNamespace.Value!, shortDescription.Value!, id, description, effectiveBeginDate, effectiveEndDate, etag, lastModifiedDate);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiSexDescriptor" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiSexDescriptor"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiSexDescriptor edFiSexDescriptor, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiSexDescriptor, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiSexDescriptor" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiSexDescriptor"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiSexDescriptor edFiSexDescriptor, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiSexDescriptor.CodeValue == null)
                throw new ArgumentNullException(nameof(edFiSexDescriptor.CodeValue), "Property is required for class EdFiSexDescriptor.");

            if (edFiSexDescriptor.Namespace == null)
                throw new ArgumentNullException(nameof(edFiSexDescriptor.Namespace), "Property is required for class EdFiSexDescriptor.");

            if (edFiSexDescriptor.ShortDescription == null)
                throw new ArgumentNullException(nameof(edFiSexDescriptor.ShortDescription), "Property is required for class EdFiSexDescriptor.");

            if (edFiSexDescriptor.IdOption.IsSet && edFiSexDescriptor.Id == null)
                throw new ArgumentNullException(nameof(edFiSexDescriptor.Id), "Property is required for class EdFiSexDescriptor.");

            if (edFiSexDescriptor.EtagOption.IsSet && edFiSexDescriptor.Etag == null)
                throw new ArgumentNullException(nameof(edFiSexDescriptor.Etag), "Property is required for class EdFiSexDescriptor.");

            writer.WriteString("codeValue", edFiSexDescriptor.CodeValue);

            writer.WriteString("namespace", edFiSexDescriptor.Namespace);

            writer.WriteString("shortDescription", edFiSexDescriptor.ShortDescription);

            if (edFiSexDescriptor.IdOption.IsSet)
                writer.WriteString("id", edFiSexDescriptor.Id);

            if (edFiSexDescriptor.DescriptionOption.IsSet)
                if (edFiSexDescriptor.DescriptionOption.Value != null)
                    writer.WriteString("description", edFiSexDescriptor.Description);
                else
                    writer.WriteNull("description");

            if (edFiSexDescriptor.EffectiveBeginDateOption.IsSet)
                if (edFiSexDescriptor.EffectiveBeginDateOption.Value != null)
                    writer.WriteString("effectiveBeginDate", edFiSexDescriptor.EffectiveBeginDateOption.Value!.Value.ToString(EffectiveBeginDateFormat));
                else
                    writer.WriteNull("effectiveBeginDate");

            if (edFiSexDescriptor.EffectiveEndDateOption.IsSet)
                if (edFiSexDescriptor.EffectiveEndDateOption.Value != null)
                    writer.WriteString("effectiveEndDate", edFiSexDescriptor.EffectiveEndDateOption.Value!.Value.ToString(EffectiveEndDateFormat));
                else
                    writer.WriteNull("effectiveEndDate");

            if (edFiSexDescriptor.EtagOption.IsSet)
                writer.WriteString("_etag", edFiSexDescriptor.Etag);

            if (edFiSexDescriptor.LastModifiedDateOption.IsSet)
                writer.WriteString("_lastModifiedDate", edFiSexDescriptor.LastModifiedDateOption.Value!.Value.ToString(LastModifiedDateFormat));
        }
    }
}
