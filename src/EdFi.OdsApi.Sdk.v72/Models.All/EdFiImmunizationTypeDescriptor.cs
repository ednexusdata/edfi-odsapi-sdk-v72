...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_immunizationTypeDescriptor")]
    public partial class EdFiImmunizationTypeDescriptor : IValidatableObject
    {
        ...
        protected EdFiImmunizationTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiImmunizationTypeDescriptor" /> class.
        /// </summary>
        ...
        public EdFiImmunizationTypeDescriptor(string id = default, string codeValue = default, string varNamespace = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string shortDescription = default, string etag = default, DateTime lastModifiedDate = default)
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiImmunizationTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "varNamespace" is required (not null)
            if (varNamespace == null)
            {
                throw new ArgumentNullException("varNamespace is a required property for EdFiImmunizationTypeDescriptor and cannot be null");
            }
            this.Namespace = varNamespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiImmunizationTypeDescriptor and cannot be null");
            }
