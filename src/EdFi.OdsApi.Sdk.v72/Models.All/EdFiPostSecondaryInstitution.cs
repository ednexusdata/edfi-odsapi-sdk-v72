...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiPostSecondaryInstitution : IValidatableObject
    {
        ...
        public EdFiPostSecondaryInstitution(string id = default, List<EdFiEducationOrganizationCategory> categories = default, long postSecondaryInstitutionId = default, List<EdFiEducationOrganizationAddress> addresses = default, string administrativeFundingControlDescriptor = default, List<EdFiEducationOrganizationIdentificationCode> identificationCodes = default, List<EdFiEducationOrganizationIndicator> indicators = default, List<EdFiEducationOrganizationInstitutionTelephone> institutionTelephones = default, List<EdFiEducationOrganizationInternationalAddress> internationalAddresses = default, List<EdFiPostSecondaryInstitutionMediumOfInstruction> mediumOfInstructions = default, string nameOfInstitution = default, string operationalStatusDescriptor = default, string postSecondaryInstitutionLevelDescriptor = default, string shortNameOfInstitution = default, string webSite = default, string etag = default, DateTime lastModifiedDate = default, Object ext = default)
        {
