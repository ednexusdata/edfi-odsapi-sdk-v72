...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class TrackedChangesEdFiSurveySectionResponseStaffTargetAssociationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiSurveySectionResponseStaffTargetAssociationKey(string staffUniqueId = default, string varNamespace = default, string surveyIdentifier = default, string surveyResponseIdentifier = default, string surveySectionTitle = default)
        {
