...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_programEvaluationReference")]
    public partial class EdFiProgramEvaluationReference : IValidatableObject
    {
        ...
        protected EdFiProgramEvaluationReference() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProgramEvaluationReference" /> class.
        /// </summary>
        ...
        public EdFiProgramEvaluationReference(long programEducationOrganizationId = default, string programEvaluationPeriodDescriptor = default, string programEvaluationTitle = default, string programEvaluationTypeDescriptor = default, string programName = default, string programTypeDescriptor = default, Link link = default)
        {
            ...
            {
                throw new ArgumentNullException("programEvaluationPeriodDescriptor is a required property for EdFiProgramEvaluationReference and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("programEvaluationTitle is a required property for EdFiProgramEvaluationReference and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("programEvaluationTypeDescriptor is a required property for EdFiProgramEvaluationReference and cannot be null");
            }
            this.ProgramEvaluationTypeDescriptor = programEvaluationTypeDescriptor;
            // to ensure "programName" is required (not null)
            if (programName == null)
            {
                throw new ArgumentNullException("programName is a required property for EdFiProgramEvaluationReference and cannot be null");
            }
            this.ProgramName = programName;
            // to ensure "programTypeDescriptor" is required (not null)
            if (programTypeDescriptor == null)
            {
                throw new ArgumentNullException("programTypeDescriptor is a required property for EdFiProgramEvaluationReference and cannot be null");
            }
