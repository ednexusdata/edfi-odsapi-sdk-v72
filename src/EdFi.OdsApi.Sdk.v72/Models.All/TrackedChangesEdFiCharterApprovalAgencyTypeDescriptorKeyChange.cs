...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class TrackedChangesEdFiCharterApprovalAgencyTypeDescriptorKeyChange : IValidatableObject
    {
        ...
        public TrackedChangesEdFiCharterApprovalAgencyTypeDescriptorKeyChange(string id = default, decimal changeVersion = default, TrackedChangesEdFiCharterApprovalAgencyTypeDescriptorKey oldKeyValues = default, TrackedChangesEdFiCharterApprovalAgencyTypeDescriptorKey newKeyValues = default)
        {
            this.Id = id;
