...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiStudentSectionAssociation : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiStudentSectionAssociation(DateOnly beginDate, EdFiSectionReference sectionReference, EdFiStudentReference studentReference, Option<string?> id = default, Option<string?> attemptStatusDescriptor = default, Option<DateOnly?> endDate = default, Option<bool?> homeroomIndicator = default, Option<List<EdFiStudentSectionAssociationProgram>?> programs = default, Option<string?> repeatIdentifierDescriptor = default, Option<bool?> teacherStudentDataLinkExclusion = default, Option<string?> etag = default, Option<DateTime?> lastModifiedDate = default, Option<Object?> ext = default)
        {
            BeginDate = beginDate;
    ...
    public class EdFiStudentSectionAssociationJsonConverter : JsonConverter<EdFiStudentSectionAssociation>
    {
        ...
        public override EdFiStudentSectionAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiStudentSectionAssociation(beginDate.Value!.Value!, sectionReference.Value!, studentReference.Value!, id, attemptStatusDescriptor, endDate, homeroomIndicator, programs, repeatIdentifierDescriptor, teacherStudentDataLinkExclusion, etag, lastModifiedDate, ext);
        }
