...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    public partial class EdFiGraduationPlanRequiredAssessmentScore : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ext">Extensions to the GraduationPlanRequiredAssessmentScore entity.</param>
        [JsonConstructor]
        public EdFiGraduationPlanRequiredAssessmentScore(string assessmentReportingMethodDescriptor, Option<string?> resultDatatypeTypeDescriptor = default, Option<string?> maximumScore = default, Option<string?> minimumScore = default, Option<Object?> ext = default)
        {
        ...
        /// <summary>
        /// Extensions to the GraduationPlanRequiredAssessmentScore entity.
        /// </summary>
        /// <value>Extensions to the GraduationPlanRequiredAssessmentScore entity.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiGraduationPlanRequiredAssessmentScore" />
    /// </summary>
    public class EdFiGraduationPlanRequiredAssessmentScoreJsonConverter : JsonConverter<EdFiGraduationPlanRequiredAssessmentScore>
    {
        /// <summary>
        /// Deserializes json to <see cref="EdFiGraduationPlanRequiredAssessmentScore" />
        /// </summary>
        ...
        public override EdFiGraduationPlanRequiredAssessmentScore Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!assessmentReportingMethodDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiGraduationPlanRequiredAssessmentScore.", nameof(assessmentReportingMethodDescriptor));

            if (assessmentReportingMethodDescriptor.IsSet && assessmentReportingMethodDescriptor.Value == null)
                throw new ArgumentNullException(nameof(assessmentReportingMethodDescriptor), "Property is not nullable for class EdFiGraduationPlanRequiredAssessmentScore.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiGraduationPlanRequiredAssessmentScore.");

            return new EdFiGraduationPlanRequiredAssessmentScore(assessmentReportingMethodDescriptor.Value!, resultDatatypeTypeDescriptor, maximumScore, minimumScore, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiGraduationPlanRequiredAssessmentScore" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiGraduationPlanRequiredAssessmentScore"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiGraduationPlanRequiredAssessmentScore edFiGraduationPlanRequiredAssessmentScore, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiGraduationPlanRequiredAssessmentScore, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiGraduationPlanRequiredAssessmentScore" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiGraduationPlanRequiredAssessmentScore"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiGraduationPlanRequiredAssessmentScore edFiGraduationPlanRequiredAssessmentScore, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiGraduationPlanRequiredAssessmentScore.AssessmentReportingMethodDescriptor == null)
                throw new ArgumentNullException(nameof(edFiGraduationPlanRequiredAssessmentScore.AssessmentReportingMethodDescriptor), "Property is required for class EdFiGraduationPlanRequiredAssessmentScore.");

            if (edFiGraduationPlanRequiredAssessmentScore.ExtOption.IsSet && edFiGraduationPlanRequiredAssessmentScore.Ext == null)
                throw new ArgumentNullException(nameof(edFiGraduationPlanRequiredAssessmentScore.Ext), "Property is required for class EdFiGraduationPlanRequiredAssessmentScore.");

            writer.WriteString("assessmentReportingMethodDescriptor", edFiGraduationPlanRequiredAssessmentScore.AssessmentReportingMethodDescriptor);

            if (edFiGraduationPlanRequiredAssessmentScore.ResultDatatypeTypeDescriptorOption.IsSet)
                if (edFiGraduationPlanRequiredAssessmentScore.ResultDatatypeTypeDescriptorOption.Value != null)
                    writer.WriteString("resultDatatypeTypeDescriptor", edFiGraduationPlanRequiredAssessmentScore.ResultDatatypeTypeDescriptor);
                else
                    writer.WriteNull("resultDatatypeTypeDescriptor");

            if (edFiGraduationPlanRequiredAssessmentScore.MaximumScoreOption.IsSet)
                if (edFiGraduationPlanRequiredAssessmentScore.MaximumScoreOption.Value != null)
                    writer.WriteString("maximumScore", edFiGraduationPlanRequiredAssessmentScore.MaximumScore);
                else
                    writer.WriteNull("maximumScore");

            if (edFiGraduationPlanRequiredAssessmentScore.MinimumScoreOption.IsSet)
                if (edFiGraduationPlanRequiredAssessmentScore.MinimumScoreOption.Value != null)
                    writer.WriteString("minimumScore", edFiGraduationPlanRequiredAssessmentScore.MinimumScore);
                else
                    writer.WriteNull("minimumScore");

            if (edFiGraduationPlanRequiredAssessmentScore.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiGraduationPlanRequiredAssessmentScore.Ext, jsonSerializerOptions);
            }
        }
    }
}
