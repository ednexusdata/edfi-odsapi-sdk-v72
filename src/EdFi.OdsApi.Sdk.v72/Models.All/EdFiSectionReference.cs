...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiSectionReference : IValidatableObject
    {
        ...
        public EdFiSectionReference(string localCourseCode = default, long schoolId = default, int schoolYear = default, string sectionIdentifier = default, string sessionName = default, Link link = default)
        {
