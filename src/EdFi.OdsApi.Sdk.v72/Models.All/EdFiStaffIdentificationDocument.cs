...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiStaffIdentificationDocument" />
    /// </summary>
    public class EdFiStaffIdentificationDocumentJsonConverter : JsonConverter<EdFiStaffIdentificationDocument>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="EdFiStaffIdentificationDocument" />
        /// </summary>
        ...
        public override EdFiStaffIdentificationDocument Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!identificationDocumentUseDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiStaffIdentificationDocument.", nameof(identificationDocumentUseDescriptor));

            if (!personalInformationVerificationDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiStaffIdentificationDocument.", nameof(personalInformationVerificationDescriptor));

            if (identificationDocumentUseDescriptor.IsSet && identificationDocumentUseDescriptor.Value == null)
                throw new ArgumentNullException(nameof(identificationDocumentUseDescriptor), "Property is not nullable for class EdFiStaffIdentificationDocument.");

            if (personalInformationVerificationDescriptor.IsSet && personalInformationVerificationDescriptor.Value == null)
                throw new ArgumentNullException(nameof(personalInformationVerificationDescriptor), "Property is not nullable for class EdFiStaffIdentificationDocument.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiStaffIdentificationDocument.");

            return new EdFiStaffIdentificationDocument(identificationDocumentUseDescriptor.Value!, personalInformationVerificationDescriptor.Value!, issuerCountryDescriptor, documentExpirationDate, documentTitle, issuerDocumentIdentificationCode, issuerName, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiStaffIdentificationDocument" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiStaffIdentificationDocument"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiStaffIdentificationDocument edFiStaffIdentificationDocument, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiStaffIdentificationDocument, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiStaffIdentificationDocument" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiStaffIdentificationDocument"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiStaffIdentificationDocument edFiStaffIdentificationDocument, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiStaffIdentificationDocument.IdentificationDocumentUseDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStaffIdentificationDocument.IdentificationDocumentUseDescriptor), "Property is required for class EdFiStaffIdentificationDocument.");

            if (edFiStaffIdentificationDocument.PersonalInformationVerificationDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStaffIdentificationDocument.PersonalInformationVerificationDescriptor), "Property is required for class EdFiStaffIdentificationDocument.");

            if (edFiStaffIdentificationDocument.ExtOption.IsSet && edFiStaffIdentificationDocument.Ext == null)
                throw new ArgumentNullException(nameof(edFiStaffIdentificationDocument.Ext), "Property is required for class EdFiStaffIdentificationDocument.");

            writer.WriteString("identificationDocumentUseDescriptor", edFiStaffIdentificationDocument.IdentificationDocumentUseDescriptor);

            writer.WriteString("personalInformationVerificationDescriptor", edFiStaffIdentificationDocument.PersonalInformationVerificationDescriptor);

            if (edFiStaffIdentificationDocument.IssuerCountryDescriptorOption.IsSet)
                if (edFiStaffIdentificationDocument.IssuerCountryDescriptorOption.Value != null)
                    writer.WriteString("issuerCountryDescriptor", edFiStaffIdentificationDocument.IssuerCountryDescriptor);
                else
                    writer.WriteNull("issuerCountryDescriptor");

            if (edFiStaffIdentificationDocument.DocumentExpirationDateOption.IsSet)
                if (edFiStaffIdentificationDocument.DocumentExpirationDateOption.Value != null)
                    writer.WriteString("documentExpirationDate", edFiStaffIdentificationDocument.DocumentExpirationDateOption.Value!.Value.ToString(DocumentExpirationDateFormat));
                else
                    writer.WriteNull("documentExpirationDate");

            if (edFiStaffIdentificationDocument.DocumentTitleOption.IsSet)
                if (edFiStaffIdentificationDocument.DocumentTitleOption.Value != null)
                    writer.WriteString("documentTitle", edFiStaffIdentificationDocument.DocumentTitle);
                else
                    writer.WriteNull("documentTitle");

            if (edFiStaffIdentificationDocument.IssuerDocumentIdentificationCodeOption.IsSet)
                if (edFiStaffIdentificationDocument.IssuerDocumentIdentificationCodeOption.Value != null)
                    writer.WriteString("issuerDocumentIdentificationCode", edFiStaffIdentificationDocument.IssuerDocumentIdentificationCode);
                else
                    writer.WriteNull("issuerDocumentIdentificationCode");

            if (edFiStaffIdentificationDocument.IssuerNameOption.IsSet)
                if (edFiStaffIdentificationDocument.IssuerNameOption.Value != null)
                    writer.WriteString("issuerName", edFiStaffIdentificationDocument.IssuerName);
                else
                    writer.WriteNull("issuerName");

            if (edFiStaffIdentificationDocument.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiStaffIdentificationDocument.Ext, jsonSerializerOptions);
            }
        }
    }
}
