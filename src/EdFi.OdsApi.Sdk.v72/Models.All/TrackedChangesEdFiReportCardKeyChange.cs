...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class TrackedChangesEdFiReportCardKeyChange : IValidatableObject
    {
        ...
        public TrackedChangesEdFiReportCardKeyChange(string id = default, decimal changeVersion = default, TrackedChangesEdFiReportCardKey oldKeyValues = default, TrackedChangesEdFiReportCardKey newKeyValues = default)
        {
            this.Id = id;
