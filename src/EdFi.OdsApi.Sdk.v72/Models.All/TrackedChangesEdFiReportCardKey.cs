...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class TrackedChangesEdFiReportCardKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiReportCardKey(long educationOrganizationId = default, string gradingPeriodDescriptor = default, string gradingPeriodName = default, long gradingPeriodSchoolId = default, int gradingPeriodSchoolYear = default, string studentUniqueId = default)
        {
