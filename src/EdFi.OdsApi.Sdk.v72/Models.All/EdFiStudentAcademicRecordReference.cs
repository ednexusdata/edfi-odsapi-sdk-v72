...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiStudentAcademicRecordReference : IValidatableObject
    {
        ...
        public EdFiStudentAcademicRecordReference(long educationOrganizationId = default, int schoolYear = default, string studentUniqueId = default, string termDescriptor = default, Link link = default)
        {
