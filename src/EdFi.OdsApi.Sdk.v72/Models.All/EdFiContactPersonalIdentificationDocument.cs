...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    public partial class EdFiContactPersonalIdentificationDocument : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ext">Extensions to the ContactPersonalIdentificationDocument entity.</param>
        [JsonConstructor]
        ...
        /// <summary>
        /// Extensions to the ContactPersonalIdentificationDocument entity.
        /// </summary>
        /// <value>Extensions to the ContactPersonalIdentificationDocument entity.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiContactPersonalIdentificationDocument" />
    /// </summary>
    public class EdFiContactPersonalIdentificationDocumentJsonConverter : JsonConverter<EdFiContactPersonalIdentificationDocument>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="EdFiContactPersonalIdentificationDocument" />
        /// </summary>
        ...
        public override EdFiContactPersonalIdentificationDocument Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!identificationDocumentUseDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiContactPersonalIdentificationDocument.", nameof(identificationDocumentUseDescriptor));

            if (!personalInformationVerificationDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiContactPersonalIdentificationDocument.", nameof(personalInformationVerificationDescriptor));

            if (identificationDocumentUseDescriptor.IsSet && identificationDocumentUseDescriptor.Value == null)
                throw new ArgumentNullException(nameof(identificationDocumentUseDescriptor), "Property is not nullable for class EdFiContactPersonalIdentificationDocument.");

            if (personalInformationVerificationDescriptor.IsSet && personalInformationVerificationDescriptor.Value == null)
                throw new ArgumentNullException(nameof(personalInformationVerificationDescriptor), "Property is not nullable for class EdFiContactPersonalIdentificationDocument.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiContactPersonalIdentificationDocument.");

            return new EdFiContactPersonalIdentificationDocument(identificationDocumentUseDescriptor.Value!, personalInformationVerificationDescriptor.Value!, issuerCountryDescriptor, documentExpirationDate, documentTitle, issuerDocumentIdentificationCode, issuerName, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiContactPersonalIdentificationDocument" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiContactPersonalIdentificationDocument"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiContactPersonalIdentificationDocument edFiContactPersonalIdentificationDocument, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiContactPersonalIdentificationDocument, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiContactPersonalIdentificationDocument" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiContactPersonalIdentificationDocument"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiContactPersonalIdentificationDocument edFiContactPersonalIdentificationDocument, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiContactPersonalIdentificationDocument.IdentificationDocumentUseDescriptor == null)
                throw new ArgumentNullException(nameof(edFiContactPersonalIdentificationDocument.IdentificationDocumentUseDescriptor), "Property is required for class EdFiContactPersonalIdentificationDocument.");

            if (edFiContactPersonalIdentificationDocument.PersonalInformationVerificationDescriptor == null)
                throw new ArgumentNullException(nameof(edFiContactPersonalIdentificationDocument.PersonalInformationVerificationDescriptor), "Property is required for class EdFiContactPersonalIdentificationDocument.");

            if (edFiContactPersonalIdentificationDocument.ExtOption.IsSet && edFiContactPersonalIdentificationDocument.Ext == null)
                throw new ArgumentNullException(nameof(edFiContactPersonalIdentificationDocument.Ext), "Property is required for class EdFiContactPersonalIdentificationDocument.");

            writer.WriteString("identificationDocumentUseDescriptor", edFiContactPersonalIdentificationDocument.IdentificationDocumentUseDescriptor);

            writer.WriteString("personalInformationVerificationDescriptor", edFiContactPersonalIdentificationDocument.PersonalInformationVerificationDescriptor);

            if (edFiContactPersonalIdentificationDocument.IssuerCountryDescriptorOption.IsSet)
                if (edFiContactPersonalIdentificationDocument.IssuerCountryDescriptorOption.Value != null)
                    writer.WriteString("issuerCountryDescriptor", edFiContactPersonalIdentificationDocument.IssuerCountryDescriptor);
                else
                    writer.WriteNull("issuerCountryDescriptor");

            if (edFiContactPersonalIdentificationDocument.DocumentExpirationDateOption.IsSet)
                if (edFiContactPersonalIdentificationDocument.DocumentExpirationDateOption.Value != null)
                    writer.WriteString("documentExpirationDate", edFiContactPersonalIdentificationDocument.DocumentExpirationDateOption.Value!.Value.ToString(DocumentExpirationDateFormat));
                else
                    writer.WriteNull("documentExpirationDate");

            if (edFiContactPersonalIdentificationDocument.DocumentTitleOption.IsSet)
                if (edFiContactPersonalIdentificationDocument.DocumentTitleOption.Value != null)
                    writer.WriteString("documentTitle", edFiContactPersonalIdentificationDocument.DocumentTitle);
                else
                    writer.WriteNull("documentTitle");

            if (edFiContactPersonalIdentificationDocument.IssuerDocumentIdentificationCodeOption.IsSet)
                if (edFiContactPersonalIdentificationDocument.IssuerDocumentIdentificationCodeOption.Value != null)
                    writer.WriteString("issuerDocumentIdentificationCode", edFiContactPersonalIdentificationDocument.IssuerDocumentIdentificationCode);
                else
                    writer.WriteNull("issuerDocumentIdentificationCode");

            if (edFiContactPersonalIdentificationDocument.IssuerNameOption.IsSet)
                if (edFiContactPersonalIdentificationDocument.IssuerNameOption.Value != null)
                    writer.WriteString("issuerName", edFiContactPersonalIdentificationDocument.IssuerName);
                else
                    writer.WriteNull("issuerName");

            if (edFiContactPersonalIdentificationDocument.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiContactPersonalIdentificationDocument.Ext, jsonSerializerOptions);
            }
        }
    }
}
