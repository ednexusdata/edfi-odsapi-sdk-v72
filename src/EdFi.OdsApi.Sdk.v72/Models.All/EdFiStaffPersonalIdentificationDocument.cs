...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    public partial class EdFiStaffPersonalIdentificationDocument : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ext">Extensions to the StaffPersonalIdentificationDocument entity.</param>
        [JsonConstructor]
        ...
        /// <summary>
        /// Extensions to the StaffPersonalIdentificationDocument entity.
        /// </summary>
        /// <value>Extensions to the StaffPersonalIdentificationDocument entity.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiStaffPersonalIdentificationDocument" />
    /// </summary>
    public class EdFiStaffPersonalIdentificationDocumentJsonConverter : JsonConverter<EdFiStaffPersonalIdentificationDocument>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="EdFiStaffPersonalIdentificationDocument" />
        /// </summary>
        ...
        public override EdFiStaffPersonalIdentificationDocument Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!identificationDocumentUseDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiStaffPersonalIdentificationDocument.", nameof(identificationDocumentUseDescriptor));

            if (!personalInformationVerificationDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiStaffPersonalIdentificationDocument.", nameof(personalInformationVerificationDescriptor));

            if (identificationDocumentUseDescriptor.IsSet && identificationDocumentUseDescriptor.Value == null)
                throw new ArgumentNullException(nameof(identificationDocumentUseDescriptor), "Property is not nullable for class EdFiStaffPersonalIdentificationDocument.");

            if (personalInformationVerificationDescriptor.IsSet && personalInformationVerificationDescriptor.Value == null)
                throw new ArgumentNullException(nameof(personalInformationVerificationDescriptor), "Property is not nullable for class EdFiStaffPersonalIdentificationDocument.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiStaffPersonalIdentificationDocument.");

            return new EdFiStaffPersonalIdentificationDocument(identificationDocumentUseDescriptor.Value!, personalInformationVerificationDescriptor.Value!, issuerCountryDescriptor, documentExpirationDate, documentTitle, issuerDocumentIdentificationCode, issuerName, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiStaffPersonalIdentificationDocument" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiStaffPersonalIdentificationDocument"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiStaffPersonalIdentificationDocument edFiStaffPersonalIdentificationDocument, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiStaffPersonalIdentificationDocument, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiStaffPersonalIdentificationDocument" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiStaffPersonalIdentificationDocument"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiStaffPersonalIdentificationDocument edFiStaffPersonalIdentificationDocument, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiStaffPersonalIdentificationDocument.IdentificationDocumentUseDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStaffPersonalIdentificationDocument.IdentificationDocumentUseDescriptor), "Property is required for class EdFiStaffPersonalIdentificationDocument.");

            if (edFiStaffPersonalIdentificationDocument.PersonalInformationVerificationDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStaffPersonalIdentificationDocument.PersonalInformationVerificationDescriptor), "Property is required for class EdFiStaffPersonalIdentificationDocument.");

            if (edFiStaffPersonalIdentificationDocument.ExtOption.IsSet && edFiStaffPersonalIdentificationDocument.Ext == null)
                throw new ArgumentNullException(nameof(edFiStaffPersonalIdentificationDocument.Ext), "Property is required for class EdFiStaffPersonalIdentificationDocument.");

            writer.WriteString("identificationDocumentUseDescriptor", edFiStaffPersonalIdentificationDocument.IdentificationDocumentUseDescriptor);

            writer.WriteString("personalInformationVerificationDescriptor", edFiStaffPersonalIdentificationDocument.PersonalInformationVerificationDescriptor);

            if (edFiStaffPersonalIdentificationDocument.IssuerCountryDescriptorOption.IsSet)
                if (edFiStaffPersonalIdentificationDocument.IssuerCountryDescriptorOption.Value != null)
                    writer.WriteString("issuerCountryDescriptor", edFiStaffPersonalIdentificationDocument.IssuerCountryDescriptor);
                else
                    writer.WriteNull("issuerCountryDescriptor");

            if (edFiStaffPersonalIdentificationDocument.DocumentExpirationDateOption.IsSet)
                if (edFiStaffPersonalIdentificationDocument.DocumentExpirationDateOption.Value != null)
                    writer.WriteString("documentExpirationDate", edFiStaffPersonalIdentificationDocument.DocumentExpirationDateOption.Value!.Value.ToString(DocumentExpirationDateFormat));
                else
                    writer.WriteNull("documentExpirationDate");

            if (edFiStaffPersonalIdentificationDocument.DocumentTitleOption.IsSet)
                if (edFiStaffPersonalIdentificationDocument.DocumentTitleOption.Value != null)
                    writer.WriteString("documentTitle", edFiStaffPersonalIdentificationDocument.DocumentTitle);
                else
                    writer.WriteNull("documentTitle");

            if (edFiStaffPersonalIdentificationDocument.IssuerDocumentIdentificationCodeOption.IsSet)
                if (edFiStaffPersonalIdentificationDocument.IssuerDocumentIdentificationCodeOption.Value != null)
                    writer.WriteString("issuerDocumentIdentificationCode", edFiStaffPersonalIdentificationDocument.IssuerDocumentIdentificationCode);
                else
                    writer.WriteNull("issuerDocumentIdentificationCode");

            if (edFiStaffPersonalIdentificationDocument.IssuerNameOption.IsSet)
                if (edFiStaffPersonalIdentificationDocument.IssuerNameOption.Value != null)
                    writer.WriteString("issuerName", edFiStaffPersonalIdentificationDocument.IssuerName);
                else
                    writer.WriteNull("issuerName");

            if (edFiStaffPersonalIdentificationDocument.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiStaffPersonalIdentificationDocument.Ext, jsonSerializerOptions);
            }
        }
    }
}
