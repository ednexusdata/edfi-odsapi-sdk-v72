...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiStudentSchoolAssociation : IValidatableObject
    {
        ...
        public EdFiStudentSchoolAssociation(string id = default, DateOnly entryDate = default, EdFiCalendarReference calendarReference = default, EdFiSchoolYearTypeReference classOfSchoolYearTypeReference = default, EdFiGraduationPlanReference graduationPlanReference = default, EdFiSchoolReference nextYearSchoolReference = default, EdFiSchoolReference schoolReference = default, EdFiSchoolYearTypeReference schoolYearTypeReference = default, EdFiStudentReference studentReference = default, List<EdFiStudentSchoolAssociationAlternativeGraduationPlan> alternativeGraduationPlans = default, List<EdFiStudentSchoolAssociationEducationPlan> educationPlans = default, bool? employedWhileEnrolled = default, string enrollmentTypeDescriptor = default, string entryGradeLevelDescriptor = default, string entryGradeLevelReasonDescriptor = default, string entryTypeDescriptor = default, DateOnly? exitWithdrawDate = default, string exitWithdrawTypeDescriptor = default, double? fullTimeEquivalency = default, string nextYearGradeLevelDescriptor = default, bool? primarySchool = default, bool? repeatGradeIndicator = default, string residencyStatusDescriptor = default, bool? schoolChoice = default, string schoolChoiceBasisDescriptor = default, bool? schoolChoiceTransfer = default, bool? termCompletionIndicator = default, string etag = default, DateTime lastModifiedDate = default, Object ext = default)
        {
