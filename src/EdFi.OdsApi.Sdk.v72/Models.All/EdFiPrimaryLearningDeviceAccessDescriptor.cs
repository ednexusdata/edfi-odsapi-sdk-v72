...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiPrimaryLearningDeviceAccessDescriptor : IValidatableObject
    {
        ...
        public EdFiPrimaryLearningDeviceAccessDescriptor(string id = default, string codeValue = default, string varNamespace = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string shortDescription = default, string etag = default, DateTime lastModifiedDate = default)
        {
            ...
            {
                throw new ArgumentNullException("varNamespace is a required property for EdFiPrimaryLearningDeviceAccessDescriptor and cannot be null");
            }
