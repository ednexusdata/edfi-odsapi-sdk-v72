...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiSurveyQuestionReference : IValidatableObject
    {
        ...
        public EdFiSurveyQuestionReference(string varNamespace = default, string questionCode = default, string surveyIdentifier = default, Link link = default)
        {
            // to ensure "varNamespace" is required (not null)
            if (varNamespace == null)
            {
                throw new ArgumentNullException("varNamespace is a required property for EdFiSurveyQuestionReference and cannot be null");
            }
