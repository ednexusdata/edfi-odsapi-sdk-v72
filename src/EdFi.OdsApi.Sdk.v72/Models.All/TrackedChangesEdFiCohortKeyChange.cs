...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class TrackedChangesEdFiCohortKeyChange : IValidatableObject
    {
        ...
        public TrackedChangesEdFiCohortKeyChange(string id = default, decimal changeVersion = default, TrackedChangesEdFiCohortKey oldKeyValues = default, TrackedChangesEdFiCohortKey newKeyValues = default)
        {
            this.Id = id;
