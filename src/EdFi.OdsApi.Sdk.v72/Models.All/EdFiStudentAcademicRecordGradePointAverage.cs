...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    public partial class EdFiStudentAcademicRecordGradePointAverage : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ext">Extensions to the StudentAcademicRecordGradePointAverage entity.</param>
        [JsonConstructor]
        public EdFiStudentAcademicRecordGradePointAverage(string gradePointAverageTypeDescriptor, double gradePointAverageValue, Option<bool?> isCumulative = default, Option<double?> maxGradePointAverageValue = default, Option<Object?> ext = default)
        {
        ...
        /// <summary>
        /// Extensions to the StudentAcademicRecordGradePointAverage entity.
        /// </summary>
        /// <value>Extensions to the StudentAcademicRecordGradePointAverage entity.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiStudentAcademicRecordGradePointAverage" />
    /// </summary>
    public class EdFiStudentAcademicRecordGradePointAverageJsonConverter : JsonConverter<EdFiStudentAcademicRecordGradePointAverage>
    {
        /// <summary>
        /// Deserializes json to <see cref="EdFiStudentAcademicRecordGradePointAverage" />
        /// </summary>
        ...
        public override EdFiStudentAcademicRecordGradePointAverage Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!gradePointAverageTypeDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiStudentAcademicRecordGradePointAverage.", nameof(gradePointAverageTypeDescriptor));

            if (!gradePointAverageValue.IsSet)
                throw new ArgumentException("Property is required for class EdFiStudentAcademicRecordGradePointAverage.", nameof(gradePointAverageValue));

            if (gradePointAverageTypeDescriptor.IsSet && gradePointAverageTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(gradePointAverageTypeDescriptor), "Property is not nullable for class EdFiStudentAcademicRecordGradePointAverage.");

            if (gradePointAverageValue.IsSet && gradePointAverageValue.Value == null)
                throw new ArgumentNullException(nameof(gradePointAverageValue), "Property is not nullable for class EdFiStudentAcademicRecordGradePointAverage.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiStudentAcademicRecordGradePointAverage.");

            return new EdFiStudentAcademicRecordGradePointAverage(gradePointAverageTypeDescriptor.Value!, gradePointAverageValue.Value!.Value!, isCumulative, maxGradePointAverageValue, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiStudentAcademicRecordGradePointAverage" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiStudentAcademicRecordGradePointAverage"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiStudentAcademicRecordGradePointAverage edFiStudentAcademicRecordGradePointAverage, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiStudentAcademicRecordGradePointAverage, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiStudentAcademicRecordGradePointAverage" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiStudentAcademicRecordGradePointAverage"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentAcademicRecordGradePointAverage edFiStudentAcademicRecordGradePointAverage, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiStudentAcademicRecordGradePointAverage.GradePointAverageTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentAcademicRecordGradePointAverage.GradePointAverageTypeDescriptor), "Property is required for class EdFiStudentAcademicRecordGradePointAverage.");

            if (edFiStudentAcademicRecordGradePointAverage.ExtOption.IsSet && edFiStudentAcademicRecordGradePointAverage.Ext == null)
                throw new ArgumentNullException(nameof(edFiStudentAcademicRecordGradePointAverage.Ext), "Property is required for class EdFiStudentAcademicRecordGradePointAverage.");

            writer.WriteString("gradePointAverageTypeDescriptor", edFiStudentAcademicRecordGradePointAverage.GradePointAverageTypeDescriptor);

            writer.WriteNumber("gradePointAverageValue", edFiStudentAcademicRecordGradePointAverage.GradePointAverageValue);

            if (edFiStudentAcademicRecordGradePointAverage.IsCumulativeOption.IsSet)
                if (edFiStudentAcademicRecordGradePointAverage.IsCumulativeOption.Value != null)
                    writer.WriteBoolean("isCumulative", edFiStudentAcademicRecordGradePointAverage.IsCumulativeOption.Value!.Value);
                else
                    writer.WriteNull("isCumulative");

            if (edFiStudentAcademicRecordGradePointAverage.MaxGradePointAverageValueOption.IsSet)
                if (edFiStudentAcademicRecordGradePointAverage.MaxGradePointAverageValueOption.Value != null)
                    writer.WriteNumber("maxGradePointAverageValue", edFiStudentAcademicRecordGradePointAverage.MaxGradePointAverageValueOption.Value!.Value);
                else
                    writer.WriteNull("maxGradePointAverageValue");

            if (edFiStudentAcademicRecordGradePointAverage.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiStudentAcademicRecordGradePointAverage.Ext, jsonSerializerOptions);
            }
        }
    }
}
