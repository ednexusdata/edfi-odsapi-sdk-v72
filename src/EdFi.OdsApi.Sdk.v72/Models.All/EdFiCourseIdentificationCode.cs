...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    public partial class EdFiCourseIdentificationCode : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ext">Extensions to the CourseIdentificationCode entity.</param>
        [JsonConstructor]
        public EdFiCourseIdentificationCode(string courseIdentificationSystemDescriptor, string identificationCode, Option<string?> assigningOrganizationIdentificationCode = default, Option<string?> courseCatalogURL = default, Option<Object?> ext = default)
        {
        ...
        /// <summary>
        /// Extensions to the CourseIdentificationCode entity.
        /// </summary>
        /// <value>Extensions to the CourseIdentificationCode entity.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiCourseIdentificationCode" />
    /// </summary>
    public class EdFiCourseIdentificationCodeJsonConverter : JsonConverter<EdFiCourseIdentificationCode>
    {
        /// <summary>
        /// Deserializes json to <see cref="EdFiCourseIdentificationCode" />
        /// </summary>
        ...
        public override EdFiCourseIdentificationCode Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!courseIdentificationSystemDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiCourseIdentificationCode.", nameof(courseIdentificationSystemDescriptor));

            if (!identificationCode.IsSet)
                throw new ArgumentException("Property is required for class EdFiCourseIdentificationCode.", nameof(identificationCode));

            if (courseIdentificationSystemDescriptor.IsSet && courseIdentificationSystemDescriptor.Value == null)
                throw new ArgumentNullException(nameof(courseIdentificationSystemDescriptor), "Property is not nullable for class EdFiCourseIdentificationCode.");

            if (identificationCode.IsSet && identificationCode.Value == null)
                throw new ArgumentNullException(nameof(identificationCode), "Property is not nullable for class EdFiCourseIdentificationCode.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiCourseIdentificationCode.");

            return new EdFiCourseIdentificationCode(courseIdentificationSystemDescriptor.Value!, identificationCode.Value!, assigningOrganizationIdentificationCode, courseCatalogURL, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiCourseIdentificationCode" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiCourseIdentificationCode"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiCourseIdentificationCode edFiCourseIdentificationCode, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiCourseIdentificationCode, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiCourseIdentificationCode" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiCourseIdentificationCode"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiCourseIdentificationCode edFiCourseIdentificationCode, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiCourseIdentificationCode.CourseIdentificationSystemDescriptor == null)
                throw new ArgumentNullException(nameof(edFiCourseIdentificationCode.CourseIdentificationSystemDescriptor), "Property is required for class EdFiCourseIdentificationCode.");

            if (edFiCourseIdentificationCode.IdentificationCode == null)
                throw new ArgumentNullException(nameof(edFiCourseIdentificationCode.IdentificationCode), "Property is required for class EdFiCourseIdentificationCode.");

            if (edFiCourseIdentificationCode.ExtOption.IsSet && edFiCourseIdentificationCode.Ext == null)
                throw new ArgumentNullException(nameof(edFiCourseIdentificationCode.Ext), "Property is required for class EdFiCourseIdentificationCode.");

            writer.WriteString("courseIdentificationSystemDescriptor", edFiCourseIdentificationCode.CourseIdentificationSystemDescriptor);

            writer.WriteString("identificationCode", edFiCourseIdentificationCode.IdentificationCode);

            if (edFiCourseIdentificationCode.AssigningOrganizationIdentificationCodeOption.IsSet)
                if (edFiCourseIdentificationCode.AssigningOrganizationIdentificationCodeOption.Value != null)
                    writer.WriteString("assigningOrganizationIdentificationCode", edFiCourseIdentificationCode.AssigningOrganizationIdentificationCode);
                else
                    writer.WriteNull("assigningOrganizationIdentificationCode");

            if (edFiCourseIdentificationCode.CourseCatalogURLOption.IsSet)
                if (edFiCourseIdentificationCode.CourseCatalogURLOption.Value != null)
                    writer.WriteString("courseCatalogURL", edFiCourseIdentificationCode.CourseCatalogURL);
                else
                    writer.WriteNull("courseCatalogURL");

            if (edFiCourseIdentificationCode.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiCourseIdentificationCode.Ext, jsonSerializerOptions);
            }
        }
    }
}
