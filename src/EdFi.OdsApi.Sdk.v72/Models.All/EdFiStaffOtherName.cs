...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// EdFiStaffOtherName
    /// </summary>
    public partial class EdFiStaffOtherName : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ext">Extensions to the StaffOtherName entity.</param>
        [JsonConstructor]
        public EdFiStaffOtherName(string otherNameTypeDescriptor, string firstName, string lastSurname, Option<string?> generationCodeSuffix = default, Option<string?> middleName = default, Option<string?> personalTitlePrefix = default, Option<Object?> ext = default)
        {
        ...
        /// <summary>
        /// Extensions to the StaffOtherName entity.
        /// </summary>
        /// <value>Extensions to the StaffOtherName entity.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiStaffOtherName" />
    /// </summary>
    public class EdFiStaffOtherNameJsonConverter : JsonConverter<EdFiStaffOtherName>
    {
        /// <summary>
        /// Deserializes json to <see cref="EdFiStaffOtherName" />
        /// </summary>
        ...
        public override EdFiStaffOtherName Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!otherNameTypeDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiStaffOtherName.", nameof(otherNameTypeDescriptor));

            if (!firstName.IsSet)
                throw new ArgumentException("Property is required for class EdFiStaffOtherName.", nameof(firstName));

            if (!lastSurname.IsSet)
                throw new ArgumentException("Property is required for class EdFiStaffOtherName.", nameof(lastSurname));

            if (otherNameTypeDescriptor.IsSet && otherNameTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(otherNameTypeDescriptor), "Property is not nullable for class EdFiStaffOtherName.");

            if (firstName.IsSet && firstName.Value == null)
                throw new ArgumentNullException(nameof(firstName), "Property is not nullable for class EdFiStaffOtherName.");

            if (lastSurname.IsSet && lastSurname.Value == null)
                throw new ArgumentNullException(nameof(lastSurname), "Property is not nullable for class EdFiStaffOtherName.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiStaffOtherName.");

            return new EdFiStaffOtherName(otherNameTypeDescriptor.Value!, firstName.Value!, lastSurname.Value!, generationCodeSuffix, middleName, personalTitlePrefix, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiStaffOtherName" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiStaffOtherName"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiStaffOtherName edFiStaffOtherName, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiStaffOtherName, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiStaffOtherName" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiStaffOtherName"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiStaffOtherName edFiStaffOtherName, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiStaffOtherName.OtherNameTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStaffOtherName.OtherNameTypeDescriptor), "Property is required for class EdFiStaffOtherName.");

            if (edFiStaffOtherName.FirstName == null)
                throw new ArgumentNullException(nameof(edFiStaffOtherName.FirstName), "Property is required for class EdFiStaffOtherName.");

            if (edFiStaffOtherName.LastSurname == null)
                throw new ArgumentNullException(nameof(edFiStaffOtherName.LastSurname), "Property is required for class EdFiStaffOtherName.");

            if (edFiStaffOtherName.ExtOption.IsSet && edFiStaffOtherName.Ext == null)
                throw new ArgumentNullException(nameof(edFiStaffOtherName.Ext), "Property is required for class EdFiStaffOtherName.");

            writer.WriteString("otherNameTypeDescriptor", edFiStaffOtherName.OtherNameTypeDescriptor);

            writer.WriteString("firstName", edFiStaffOtherName.FirstName);

            writer.WriteString("lastSurname", edFiStaffOtherName.LastSurname);

            if (edFiStaffOtherName.GenerationCodeSuffixOption.IsSet)
                if (edFiStaffOtherName.GenerationCodeSuffixOption.Value != null)
                    writer.WriteString("generationCodeSuffix", edFiStaffOtherName.GenerationCodeSuffix);
                else
                    writer.WriteNull("generationCodeSuffix");

            if (edFiStaffOtherName.MiddleNameOption.IsSet)
                if (edFiStaffOtherName.MiddleNameOption.Value != null)
                    writer.WriteString("middleName", edFiStaffOtherName.MiddleName);
                else
                    writer.WriteNull("middleName");

            if (edFiStaffOtherName.PersonalTitlePrefixOption.IsSet)
                if (edFiStaffOtherName.PersonalTitlePrefixOption.Value != null)
                    writer.WriteString("personalTitlePrefix", edFiStaffOtherName.PersonalTitlePrefix);
                else
                    writer.WriteNull("personalTitlePrefix");

            if (edFiStaffOtherName.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiStaffOtherName.Ext, jsonSerializerOptions);
            }
        }
    }
}
