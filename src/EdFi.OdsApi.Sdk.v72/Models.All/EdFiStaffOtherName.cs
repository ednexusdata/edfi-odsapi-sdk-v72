...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiStaffOtherName : IValidatableObject
    {
        ...
        public EdFiStaffOtherName(string otherNameTypeDescriptor = default, string firstName = default, string generationCodeSuffix = default, string lastSurname = default, string middleName = default, string personalTitlePrefix = default, Object ext = default)
        {
