...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    public partial class TrackedChangesEdFiStudentHomelessProgramAssociationKey : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public TrackedChangesEdFiStudentHomelessProgramAssociationKey(Option<DateOnly?> beginDate = default, Option<long?> educationOrganizationId = default, Option<long?> programEducationOrganizationId = default, Option<string?> programName = default, Option<string?> programTypeDescriptor = default, Option<string?> studentUniqueId = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="TrackedChangesEdFiStudentHomelessProgramAssociationKey" />
    /// </summary>
    public class TrackedChangesEdFiStudentHomelessProgramAssociationKeyJsonConverter : JsonConverter<TrackedChangesEdFiStudentHomelessProgramAssociationKey>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="TrackedChangesEdFiStudentHomelessProgramAssociationKey" />
        /// </summary>
        ...
        public override TrackedChangesEdFiStudentHomelessProgramAssociationKey Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (beginDate.IsSet && beginDate.Value == null)
                throw new ArgumentNullException(nameof(beginDate), "Property is not nullable for class TrackedChangesEdFiStudentHomelessProgramAssociationKey.");

            if (educationOrganizationId.IsSet && educationOrganizationId.Value == null)
                throw new ArgumentNullException(nameof(educationOrganizationId), "Property is not nullable for class TrackedChangesEdFiStudentHomelessProgramAssociationKey.");

            if (programEducationOrganizationId.IsSet && programEducationOrganizationId.Value == null)
                throw new ArgumentNullException(nameof(programEducationOrganizationId), "Property is not nullable for class TrackedChangesEdFiStudentHomelessProgramAssociationKey.");

            if (programName.IsSet && programName.Value == null)
                throw new ArgumentNullException(nameof(programName), "Property is not nullable for class TrackedChangesEdFiStudentHomelessProgramAssociationKey.");

            if (programTypeDescriptor.IsSet && programTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(programTypeDescriptor), "Property is not nullable for class TrackedChangesEdFiStudentHomelessProgramAssociationKey.");

            if (studentUniqueId.IsSet && studentUniqueId.Value == null)
                throw new ArgumentNullException(nameof(studentUniqueId), "Property is not nullable for class TrackedChangesEdFiStudentHomelessProgramAssociationKey.");

            return new TrackedChangesEdFiStudentHomelessProgramAssociationKey(beginDate, educationOrganizationId, programEducationOrganizationId, programName, programTypeDescriptor, studentUniqueId);
        }

        /// <summary>
        /// Serializes a <see cref="TrackedChangesEdFiStudentHomelessProgramAssociationKey" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="trackedChangesEdFiStudentHomelessProgramAssociationKey"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TrackedChangesEdFiStudentHomelessProgramAssociationKey trackedChangesEdFiStudentHomelessProgramAssociationKey, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, trackedChangesEdFiStudentHomelessProgramAssociationKey, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TrackedChangesEdFiStudentHomelessProgramAssociationKey" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="trackedChangesEdFiStudentHomelessProgramAssociationKey"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TrackedChangesEdFiStudentHomelessProgramAssociationKey trackedChangesEdFiStudentHomelessProgramAssociationKey, JsonSerializerOptions jsonSerializerOptions)
        {
            if (trackedChangesEdFiStudentHomelessProgramAssociationKey.ProgramNameOption.IsSet && trackedChangesEdFiStudentHomelessProgramAssociationKey.ProgramName == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiStudentHomelessProgramAssociationKey.ProgramName), "Property is required for class TrackedChangesEdFiStudentHomelessProgramAssociationKey.");

            if (trackedChangesEdFiStudentHomelessProgramAssociationKey.ProgramTypeDescriptorOption.IsSet && trackedChangesEdFiStudentHomelessProgramAssociationKey.ProgramTypeDescriptor == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiStudentHomelessProgramAssociationKey.ProgramTypeDescriptor), "Property is required for class TrackedChangesEdFiStudentHomelessProgramAssociationKey.");

            if (trackedChangesEdFiStudentHomelessProgramAssociationKey.StudentUniqueIdOption.IsSet && trackedChangesEdFiStudentHomelessProgramAssociationKey.StudentUniqueId == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiStudentHomelessProgramAssociationKey.StudentUniqueId), "Property is required for class TrackedChangesEdFiStudentHomelessProgramAssociationKey.");

            if (trackedChangesEdFiStudentHomelessProgramAssociationKey.BeginDateOption.IsSet)
                writer.WriteString("beginDate", trackedChangesEdFiStudentHomelessProgramAssociationKey.BeginDateOption.Value!.Value.ToString(BeginDateFormat));

            if (trackedChangesEdFiStudentHomelessProgramAssociationKey.EducationOrganizationIdOption.IsSet)
                writer.WriteNumber("educationOrganizationId", trackedChangesEdFiStudentHomelessProgramAssociationKey.EducationOrganizationIdOption.Value!.Value);

            if (trackedChangesEdFiStudentHomelessProgramAssociationKey.ProgramEducationOrganizationIdOption.IsSet)
                writer.WriteNumber("programEducationOrganizationId", trackedChangesEdFiStudentHomelessProgramAssociationKey.ProgramEducationOrganizationIdOption.Value!.Value);

            if (trackedChangesEdFiStudentHomelessProgramAssociationKey.ProgramNameOption.IsSet)
                writer.WriteString("programName", trackedChangesEdFiStudentHomelessProgramAssociationKey.ProgramName);

            if (trackedChangesEdFiStudentHomelessProgramAssociationKey.ProgramTypeDescriptorOption.IsSet)
                writer.WriteString("programTypeDescriptor", trackedChangesEdFiStudentHomelessProgramAssociationKey.ProgramTypeDescriptor);

            if (trackedChangesEdFiStudentHomelessProgramAssociationKey.StudentUniqueIdOption.IsSet)
                writer.WriteString("studentUniqueId", trackedChangesEdFiStudentHomelessProgramAssociationKey.StudentUniqueId);
        }
    }
}
