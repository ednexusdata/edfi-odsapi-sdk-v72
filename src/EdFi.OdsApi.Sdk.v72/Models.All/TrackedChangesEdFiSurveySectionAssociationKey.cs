...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class TrackedChangesEdFiSurveySectionAssociationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiSurveySectionAssociationKey(string localCourseCode = default, long schoolId = default, int schoolYear = default, string sectionIdentifier = default, string sessionName = default, string varNamespace = default, string surveyIdentifier = default)
        {
