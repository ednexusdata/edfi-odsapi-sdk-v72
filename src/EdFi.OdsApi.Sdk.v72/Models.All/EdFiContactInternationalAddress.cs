...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiContactInternationalAddress : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiContactInternationalAddress(string addressTypeDescriptor, string countryDescriptor, string addressLine1, Option<string?> addressLine2 = default, Option<string?> addressLine3 = default, Option<string?> addressLine4 = default, Option<DateOnly?> beginDate = default, Option<DateOnly?> endDate = default, Option<string?> latitude = default, Option<string?> longitude = default, Option<Object?> ext = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiContactInternationalAddress" />
    /// </summary>
    public class EdFiContactInternationalAddressJsonConverter : JsonConverter<EdFiContactInternationalAddress>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="EdFiContactInternationalAddress" />
        /// </summary>
        ...
        public override EdFiContactInternationalAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!addressTypeDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiContactInternationalAddress.", nameof(addressTypeDescriptor));

            if (!countryDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiContactInternationalAddress.", nameof(countryDescriptor));

            if (!addressLine1.IsSet)
                throw new ArgumentException("Property is required for class EdFiContactInternationalAddress.", nameof(addressLine1));

            if (addressTypeDescriptor.IsSet && addressTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(addressTypeDescriptor), "Property is not nullable for class EdFiContactInternationalAddress.");

            if (countryDescriptor.IsSet && countryDescriptor.Value == null)
                throw new ArgumentNullException(nameof(countryDescriptor), "Property is not nullable for class EdFiContactInternationalAddress.");

            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class EdFiContactInternationalAddress.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiContactInternationalAddress.");

            return new EdFiContactInternationalAddress(addressTypeDescriptor.Value!, countryDescriptor.Value!, addressLine1.Value!, addressLine2, addressLine3, addressLine4, beginDate, endDate, latitude, longitude, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiContactInternationalAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiContactInternationalAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiContactInternationalAddress edFiContactInternationalAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiContactInternationalAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiContactInternationalAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiContactInternationalAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiContactInternationalAddress edFiContactInternationalAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiContactInternationalAddress.AddressTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiContactInternationalAddress.AddressTypeDescriptor), "Property is required for class EdFiContactInternationalAddress.");

            if (edFiContactInternationalAddress.CountryDescriptor == null)
                throw new ArgumentNullException(nameof(edFiContactInternationalAddress.CountryDescriptor), "Property is required for class EdFiContactInternationalAddress.");

            if (edFiContactInternationalAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(edFiContactInternationalAddress.AddressLine1), "Property is required for class EdFiContactInternationalAddress.");

            if (edFiContactInternationalAddress.ExtOption.IsSet && edFiContactInternationalAddress.Ext == null)
                throw new ArgumentNullException(nameof(edFiContactInternationalAddress.Ext), "Property is required for class EdFiContactInternationalAddress.");

            writer.WriteString("addressTypeDescriptor", edFiContactInternationalAddress.AddressTypeDescriptor);

            writer.WriteString("countryDescriptor", edFiContactInternationalAddress.CountryDescriptor);

            writer.WriteString("addressLine1", edFiContactInternationalAddress.AddressLine1);

            if (edFiContactInternationalAddress.AddressLine2Option.IsSet)
                if (edFiContactInternationalAddress.AddressLine2Option.Value != null)
                    writer.WriteString("addressLine2", edFiContactInternationalAddress.AddressLine2);
                else
                    writer.WriteNull("addressLine2");

            if (edFiContactInternationalAddress.AddressLine3Option.IsSet)
                if (edFiContactInternationalAddress.AddressLine3Option.Value != null)
                    writer.WriteString("addressLine3", edFiContactInternationalAddress.AddressLine3);
                else
                    writer.WriteNull("addressLine3");

            if (edFiContactInternationalAddress.AddressLine4Option.IsSet)
                if (edFiContactInternationalAddress.AddressLine4Option.Value != null)
                    writer.WriteString("addressLine4", edFiContactInternationalAddress.AddressLine4);
                else
                    writer.WriteNull("addressLine4");

            if (edFiContactInternationalAddress.BeginDateOption.IsSet)
                if (edFiContactInternationalAddress.BeginDateOption.Value != null)
                    writer.WriteString("beginDate", edFiContactInternationalAddress.BeginDateOption.Value!.Value.ToString(BeginDateFormat));
                else
                    writer.WriteNull("beginDate");

            if (edFiContactInternationalAddress.EndDateOption.IsSet)
                if (edFiContactInternationalAddress.EndDateOption.Value != null)
                    writer.WriteString("endDate", edFiContactInternationalAddress.EndDateOption.Value!.Value.ToString(EndDateFormat));
                else
                    writer.WriteNull("endDate");

            if (edFiContactInternationalAddress.LatitudeOption.IsSet)
                if (edFiContactInternationalAddress.LatitudeOption.Value != null)
                    writer.WriteString("latitude", edFiContactInternationalAddress.Latitude);
                else
                    writer.WriteNull("latitude");

            if (edFiContactInternationalAddress.LongitudeOption.IsSet)
                if (edFiContactInternationalAddress.LongitudeOption.Value != null)
                    writer.WriteString("longitude", edFiContactInternationalAddress.Longitude);
                else
                    writer.WriteNull("longitude");

            if (edFiContactInternationalAddress.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiContactInternationalAddress.Ext, jsonSerializerOptions);
            }
        }
    }
}
