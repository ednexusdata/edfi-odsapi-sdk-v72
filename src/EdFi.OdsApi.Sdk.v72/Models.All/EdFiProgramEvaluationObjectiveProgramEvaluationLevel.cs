...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_programEvaluationObjectiveProgramEvaluationLevel")]
    public partial class EdFiProgramEvaluationObjectiveProgramEvaluationLevel : IValidatableObject
    {
        ...
        protected EdFiProgramEvaluationObjectiveProgramEvaluationLevel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProgramEvaluationObjectiveProgramEvaluationLevel" /> class.
        /// </summary>
        ...
        public EdFiProgramEvaluationObjectiveProgramEvaluationLevel(string ratingLevelDescriptor = default, double? maxNumericRating = default, double? minNumericRating = default, Object ext = default)
        {
            // to ensure "ratingLevelDescriptor" is required (not null)
            if (ratingLevelDescriptor == null)
            {
                throw new ArgumentNullException("ratingLevelDescriptor is a required property for EdFiProgramEvaluationObjectiveProgramEvaluationLevel and cannot be null");
            }
