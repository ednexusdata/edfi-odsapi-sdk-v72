...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiStateEducationAgency : IValidatableObject
    {
        ...
        /// <param name="stateEducationAgencyId">The identifier assigned to a state education agency. It must be distinct from any other identifier assigned to educational organizations, such as a LocalEducationAgencyId, to prevent duplication. (required).</param>
        ...
        public EdFiStateEducationAgency(string id = default, List<EdFiEducationOrganizationCategory> categories = default, long stateEducationAgencyId = default, List<EdFiStateEducationAgencyAccountability> accountabilities = default, List<EdFiEducationOrganizationAddress> addresses = default, List<EdFiStateEducationAgencyFederalFunds> federalFunds = default, List<EdFiEducationOrganizationIdentificationCode> identificationCodes = default, List<EdFiEducationOrganizationIndicator> indicators = default, List<EdFiEducationOrganizationInstitutionTelephone> institutionTelephones = default, List<EdFiEducationOrganizationInternationalAddress> internationalAddresses = default, string nameOfInstitution = default, string operationalStatusDescriptor = default, string shortNameOfInstitution = default, string webSite = default, string etag = default, DateTime lastModifiedDate = default, Object ext = default)
        {
