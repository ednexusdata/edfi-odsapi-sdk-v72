...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiBalanceSheetDimension : IValidatableObject
    {
        ...
        public EdFiBalanceSheetDimension(string id = default, string code = default, int fiscalYear = default, string codeName = default, List<EdFiBalanceSheetDimensionReportingTag> reportingTags = default, string etag = default, DateTime lastModifiedDate = default, Object ext = default)
        {
