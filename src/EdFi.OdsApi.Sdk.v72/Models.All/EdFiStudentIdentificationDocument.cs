...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    public partial class EdFiStudentIdentificationDocument : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ext">Extensions to the StudentIdentificationDocument entity.</param>
        [JsonConstructor]
        ...
        /// <summary>
        /// Extensions to the StudentIdentificationDocument entity.
        /// </summary>
        /// <value>Extensions to the StudentIdentificationDocument entity.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiStudentIdentificationDocument" />
    /// </summary>
    public class EdFiStudentIdentificationDocumentJsonConverter : JsonConverter<EdFiStudentIdentificationDocument>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="EdFiStudentIdentificationDocument" />
        /// </summary>
        ...
        public override EdFiStudentIdentificationDocument Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!identificationDocumentUseDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiStudentIdentificationDocument.", nameof(identificationDocumentUseDescriptor));

            if (!personalInformationVerificationDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiStudentIdentificationDocument.", nameof(personalInformationVerificationDescriptor));

            if (identificationDocumentUseDescriptor.IsSet && identificationDocumentUseDescriptor.Value == null)
                throw new ArgumentNullException(nameof(identificationDocumentUseDescriptor), "Property is not nullable for class EdFiStudentIdentificationDocument.");

            if (personalInformationVerificationDescriptor.IsSet && personalInformationVerificationDescriptor.Value == null)
                throw new ArgumentNullException(nameof(personalInformationVerificationDescriptor), "Property is not nullable for class EdFiStudentIdentificationDocument.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiStudentIdentificationDocument.");

            return new EdFiStudentIdentificationDocument(identificationDocumentUseDescriptor.Value!, personalInformationVerificationDescriptor.Value!, issuerCountryDescriptor, documentExpirationDate, documentTitle, issuerDocumentIdentificationCode, issuerName, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiStudentIdentificationDocument" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiStudentIdentificationDocument"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiStudentIdentificationDocument edFiStudentIdentificationDocument, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiStudentIdentificationDocument, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiStudentIdentificationDocument" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiStudentIdentificationDocument"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentIdentificationDocument edFiStudentIdentificationDocument, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiStudentIdentificationDocument.IdentificationDocumentUseDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentIdentificationDocument.IdentificationDocumentUseDescriptor), "Property is required for class EdFiStudentIdentificationDocument.");

            if (edFiStudentIdentificationDocument.PersonalInformationVerificationDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentIdentificationDocument.PersonalInformationVerificationDescriptor), "Property is required for class EdFiStudentIdentificationDocument.");

            if (edFiStudentIdentificationDocument.ExtOption.IsSet && edFiStudentIdentificationDocument.Ext == null)
                throw new ArgumentNullException(nameof(edFiStudentIdentificationDocument.Ext), "Property is required for class EdFiStudentIdentificationDocument.");

            writer.WriteString("identificationDocumentUseDescriptor", edFiStudentIdentificationDocument.IdentificationDocumentUseDescriptor);

            writer.WriteString("personalInformationVerificationDescriptor", edFiStudentIdentificationDocument.PersonalInformationVerificationDescriptor);

            if (edFiStudentIdentificationDocument.IssuerCountryDescriptorOption.IsSet)
                if (edFiStudentIdentificationDocument.IssuerCountryDescriptorOption.Value != null)
                    writer.WriteString("issuerCountryDescriptor", edFiStudentIdentificationDocument.IssuerCountryDescriptor);
                else
                    writer.WriteNull("issuerCountryDescriptor");

            if (edFiStudentIdentificationDocument.DocumentExpirationDateOption.IsSet)
                if (edFiStudentIdentificationDocument.DocumentExpirationDateOption.Value != null)
                    writer.WriteString("documentExpirationDate", edFiStudentIdentificationDocument.DocumentExpirationDateOption.Value!.Value.ToString(DocumentExpirationDateFormat));
                else
                    writer.WriteNull("documentExpirationDate");

            if (edFiStudentIdentificationDocument.DocumentTitleOption.IsSet)
                if (edFiStudentIdentificationDocument.DocumentTitleOption.Value != null)
                    writer.WriteString("documentTitle", edFiStudentIdentificationDocument.DocumentTitle);
                else
                    writer.WriteNull("documentTitle");

            if (edFiStudentIdentificationDocument.IssuerDocumentIdentificationCodeOption.IsSet)
                if (edFiStudentIdentificationDocument.IssuerDocumentIdentificationCodeOption.Value != null)
                    writer.WriteString("issuerDocumentIdentificationCode", edFiStudentIdentificationDocument.IssuerDocumentIdentificationCode);
                else
                    writer.WriteNull("issuerDocumentIdentificationCode");

            if (edFiStudentIdentificationDocument.IssuerNameOption.IsSet)
                if (edFiStudentIdentificationDocument.IssuerNameOption.Value != null)
                    writer.WriteString("issuerName", edFiStudentIdentificationDocument.IssuerName);
                else
                    writer.WriteNull("issuerName");

            if (edFiStudentIdentificationDocument.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiStudentIdentificationDocument.Ext, jsonSerializerOptions);
            }
        }
    }
}
