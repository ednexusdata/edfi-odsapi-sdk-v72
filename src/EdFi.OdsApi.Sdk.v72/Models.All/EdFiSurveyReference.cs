...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiSurveyReference : IValidatableObject
    {
        ...
        public EdFiSurveyReference(string varNamespace = default, string surveyIdentifier = default, Link link = default)
        {
            // to ensure "varNamespace" is required (not null)
            if (varNamespace == null)
            {
                throw new ArgumentNullException("varNamespace is a required property for EdFiSurveyReference and cannot be null");
            }
