...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiObjectiveAssessmentPerformanceLevel : IValidatableObject
    {
        ...
        public EdFiObjectiveAssessmentPerformanceLevel(string assessmentReportingMethodDescriptor = default, string performanceLevelDescriptor = default, string resultDatatypeTypeDescriptor = default, string maximumScore = default, string minimumScore = default, string performanceLevelIndicatorName = default, Object ext = default)
        {
