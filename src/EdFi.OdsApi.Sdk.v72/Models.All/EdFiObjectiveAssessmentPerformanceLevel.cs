...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    public partial class EdFiObjectiveAssessmentPerformanceLevel : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ext">Extensions to the ObjectiveAssessmentPerformanceLevel entity.</param>
        [JsonConstructor]
        ...
        /// <summary>
        /// Extensions to the ObjectiveAssessmentPerformanceLevel entity.
        /// </summary>
        /// <value>Extensions to the ObjectiveAssessmentPerformanceLevel entity.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiObjectiveAssessmentPerformanceLevel" />
    /// </summary>
    public class EdFiObjectiveAssessmentPerformanceLevelJsonConverter : JsonConverter<EdFiObjectiveAssessmentPerformanceLevel>
    {
        /// <summary>
        /// Deserializes json to <see cref="EdFiObjectiveAssessmentPerformanceLevel" />
        /// </summary>
        ...
        public override EdFiObjectiveAssessmentPerformanceLevel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!assessmentReportingMethodDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiObjectiveAssessmentPerformanceLevel.", nameof(assessmentReportingMethodDescriptor));

            if (!performanceLevelDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiObjectiveAssessmentPerformanceLevel.", nameof(performanceLevelDescriptor));

            if (assessmentReportingMethodDescriptor.IsSet && assessmentReportingMethodDescriptor.Value == null)
                throw new ArgumentNullException(nameof(assessmentReportingMethodDescriptor), "Property is not nullable for class EdFiObjectiveAssessmentPerformanceLevel.");

            if (performanceLevelDescriptor.IsSet && performanceLevelDescriptor.Value == null)
                throw new ArgumentNullException(nameof(performanceLevelDescriptor), "Property is not nullable for class EdFiObjectiveAssessmentPerformanceLevel.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiObjectiveAssessmentPerformanceLevel.");

            return new EdFiObjectiveAssessmentPerformanceLevel(assessmentReportingMethodDescriptor.Value!, performanceLevelDescriptor.Value!, resultDatatypeTypeDescriptor, maximumScore, minimumScore, performanceLevelIndicatorName, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiObjectiveAssessmentPerformanceLevel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiObjectiveAssessmentPerformanceLevel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiObjectiveAssessmentPerformanceLevel edFiObjectiveAssessmentPerformanceLevel, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiObjectiveAssessmentPerformanceLevel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiObjectiveAssessmentPerformanceLevel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiObjectiveAssessmentPerformanceLevel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiObjectiveAssessmentPerformanceLevel edFiObjectiveAssessmentPerformanceLevel, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiObjectiveAssessmentPerformanceLevel.AssessmentReportingMethodDescriptor == null)
                throw new ArgumentNullException(nameof(edFiObjectiveAssessmentPerformanceLevel.AssessmentReportingMethodDescriptor), "Property is required for class EdFiObjectiveAssessmentPerformanceLevel.");

            if (edFiObjectiveAssessmentPerformanceLevel.PerformanceLevelDescriptor == null)
                throw new ArgumentNullException(nameof(edFiObjectiveAssessmentPerformanceLevel.PerformanceLevelDescriptor), "Property is required for class EdFiObjectiveAssessmentPerformanceLevel.");

            if (edFiObjectiveAssessmentPerformanceLevel.ExtOption.IsSet && edFiObjectiveAssessmentPerformanceLevel.Ext == null)
                throw new ArgumentNullException(nameof(edFiObjectiveAssessmentPerformanceLevel.Ext), "Property is required for class EdFiObjectiveAssessmentPerformanceLevel.");

            writer.WriteString("assessmentReportingMethodDescriptor", edFiObjectiveAssessmentPerformanceLevel.AssessmentReportingMethodDescriptor);

            writer.WriteString("performanceLevelDescriptor", edFiObjectiveAssessmentPerformanceLevel.PerformanceLevelDescriptor);

            if (edFiObjectiveAssessmentPerformanceLevel.ResultDatatypeTypeDescriptorOption.IsSet)
                if (edFiObjectiveAssessmentPerformanceLevel.ResultDatatypeTypeDescriptorOption.Value != null)
                    writer.WriteString("resultDatatypeTypeDescriptor", edFiObjectiveAssessmentPerformanceLevel.ResultDatatypeTypeDescriptor);
                else
                    writer.WriteNull("resultDatatypeTypeDescriptor");

            if (edFiObjectiveAssessmentPerformanceLevel.MaximumScoreOption.IsSet)
                if (edFiObjectiveAssessmentPerformanceLevel.MaximumScoreOption.Value != null)
                    writer.WriteString("maximumScore", edFiObjectiveAssessmentPerformanceLevel.MaximumScore);
                else
                    writer.WriteNull("maximumScore");

            if (edFiObjectiveAssessmentPerformanceLevel.MinimumScoreOption.IsSet)
                if (edFiObjectiveAssessmentPerformanceLevel.MinimumScoreOption.Value != null)
                    writer.WriteString("minimumScore", edFiObjectiveAssessmentPerformanceLevel.MinimumScore);
                else
                    writer.WriteNull("minimumScore");

            if (edFiObjectiveAssessmentPerformanceLevel.PerformanceLevelIndicatorNameOption.IsSet)
                if (edFiObjectiveAssessmentPerformanceLevel.PerformanceLevelIndicatorNameOption.Value != null)
                    writer.WriteString("performanceLevelIndicatorName", edFiObjectiveAssessmentPerformanceLevel.PerformanceLevelIndicatorName);
                else
                    writer.WriteNull("performanceLevelIndicatorName");

            if (edFiObjectiveAssessmentPerformanceLevel.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiObjectiveAssessmentPerformanceLevel.Ext, jsonSerializerOptions);
            }
        }
    }
}
