...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    public partial class EdFiStaffEducationOrganizationContactAssociationAddress : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ext">Extensions to the StaffEducationOrganizationContactAssociationAddress entity.</param>
        [JsonConstructor]
        public EdFiStaffEducationOrganizationContactAssociationAddress(string addressTypeDescriptor, string stateAbbreviationDescriptor, string city, string postalCode, string streetNumberName, Option<string?> localeDescriptor = default, Option<string?> apartmentRoomSuiteNumber = default, Option<string?> buildingSiteNumber = default, Option<string?> congressionalDistrict = default, Option<string?> countyFIPSCode = default, Option<bool?> doNotPublishIndicator = default, Option<string?> latitude = default, Option<string?> longitude = default, Option<string?> nameOfCounty = default, Option<List<EdFiStaffEducationOrganizationContactAssociationAddressPeriod>?> periods = default, Option<Object?> ext = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<EdFiStaffEducationOrganizationContactAssociationAddressPeriod>?> PeriodsOption { get; private set; }
        ...
        public List<EdFiStaffEducationOrganizationContactAssociationAddressPeriod>? Periods { get { return this.PeriodsOption; } set { this.PeriodsOption = new(value); } }
        ...
        /// <summary>
        /// Extensions to the StaffEducationOrganizationContactAssociationAddress entity.
        /// </summary>
        /// <value>Extensions to the StaffEducationOrganizationContactAssociationAddress entity.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiStaffEducationOrganizationContactAssociationAddress" />
    /// </summary>
    public class EdFiStaffEducationOrganizationContactAssociationAddressJsonConverter : JsonConverter<EdFiStaffEducationOrganizationContactAssociationAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="EdFiStaffEducationOrganizationContactAssociationAddress" />
        /// </summary>
        ...
        public override EdFiStaffEducationOrganizationContactAssociationAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<EdFiStaffEducationOrganizationContactAssociationAddressPeriod>?> periods = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "nameOfCounty":
                            ...
                            break;
                        case "periods":
                            periods = new Option<List<EdFiStaffEducationOrganizationContactAssociationAddressPeriod>?>(JsonSerializer.Deserialize<List<EdFiStaffEducationOrganizationContactAssociationAddressPeriod>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "_ext":
            ...
            if (!addressTypeDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiStaffEducationOrganizationContactAssociationAddress.", nameof(addressTypeDescriptor));

            if (!stateAbbreviationDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiStaffEducationOrganizationContactAssociationAddress.", nameof(stateAbbreviationDescriptor));

            if (!city.IsSet)
                throw new ArgumentException("Property is required for class EdFiStaffEducationOrganizationContactAssociationAddress.", nameof(city));

            if (!postalCode.IsSet)
                throw new ArgumentException("Property is required for class EdFiStaffEducationOrganizationContactAssociationAddress.", nameof(postalCode));

            if (!streetNumberName.IsSet)
                throw new ArgumentException("Property is required for class EdFiStaffEducationOrganizationContactAssociationAddress.", nameof(streetNumberName));

            if (addressTypeDescriptor.IsSet && addressTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(addressTypeDescriptor), "Property is not nullable for class EdFiStaffEducationOrganizationContactAssociationAddress.");

            if (stateAbbreviationDescriptor.IsSet && stateAbbreviationDescriptor.Value == null)
                throw new ArgumentNullException(nameof(stateAbbreviationDescriptor), "Property is not nullable for class EdFiStaffEducationOrganizationContactAssociationAddress.");

            if (city.IsSet && city.Value == null)
                throw new ArgumentNullException(nameof(city), "Property is not nullable for class EdFiStaffEducationOrganizationContactAssociationAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class EdFiStaffEducationOrganizationContactAssociationAddress.");

            if (streetNumberName.IsSet && streetNumberName.Value == null)
                throw new ArgumentNullException(nameof(streetNumberName), "Property is not nullable for class EdFiStaffEducationOrganizationContactAssociationAddress.");

            if (periods.IsSet && periods.Value == null)
                throw new ArgumentNullException(nameof(periods), "Property is not nullable for class EdFiStaffEducationOrganizationContactAssociationAddress.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiStaffEducationOrganizationContactAssociationAddress.");

            return new EdFiStaffEducationOrganizationContactAssociationAddress(addressTypeDescriptor.Value!, stateAbbreviationDescriptor.Value!, city.Value!, postalCode.Value!, streetNumberName.Value!, localeDescriptor, apartmentRoomSuiteNumber, buildingSiteNumber, congressionalDistrict, countyFIPSCode, doNotPublishIndicator, latitude, longitude, nameOfCounty, periods, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiStaffEducationOrganizationContactAssociationAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiStaffEducationOrganizationContactAssociationAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiStaffEducationOrganizationContactAssociationAddress edFiStaffEducationOrganizationContactAssociationAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiStaffEducationOrganizationContactAssociationAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiStaffEducationOrganizationContactAssociationAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiStaffEducationOrganizationContactAssociationAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiStaffEducationOrganizationContactAssociationAddress edFiStaffEducationOrganizationContactAssociationAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiStaffEducationOrganizationContactAssociationAddress.AddressTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStaffEducationOrganizationContactAssociationAddress.AddressTypeDescriptor), "Property is required for class EdFiStaffEducationOrganizationContactAssociationAddress.");

            if (edFiStaffEducationOrganizationContactAssociationAddress.StateAbbreviationDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStaffEducationOrganizationContactAssociationAddress.StateAbbreviationDescriptor), "Property is required for class EdFiStaffEducationOrganizationContactAssociationAddress.");

            if (edFiStaffEducationOrganizationContactAssociationAddress.City == null)
                throw new ArgumentNullException(nameof(edFiStaffEducationOrganizationContactAssociationAddress.City), "Property is required for class EdFiStaffEducationOrganizationContactAssociationAddress.");

            if (edFiStaffEducationOrganizationContactAssociationAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(edFiStaffEducationOrganizationContactAssociationAddress.PostalCode), "Property is required for class EdFiStaffEducationOrganizationContactAssociationAddress.");

            if (edFiStaffEducationOrganizationContactAssociationAddress.StreetNumberName == null)
                throw new ArgumentNullException(nameof(edFiStaffEducationOrganizationContactAssociationAddress.StreetNumberName), "Property is required for class EdFiStaffEducationOrganizationContactAssociationAddress.");

            if (edFiStaffEducationOrganizationContactAssociationAddress.PeriodsOption.IsSet && edFiStaffEducationOrganizationContactAssociationAddress.Periods == null)
                throw new ArgumentNullException(nameof(edFiStaffEducationOrganizationContactAssociationAddress.Periods), "Property is required for class EdFiStaffEducationOrganizationContactAssociationAddress.");

            if (edFiStaffEducationOrganizationContactAssociationAddress.ExtOption.IsSet && edFiStaffEducationOrganizationContactAssociationAddress.Ext == null)
                throw new ArgumentNullException(nameof(edFiStaffEducationOrganizationContactAssociationAddress.Ext), "Property is required for class EdFiStaffEducationOrganizationContactAssociationAddress.");

            writer.WriteString("addressTypeDescriptor", edFiStaffEducationOrganizationContactAssociationAddress.AddressTypeDescriptor);

            writer.WriteString("stateAbbreviationDescriptor", edFiStaffEducationOrganizationContactAssociationAddress.StateAbbreviationDescriptor);

            writer.WriteString("city", edFiStaffEducationOrganizationContactAssociationAddress.City);

            writer.WriteString("postalCode", edFiStaffEducationOrganizationContactAssociationAddress.PostalCode);

            writer.WriteString("streetNumberName", edFiStaffEducationOrganizationContactAssociationAddress.StreetNumberName);

            if (edFiStaffEducationOrganizationContactAssociationAddress.LocaleDescriptorOption.IsSet)
                if (edFiStaffEducationOrganizationContactAssociationAddress.LocaleDescriptorOption.Value != null)
                    writer.WriteString("localeDescriptor", edFiStaffEducationOrganizationContactAssociationAddress.LocaleDescriptor);
                else
                    writer.WriteNull("localeDescriptor");

            if (edFiStaffEducationOrganizationContactAssociationAddress.ApartmentRoomSuiteNumberOption.IsSet)
                if (edFiStaffEducationOrganizationContactAssociationAddress.ApartmentRoomSuiteNumberOption.Value != null)
                    writer.WriteString("apartmentRoomSuiteNumber", edFiStaffEducationOrganizationContactAssociationAddress.ApartmentRoomSuiteNumber);
                else
                    writer.WriteNull("apartmentRoomSuiteNumber");

            if (edFiStaffEducationOrganizationContactAssociationAddress.BuildingSiteNumberOption.IsSet)
                if (edFiStaffEducationOrganizationContactAssociationAddress.BuildingSiteNumberOption.Value != null)
                    writer.WriteString("buildingSiteNumber", edFiStaffEducationOrganizationContactAssociationAddress.BuildingSiteNumber);
                else
                    writer.WriteNull("buildingSiteNumber");

            if (edFiStaffEducationOrganizationContactAssociationAddress.CongressionalDistrictOption.IsSet)
                if (edFiStaffEducationOrganizationContactAssociationAddress.CongressionalDistrictOption.Value != null)
                    writer.WriteString("congressionalDistrict", edFiStaffEducationOrganizationContactAssociationAddress.CongressionalDistrict);
                else
                    writer.WriteNull("congressionalDistrict");

            if (edFiStaffEducationOrganizationContactAssociationAddress.CountyFIPSCodeOption.IsSet)
                if (edFiStaffEducationOrganizationContactAssociationAddress.CountyFIPSCodeOption.Value != null)
                    writer.WriteString("countyFIPSCode", edFiStaffEducationOrganizationContactAssociationAddress.CountyFIPSCode);
                else
                    writer.WriteNull("countyFIPSCode");

            if (edFiStaffEducationOrganizationContactAssociationAddress.DoNotPublishIndicatorOption.IsSet)
                if (edFiStaffEducationOrganizationContactAssociationAddress.DoNotPublishIndicatorOption.Value != null)
                    writer.WriteBoolean("doNotPublishIndicator", edFiStaffEducationOrganizationContactAssociationAddress.DoNotPublishIndicatorOption.Value!.Value);
                else
                    writer.WriteNull("doNotPublishIndicator");

            if (edFiStaffEducationOrganizationContactAssociationAddress.LatitudeOption.IsSet)
                if (edFiStaffEducationOrganizationContactAssociationAddress.LatitudeOption.Value != null)
                    writer.WriteString("latitude", edFiStaffEducationOrganizationContactAssociationAddress.Latitude);
                else
                    writer.WriteNull("latitude");

            if (edFiStaffEducationOrganizationContactAssociationAddress.LongitudeOption.IsSet)
                if (edFiStaffEducationOrganizationContactAssociationAddress.LongitudeOption.Value != null)
                    writer.WriteString("longitude", edFiStaffEducationOrganizationContactAssociationAddress.Longitude);
                else
                    writer.WriteNull("longitude");

            if (edFiStaffEducationOrganizationContactAssociationAddress.NameOfCountyOption.IsSet)
                if (edFiStaffEducationOrganizationContactAssociationAddress.NameOfCountyOption.Value != null)
                    writer.WriteString("nameOfCounty", edFiStaffEducationOrganizationContactAssociationAddress.NameOfCounty);
                else
                    writer.WriteNull("nameOfCounty");

            if (edFiStaffEducationOrganizationContactAssociationAddress.PeriodsOption.IsSet)
            {
                writer.WritePropertyName("periods");
                JsonSerializer.Serialize(writer, edFiStaffEducationOrganizationContactAssociationAddress.Periods, jsonSerializerOptions);
            }
            if (edFiStaffEducationOrganizationContactAssociationAddress.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiStaffEducationOrganizationContactAssociationAddress.Ext, jsonSerializerOptions);
            }
        }
    }
}
