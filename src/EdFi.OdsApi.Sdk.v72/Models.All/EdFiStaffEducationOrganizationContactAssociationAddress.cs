...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiStaffEducationOrganizationContactAssociationAddress : IValidatableObject
    {
        ...
        public EdFiStaffEducationOrganizationContactAssociationAddress(string addressTypeDescriptor = default, string localeDescriptor = default, string stateAbbreviationDescriptor = default, string apartmentRoomSuiteNumber = default, string buildingSiteNumber = default, string city = default, string congressionalDistrict = default, string countyFIPSCode = default, bool? doNotPublishIndicator = default, string latitude = default, string longitude = default, string nameOfCounty = default, string postalCode = default, string streetNumberName = default, List<EdFiStaffEducationOrganizationContactAssociationAddressPeriod> periods = default, Object ext = default)
        {
