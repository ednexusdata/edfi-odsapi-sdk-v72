...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiCourseOfferingReference : IValidatableObject
    {
        ...
        public EdFiCourseOfferingReference(string localCourseCode = default, long schoolId = default, int schoolYear = default, string sessionName = default, Link link = default)
        {
