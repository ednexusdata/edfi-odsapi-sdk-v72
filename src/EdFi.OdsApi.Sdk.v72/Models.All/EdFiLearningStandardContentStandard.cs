...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiLearningStandardContentStandard : IValidatableObject
    {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<EdFiLearningStandardContentStandardAuthor>?> AuthorsOption { get; private set; }
        ...
        public List<EdFiLearningStandardContentStandardAuthor>? Authors { get { return this.AuthorsOption; } set { this.AuthorsOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiLearningStandardContentStandard" />
    /// </summary>
    public class EdFiLearningStandardContentStandardJsonConverter : JsonConverter<EdFiLearningStandardContentStandard>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="EdFiLearningStandardContentStandard" />
        /// </summary>
        ...
        public override EdFiLearningStandardContentStandard Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<EdFiLearningStandardContentStandardAuthor>?> authors = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "mandatingEducationOrganizationReference":
                            ...
                            break;
                        case "authors":
                            authors = new Option<List<EdFiLearningStandardContentStandardAuthor>?>(JsonSerializer.Deserialize<List<EdFiLearningStandardContentStandardAuthor>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "_ext":
            ...
            if (!title.IsSet)
                throw new ArgumentException("Property is required for class EdFiLearningStandardContentStandard.", nameof(title));

            if (title.IsSet && title.Value == null)
                throw new ArgumentNullException(nameof(title), "Property is not nullable for class EdFiLearningStandardContentStandard.");

            if (mandatingEducationOrganizationReference.IsSet && mandatingEducationOrganizationReference.Value == null)
                throw new ArgumentNullException(nameof(mandatingEducationOrganizationReference), "Property is not nullable for class EdFiLearningStandardContentStandard.");

            if (authors.IsSet && authors.Value == null)
                throw new ArgumentNullException(nameof(authors), "Property is not nullable for class EdFiLearningStandardContentStandard.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiLearningStandardContentStandard.");

            return new EdFiLearningStandardContentStandard(title.Value!, publicationStatusDescriptor, beginDate, endDate, publicationDate, publicationYear, uri, varVersion, mandatingEducationOrganizationReference, authors, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiLearningStandardContentStandard" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiLearningStandardContentStandard"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiLearningStandardContentStandard edFiLearningStandardContentStandard, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiLearningStandardContentStandard, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiLearningStandardContentStandard" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiLearningStandardContentStandard"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiLearningStandardContentStandard edFiLearningStandardContentStandard, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiLearningStandardContentStandard.Title == null)
                throw new ArgumentNullException(nameof(edFiLearningStandardContentStandard.Title), "Property is required for class EdFiLearningStandardContentStandard.");

            if (edFiLearningStandardContentStandard.MandatingEducationOrganizationReferenceOption.IsSet && edFiLearningStandardContentStandard.MandatingEducationOrganizationReference == null)
                throw new ArgumentNullException(nameof(edFiLearningStandardContentStandard.MandatingEducationOrganizationReference), "Property is required for class EdFiLearningStandardContentStandard.");

            if (edFiLearningStandardContentStandard.AuthorsOption.IsSet && edFiLearningStandardContentStandard.Authors == null)
                throw new ArgumentNullException(nameof(edFiLearningStandardContentStandard.Authors), "Property is required for class EdFiLearningStandardContentStandard.");

            if (edFiLearningStandardContentStandard.ExtOption.IsSet && edFiLearningStandardContentStandard.Ext == null)
                throw new ArgumentNullException(nameof(edFiLearningStandardContentStandard.Ext), "Property is required for class EdFiLearningStandardContentStandard.");

            writer.WriteString("title", edFiLearningStandardContentStandard.Title);

            if (edFiLearningStandardContentStandard.PublicationStatusDescriptorOption.IsSet)
                if (edFiLearningStandardContentStandard.PublicationStatusDescriptorOption.Value != null)
                    writer.WriteString("publicationStatusDescriptor", edFiLearningStandardContentStandard.PublicationStatusDescriptor);
                else
                    writer.WriteNull("publicationStatusDescriptor");

            if (edFiLearningStandardContentStandard.BeginDateOption.IsSet)
                if (edFiLearningStandardContentStandard.BeginDateOption.Value != null)
                    writer.WriteString("beginDate", edFiLearningStandardContentStandard.BeginDateOption.Value!.Value.ToString(BeginDateFormat));
                else
                    writer.WriteNull("beginDate");

            if (edFiLearningStandardContentStandard.EndDateOption.IsSet)
                if (edFiLearningStandardContentStandard.EndDateOption.Value != null)
                    writer.WriteString("endDate", edFiLearningStandardContentStandard.EndDateOption.Value!.Value.ToString(EndDateFormat));
                else
                    writer.WriteNull("endDate");

            if (edFiLearningStandardContentStandard.PublicationDateOption.IsSet)
                if (edFiLearningStandardContentStandard.PublicationDateOption.Value != null)
                    writer.WriteString("publicationDate", edFiLearningStandardContentStandard.PublicationDateOption.Value!.Value.ToString(PublicationDateFormat));
                else
                    writer.WriteNull("publicationDate");

            if (edFiLearningStandardContentStandard.PublicationYearOption.IsSet)
                if (edFiLearningStandardContentStandard.PublicationYearOption.Value != null)
                    writer.WriteNumber("publicationYear", edFiLearningStandardContentStandard.PublicationYearOption.Value!.Value);
                else
                    writer.WriteNull("publicationYear");

            if (edFiLearningStandardContentStandard.UriOption.IsSet)
                if (edFiLearningStandardContentStandard.UriOption.Value != null)
                    writer.WriteString("uri", edFiLearningStandardContentStandard.Uri);
                else
                    writer.WriteNull("uri");

            if (edFiLearningStandardContentStandard.VarVersionOption.IsSet)
                if (edFiLearningStandardContentStandard.VarVersionOption.Value != null)
                    writer.WriteString("version", edFiLearningStandardContentStandard.VarVersion);
                else
                    writer.WriteNull("version");

            if (edFiLearningStandardContentStandard.MandatingEducationOrganizationReferenceOption.IsSet)
            {
                writer.WritePropertyName("mandatingEducationOrganizationReference");
                JsonSerializer.Serialize(writer, edFiLearningStandardContentStandard.MandatingEducationOrganizationReference, jsonSerializerOptions);
            }
            if (edFiLearningStandardContentStandard.AuthorsOption.IsSet)
            {
                writer.WritePropertyName("authors");
                JsonSerializer.Serialize(writer, edFiLearningStandardContentStandard.Authors, jsonSerializerOptions);
            }
            if (edFiLearningStandardContentStandard.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiLearningStandardContentStandard.Ext, jsonSerializerOptions);
            }
        }
    }
}
