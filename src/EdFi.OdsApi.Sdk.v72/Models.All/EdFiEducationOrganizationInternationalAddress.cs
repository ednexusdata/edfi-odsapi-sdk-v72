...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiEducationOrganizationInternationalAddress : IValidatableObject
    {
        ...
        public EdFiEducationOrganizationInternationalAddress(string addressTypeDescriptor = default, string countryDescriptor = default, string addressLine1 = default, string addressLine2 = default, string addressLine3 = default, string addressLine4 = default, DateOnly? beginDate = default, DateOnly? endDate = default, string latitude = default, string longitude = default, Object ext = default)
        {
