...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    public partial class EdFiEducationOrganizationInternationalAddress : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ext">Extensions to the EducationOrganizationInternationalAddress entity.</param>
        [JsonConstructor]
        public EdFiEducationOrganizationInternationalAddress(string addressTypeDescriptor, string countryDescriptor, string addressLine1, Option<string?> addressLine2 = default, Option<string?> addressLine3 = default, Option<string?> addressLine4 = default, Option<DateOnly?> beginDate = default, Option<DateOnly?> endDate = default, Option<string?> latitude = default, Option<string?> longitude = default, Option<Object?> ext = default)
        {
        ...
        /// <summary>
        /// Extensions to the EducationOrganizationInternationalAddress entity.
        /// </summary>
        /// <value>Extensions to the EducationOrganizationInternationalAddress entity.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiEducationOrganizationInternationalAddress" />
    /// </summary>
    public class EdFiEducationOrganizationInternationalAddressJsonConverter : JsonConverter<EdFiEducationOrganizationInternationalAddress>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="EdFiEducationOrganizationInternationalAddress" />
        /// </summary>
        ...
        public override EdFiEducationOrganizationInternationalAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!addressTypeDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiEducationOrganizationInternationalAddress.", nameof(addressTypeDescriptor));

            if (!countryDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiEducationOrganizationInternationalAddress.", nameof(countryDescriptor));

            if (!addressLine1.IsSet)
                throw new ArgumentException("Property is required for class EdFiEducationOrganizationInternationalAddress.", nameof(addressLine1));

            if (addressTypeDescriptor.IsSet && addressTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(addressTypeDescriptor), "Property is not nullable for class EdFiEducationOrganizationInternationalAddress.");

            if (countryDescriptor.IsSet && countryDescriptor.Value == null)
                throw new ArgumentNullException(nameof(countryDescriptor), "Property is not nullable for class EdFiEducationOrganizationInternationalAddress.");

            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class EdFiEducationOrganizationInternationalAddress.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiEducationOrganizationInternationalAddress.");

            return new EdFiEducationOrganizationInternationalAddress(addressTypeDescriptor.Value!, countryDescriptor.Value!, addressLine1.Value!, addressLine2, addressLine3, addressLine4, beginDate, endDate, latitude, longitude, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiEducationOrganizationInternationalAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiEducationOrganizationInternationalAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiEducationOrganizationInternationalAddress edFiEducationOrganizationInternationalAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiEducationOrganizationInternationalAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiEducationOrganizationInternationalAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiEducationOrganizationInternationalAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiEducationOrganizationInternationalAddress edFiEducationOrganizationInternationalAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiEducationOrganizationInternationalAddress.AddressTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiEducationOrganizationInternationalAddress.AddressTypeDescriptor), "Property is required for class EdFiEducationOrganizationInternationalAddress.");

            if (edFiEducationOrganizationInternationalAddress.CountryDescriptor == null)
                throw new ArgumentNullException(nameof(edFiEducationOrganizationInternationalAddress.CountryDescriptor), "Property is required for class EdFiEducationOrganizationInternationalAddress.");

            if (edFiEducationOrganizationInternationalAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(edFiEducationOrganizationInternationalAddress.AddressLine1), "Property is required for class EdFiEducationOrganizationInternationalAddress.");

            if (edFiEducationOrganizationInternationalAddress.ExtOption.IsSet && edFiEducationOrganizationInternationalAddress.Ext == null)
                throw new ArgumentNullException(nameof(edFiEducationOrganizationInternationalAddress.Ext), "Property is required for class EdFiEducationOrganizationInternationalAddress.");

            writer.WriteString("addressTypeDescriptor", edFiEducationOrganizationInternationalAddress.AddressTypeDescriptor);

            writer.WriteString("countryDescriptor", edFiEducationOrganizationInternationalAddress.CountryDescriptor);

            writer.WriteString("addressLine1", edFiEducationOrganizationInternationalAddress.AddressLine1);

            if (edFiEducationOrganizationInternationalAddress.AddressLine2Option.IsSet)
                if (edFiEducationOrganizationInternationalAddress.AddressLine2Option.Value != null)
                    writer.WriteString("addressLine2", edFiEducationOrganizationInternationalAddress.AddressLine2);
                else
                    writer.WriteNull("addressLine2");

            if (edFiEducationOrganizationInternationalAddress.AddressLine3Option.IsSet)
                if (edFiEducationOrganizationInternationalAddress.AddressLine3Option.Value != null)
                    writer.WriteString("addressLine3", edFiEducationOrganizationInternationalAddress.AddressLine3);
                else
                    writer.WriteNull("addressLine3");

            if (edFiEducationOrganizationInternationalAddress.AddressLine4Option.IsSet)
                if (edFiEducationOrganizationInternationalAddress.AddressLine4Option.Value != null)
                    writer.WriteString("addressLine4", edFiEducationOrganizationInternationalAddress.AddressLine4);
                else
                    writer.WriteNull("addressLine4");

            if (edFiEducationOrganizationInternationalAddress.BeginDateOption.IsSet)
                if (edFiEducationOrganizationInternationalAddress.BeginDateOption.Value != null)
                    writer.WriteString("beginDate", edFiEducationOrganizationInternationalAddress.BeginDateOption.Value!.Value.ToString(BeginDateFormat));
                else
                    writer.WriteNull("beginDate");

            if (edFiEducationOrganizationInternationalAddress.EndDateOption.IsSet)
                if (edFiEducationOrganizationInternationalAddress.EndDateOption.Value != null)
                    writer.WriteString("endDate", edFiEducationOrganizationInternationalAddress.EndDateOption.Value!.Value.ToString(EndDateFormat));
                else
                    writer.WriteNull("endDate");

            if (edFiEducationOrganizationInternationalAddress.LatitudeOption.IsSet)
                if (edFiEducationOrganizationInternationalAddress.LatitudeOption.Value != null)
                    writer.WriteString("latitude", edFiEducationOrganizationInternationalAddress.Latitude);
                else
                    writer.WriteNull("latitude");

            if (edFiEducationOrganizationInternationalAddress.LongitudeOption.IsSet)
                if (edFiEducationOrganizationInternationalAddress.LongitudeOption.Value != null)
                    writer.WriteString("longitude", edFiEducationOrganizationInternationalAddress.Longitude);
                else
                    writer.WriteNull("longitude");

            if (edFiEducationOrganizationInternationalAddress.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiEducationOrganizationInternationalAddress.Ext, jsonSerializerOptions);
            }
        }
    }
}
