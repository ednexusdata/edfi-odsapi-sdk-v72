...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    public partial class EdFiGraduationPlanRequiredAssessmentPerformanceLevel : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ext">Extensions to the GraduationPlanRequiredAssessmentPerformanceLevel entity.</param>
        [JsonConstructor]
        public EdFiGraduationPlanRequiredAssessmentPerformanceLevel(string assessmentReportingMethodDescriptor, string performanceLevelDescriptor, Option<string?> resultDatatypeTypeDescriptor = default, Option<string?> maximumScore = default, Option<string?> minimumScore = default, Option<string?> performanceLevelIndicatorName = default, Option<Object?> ext = default)
        {
        ...
        /// <summary>
        /// Extensions to the GraduationPlanRequiredAssessmentPerformanceLevel entity.
        /// </summary>
        /// <value>Extensions to the GraduationPlanRequiredAssessmentPerformanceLevel entity.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiGraduationPlanRequiredAssessmentPerformanceLevel" />
    /// </summary>
    public class EdFiGraduationPlanRequiredAssessmentPerformanceLevelJsonConverter : JsonConverter<EdFiGraduationPlanRequiredAssessmentPerformanceLevel>
    {
        /// <summary>
        /// Deserializes json to <see cref="EdFiGraduationPlanRequiredAssessmentPerformanceLevel" />
        /// </summary>
        ...
        public override EdFiGraduationPlanRequiredAssessmentPerformanceLevel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!assessmentReportingMethodDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiGraduationPlanRequiredAssessmentPerformanceLevel.", nameof(assessmentReportingMethodDescriptor));

            if (!performanceLevelDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiGraduationPlanRequiredAssessmentPerformanceLevel.", nameof(performanceLevelDescriptor));

            if (assessmentReportingMethodDescriptor.IsSet && assessmentReportingMethodDescriptor.Value == null)
                throw new ArgumentNullException(nameof(assessmentReportingMethodDescriptor), "Property is not nullable for class EdFiGraduationPlanRequiredAssessmentPerformanceLevel.");

            if (performanceLevelDescriptor.IsSet && performanceLevelDescriptor.Value == null)
                throw new ArgumentNullException(nameof(performanceLevelDescriptor), "Property is not nullable for class EdFiGraduationPlanRequiredAssessmentPerformanceLevel.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiGraduationPlanRequiredAssessmentPerformanceLevel.");

            return new EdFiGraduationPlanRequiredAssessmentPerformanceLevel(assessmentReportingMethodDescriptor.Value!, performanceLevelDescriptor.Value!, resultDatatypeTypeDescriptor, maximumScore, minimumScore, performanceLevelIndicatorName, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiGraduationPlanRequiredAssessmentPerformanceLevel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiGraduationPlanRequiredAssessmentPerformanceLevel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiGraduationPlanRequiredAssessmentPerformanceLevel edFiGraduationPlanRequiredAssessmentPerformanceLevel, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiGraduationPlanRequiredAssessmentPerformanceLevel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiGraduationPlanRequiredAssessmentPerformanceLevel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiGraduationPlanRequiredAssessmentPerformanceLevel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiGraduationPlanRequiredAssessmentPerformanceLevel edFiGraduationPlanRequiredAssessmentPerformanceLevel, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiGraduationPlanRequiredAssessmentPerformanceLevel.AssessmentReportingMethodDescriptor == null)
                throw new ArgumentNullException(nameof(edFiGraduationPlanRequiredAssessmentPerformanceLevel.AssessmentReportingMethodDescriptor), "Property is required for class EdFiGraduationPlanRequiredAssessmentPerformanceLevel.");

            if (edFiGraduationPlanRequiredAssessmentPerformanceLevel.PerformanceLevelDescriptor == null)
                throw new ArgumentNullException(nameof(edFiGraduationPlanRequiredAssessmentPerformanceLevel.PerformanceLevelDescriptor), "Property is required for class EdFiGraduationPlanRequiredAssessmentPerformanceLevel.");

            if (edFiGraduationPlanRequiredAssessmentPerformanceLevel.ExtOption.IsSet && edFiGraduationPlanRequiredAssessmentPerformanceLevel.Ext == null)
                throw new ArgumentNullException(nameof(edFiGraduationPlanRequiredAssessmentPerformanceLevel.Ext), "Property is required for class EdFiGraduationPlanRequiredAssessmentPerformanceLevel.");

            writer.WriteString("assessmentReportingMethodDescriptor", edFiGraduationPlanRequiredAssessmentPerformanceLevel.AssessmentReportingMethodDescriptor);

            writer.WriteString("performanceLevelDescriptor", edFiGraduationPlanRequiredAssessmentPerformanceLevel.PerformanceLevelDescriptor);

            if (edFiGraduationPlanRequiredAssessmentPerformanceLevel.ResultDatatypeTypeDescriptorOption.IsSet)
                if (edFiGraduationPlanRequiredAssessmentPerformanceLevel.ResultDatatypeTypeDescriptorOption.Value != null)
                    writer.WriteString("resultDatatypeTypeDescriptor", edFiGraduationPlanRequiredAssessmentPerformanceLevel.ResultDatatypeTypeDescriptor);
                else
                    writer.WriteNull("resultDatatypeTypeDescriptor");

            if (edFiGraduationPlanRequiredAssessmentPerformanceLevel.MaximumScoreOption.IsSet)
                if (edFiGraduationPlanRequiredAssessmentPerformanceLevel.MaximumScoreOption.Value != null)
                    writer.WriteString("maximumScore", edFiGraduationPlanRequiredAssessmentPerformanceLevel.MaximumScore);
                else
                    writer.WriteNull("maximumScore");

            if (edFiGraduationPlanRequiredAssessmentPerformanceLevel.MinimumScoreOption.IsSet)
                if (edFiGraduationPlanRequiredAssessmentPerformanceLevel.MinimumScoreOption.Value != null)
                    writer.WriteString("minimumScore", edFiGraduationPlanRequiredAssessmentPerformanceLevel.MinimumScore);
                else
                    writer.WriteNull("minimumScore");

            if (edFiGraduationPlanRequiredAssessmentPerformanceLevel.PerformanceLevelIndicatorNameOption.IsSet)
                if (edFiGraduationPlanRequiredAssessmentPerformanceLevel.PerformanceLevelIndicatorNameOption.Value != null)
                    writer.WriteString("performanceLevelIndicatorName", edFiGraduationPlanRequiredAssessmentPerformanceLevel.PerformanceLevelIndicatorName);
                else
                    writer.WriteNull("performanceLevelIndicatorName");

            if (edFiGraduationPlanRequiredAssessmentPerformanceLevel.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiGraduationPlanRequiredAssessmentPerformanceLevel.Ext, jsonSerializerOptions);
            }
        }
    }
}
