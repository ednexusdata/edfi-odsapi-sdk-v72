...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    public partial class TrackedChangesEdFiStudentCTEProgramAssociationKey : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="TrackedChangesEdFiStudentCTEProgramAssociationKey" />
    /// </summary>
    public class TrackedChangesEdFiStudentCTEProgramAssociationKeyJsonConverter : JsonConverter<TrackedChangesEdFiStudentCTEProgramAssociationKey>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="TrackedChangesEdFiStudentCTEProgramAssociationKey" />
        /// </summary>
        ...
        public override TrackedChangesEdFiStudentCTEProgramAssociationKey Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (beginDate.IsSet && beginDate.Value == null)
                throw new ArgumentNullException(nameof(beginDate), "Property is not nullable for class TrackedChangesEdFiStudentCTEProgramAssociationKey.");

            if (educationOrganizationId.IsSet && educationOrganizationId.Value == null)
                throw new ArgumentNullException(nameof(educationOrganizationId), "Property is not nullable for class TrackedChangesEdFiStudentCTEProgramAssociationKey.");

            if (programEducationOrganizationId.IsSet && programEducationOrganizationId.Value == null)
                throw new ArgumentNullException(nameof(programEducationOrganizationId), "Property is not nullable for class TrackedChangesEdFiStudentCTEProgramAssociationKey.");

            if (programName.IsSet && programName.Value == null)
                throw new ArgumentNullException(nameof(programName), "Property is not nullable for class TrackedChangesEdFiStudentCTEProgramAssociationKey.");

            if (programTypeDescriptor.IsSet && programTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(programTypeDescriptor), "Property is not nullable for class TrackedChangesEdFiStudentCTEProgramAssociationKey.");

            if (studentUniqueId.IsSet && studentUniqueId.Value == null)
                throw new ArgumentNullException(nameof(studentUniqueId), "Property is not nullable for class TrackedChangesEdFiStudentCTEProgramAssociationKey.");

            return new TrackedChangesEdFiStudentCTEProgramAssociationKey(beginDate, educationOrganizationId, programEducationOrganizationId, programName, programTypeDescriptor, studentUniqueId);
        }

        /// <summary>
        /// Serializes a <see cref="TrackedChangesEdFiStudentCTEProgramAssociationKey" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="trackedChangesEdFiStudentCTEProgramAssociationKey"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TrackedChangesEdFiStudentCTEProgramAssociationKey trackedChangesEdFiStudentCTEProgramAssociationKey, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, trackedChangesEdFiStudentCTEProgramAssociationKey, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TrackedChangesEdFiStudentCTEProgramAssociationKey" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="trackedChangesEdFiStudentCTEProgramAssociationKey"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TrackedChangesEdFiStudentCTEProgramAssociationKey trackedChangesEdFiStudentCTEProgramAssociationKey, JsonSerializerOptions jsonSerializerOptions)
        {
            if (trackedChangesEdFiStudentCTEProgramAssociationKey.ProgramNameOption.IsSet && trackedChangesEdFiStudentCTEProgramAssociationKey.ProgramName == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiStudentCTEProgramAssociationKey.ProgramName), "Property is required for class TrackedChangesEdFiStudentCTEProgramAssociationKey.");

            if (trackedChangesEdFiStudentCTEProgramAssociationKey.ProgramTypeDescriptorOption.IsSet && trackedChangesEdFiStudentCTEProgramAssociationKey.ProgramTypeDescriptor == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiStudentCTEProgramAssociationKey.ProgramTypeDescriptor), "Property is required for class TrackedChangesEdFiStudentCTEProgramAssociationKey.");

            if (trackedChangesEdFiStudentCTEProgramAssociationKey.StudentUniqueIdOption.IsSet && trackedChangesEdFiStudentCTEProgramAssociationKey.StudentUniqueId == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiStudentCTEProgramAssociationKey.StudentUniqueId), "Property is required for class TrackedChangesEdFiStudentCTEProgramAssociationKey.");

            if (trackedChangesEdFiStudentCTEProgramAssociationKey.BeginDateOption.IsSet)
                writer.WriteString("beginDate", trackedChangesEdFiStudentCTEProgramAssociationKey.BeginDateOption.Value!.Value.ToString(BeginDateFormat));

            if (trackedChangesEdFiStudentCTEProgramAssociationKey.EducationOrganizationIdOption.IsSet)
                writer.WriteNumber("educationOrganizationId", trackedChangesEdFiStudentCTEProgramAssociationKey.EducationOrganizationIdOption.Value!.Value);

            if (trackedChangesEdFiStudentCTEProgramAssociationKey.ProgramEducationOrganizationIdOption.IsSet)
                writer.WriteNumber("programEducationOrganizationId", trackedChangesEdFiStudentCTEProgramAssociationKey.ProgramEducationOrganizationIdOption.Value!.Value);

            if (trackedChangesEdFiStudentCTEProgramAssociationKey.ProgramNameOption.IsSet)
                writer.WriteString("programName", trackedChangesEdFiStudentCTEProgramAssociationKey.ProgramName);

            if (trackedChangesEdFiStudentCTEProgramAssociationKey.ProgramTypeDescriptorOption.IsSet)
                writer.WriteString("programTypeDescriptor", trackedChangesEdFiStudentCTEProgramAssociationKey.ProgramTypeDescriptor);

            if (trackedChangesEdFiStudentCTEProgramAssociationKey.StudentUniqueIdOption.IsSet)
                writer.WriteString("studentUniqueId", trackedChangesEdFiStudentCTEProgramAssociationKey.StudentUniqueId);
        }
    }
}
