...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class TrackedChangesEdFiCalendarDateKey : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TrackedChangesEdFiCalendarDateKey(Option<DateOnly?> date = default, Option<string?> calendarCode = default, Option<long?> schoolId = default, Option<int?> schoolYear = default)
        {
            DateOption = date;
    ...
    /// <summary>
    /// A Json converter for type <see cref="TrackedChangesEdFiCalendarDateKey" />
    /// </summary>
    public class TrackedChangesEdFiCalendarDateKeyJsonConverter : JsonConverter<TrackedChangesEdFiCalendarDateKey>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="TrackedChangesEdFiCalendarDateKey" />
        /// </summary>
        ...
        public override TrackedChangesEdFiCalendarDateKey Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (date.IsSet && date.Value == null)
                throw new ArgumentNullException(nameof(date), "Property is not nullable for class TrackedChangesEdFiCalendarDateKey.");

            if (calendarCode.IsSet && calendarCode.Value == null)
                throw new ArgumentNullException(nameof(calendarCode), "Property is not nullable for class TrackedChangesEdFiCalendarDateKey.");

            if (schoolId.IsSet && schoolId.Value == null)
                throw new ArgumentNullException(nameof(schoolId), "Property is not nullable for class TrackedChangesEdFiCalendarDateKey.");

            if (schoolYear.IsSet && schoolYear.Value == null)
                throw new ArgumentNullException(nameof(schoolYear), "Property is not nullable for class TrackedChangesEdFiCalendarDateKey.");

            return new TrackedChangesEdFiCalendarDateKey(date, calendarCode, schoolId, schoolYear);
        }

        /// <summary>
        /// Serializes a <see cref="TrackedChangesEdFiCalendarDateKey" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="trackedChangesEdFiCalendarDateKey"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TrackedChangesEdFiCalendarDateKey trackedChangesEdFiCalendarDateKey, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, trackedChangesEdFiCalendarDateKey, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TrackedChangesEdFiCalendarDateKey" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="trackedChangesEdFiCalendarDateKey"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TrackedChangesEdFiCalendarDateKey trackedChangesEdFiCalendarDateKey, JsonSerializerOptions jsonSerializerOptions)
        {
            if (trackedChangesEdFiCalendarDateKey.CalendarCodeOption.IsSet && trackedChangesEdFiCalendarDateKey.CalendarCode == null)
                throw new ArgumentNullException(nameof(trackedChangesEdFiCalendarDateKey.CalendarCode), "Property is required for class TrackedChangesEdFiCalendarDateKey.");

            if (trackedChangesEdFiCalendarDateKey.DateOption.IsSet)
                writer.WriteString("date", trackedChangesEdFiCalendarDateKey.DateOption.Value!.Value.ToString(DateFormat));

            if (trackedChangesEdFiCalendarDateKey.CalendarCodeOption.IsSet)
                writer.WriteString("calendarCode", trackedChangesEdFiCalendarDateKey.CalendarCode);

            if (trackedChangesEdFiCalendarDateKey.SchoolIdOption.IsSet)
                writer.WriteNumber("schoolId", trackedChangesEdFiCalendarDateKey.SchoolIdOption.Value!.Value);

            if (trackedChangesEdFiCalendarDateKey.SchoolYearOption.IsSet)
                writer.WriteNumber("schoolYear", trackedChangesEdFiCalendarDateKey.SchoolYearOption.Value!.Value);
        }
    }
}
