...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_travelDirectionDescriptor")]
    public partial class EdFiTravelDirectionDescriptor : IValidatableObject
    {
        ...
        protected EdFiTravelDirectionDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiTravelDirectionDescriptor" /> class.
        /// </summary>
        ...
        public EdFiTravelDirectionDescriptor(string id = default, string codeValue = default, string varNamespace = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string shortDescription = default, string etag = default, DateTime lastModifiedDate = default)
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiTravelDirectionDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "varNamespace" is required (not null)
            if (varNamespace == null)
            {
                throw new ArgumentNullException("varNamespace is a required property for EdFiTravelDirectionDescriptor and cannot be null");
            }
            this.Namespace = varNamespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiTravelDirectionDescriptor and cannot be null");
            }
