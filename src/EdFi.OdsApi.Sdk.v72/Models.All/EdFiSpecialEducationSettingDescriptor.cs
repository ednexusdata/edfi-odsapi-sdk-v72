...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiSpecialEducationSettingDescriptor : IValidatableObject
    {
        ...
        public EdFiSpecialEducationSettingDescriptor(string id = default, string codeValue = default, string varNamespace = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string shortDescription = default, string etag = default, DateTime lastModifiedDate = default)
        {
            ...
            {
                throw new ArgumentNullException("varNamespace is a required property for EdFiSpecialEducationSettingDescriptor and cannot be null");
            }
