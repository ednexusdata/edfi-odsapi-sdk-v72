...
namespace EdFi.OdsApi.Sdk.v72.Models.All
{
    ...
    public partial class EdFiRestraintEvent : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiRestraintEvent(string restraintEventIdentifier, EdFiSchoolReference schoolReference, EdFiStudentReference studentReference, DateOnly eventDate, Option<string?> id = default, Option<string?> educationalEnvironmentDescriptor = default, Option<List<EdFiRestraintEventProgram>?> programs = default, Option<List<EdFiRestraintEventReason>?> reasons = default, Option<string?> etag = default, Option<DateTime?> lastModifiedDate = default, Option<Object?> ext = default)
        {
    ...
    public class EdFiRestraintEventJsonConverter : JsonConverter<EdFiRestraintEvent>
    {
        ...
        public override EdFiRestraintEvent Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiRestraintEvent(restraintEventIdentifier.Value!, schoolReference.Value!, studentReference.Value!, eventDate.Value!.Value!, id, educationalEnvironmentDescriptor, programs, reasons, etag, lastModifiedDate, ext);
        }
