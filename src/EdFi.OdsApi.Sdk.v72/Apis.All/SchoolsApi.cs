...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteSchoolByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesSchoolsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiSchoolDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetSchoolsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiSchool>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetSchoolsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiSchool?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesSchoolsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiSchoolKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostSchoolApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutSchoolApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class SchoolsApi : ISchoolsApi
    {
        ...
        /// </summary>
        public partial class DeleteSchoolByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteSchoolByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesSchoolsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesSchoolsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        private void ValidateGetSchools(Option<string> administrativeFundingControlDescriptor, Option<string> charterApprovalAgencyTypeDescriptor, Option<string> charterStatusDescriptor, Option<string> internetAccessDescriptor, Option<string> magnetSpecialProgramEmphasisSchoolDescriptor, Option<string> schoolTypeDescriptor, Option<string> titleIPartASchoolDesignationDescriptor, Option<string> id)
        {
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetSchools(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, schoolId, localEducationAgencyId, charterApprovalSchoolYear, administrativeFundingControlDescriptor, charterApprovalAgencyTypeDescriptor, charterStatusDescriptor, internetAccessDescriptor, magnetSpecialProgramEmphasisSchoolDescriptor, schoolTypeDescriptor, titleIPartASchoolDesignationDescriptor, id, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetSchoolsApiResponse?> GetSchoolsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<long> schoolId = default, Option<long> localEducationAgencyId = default, Option<int> charterApprovalSchoolYear = default, Option<string> administrativeFundingControlDescriptor = default, Option<string> charterApprovalAgencyTypeDescriptor = default, Option<string> charterStatusDescriptor = default, Option<string> internetAccessDescriptor = default, Option<string> magnetSpecialProgramEmphasisSchoolDescriptor = default, Option<string> schoolTypeDescriptor = default, Option<string> titleIPartASchoolDesignationDescriptor = default, Option<string> id = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetSchoolsAsync(offset, limit, minChangeVersion, maxChangeVersion, totalCount, schoolId, localEducationAgencyId, charterApprovalSchoolYear, administrativeFundingControlDescriptor, charterApprovalAgencyTypeDescriptor, charterStatusDescriptor, internetAccessDescriptor, magnetSpecialProgramEmphasisSchoolDescriptor, schoolTypeDescriptor, titleIPartASchoolDesignationDescriptor, id, useSnapshot, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IGetSchoolsApiResponse> GetSchoolsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<long> schoolId = default, Option<long> localEducationAgencyId = default, Option<int> charterApprovalSchoolYear = default, Option<string> administrativeFundingControlDescriptor = default, Option<string> charterApprovalAgencyTypeDescriptor = default, Option<string> charterStatusDescriptor = default, Option<string> internetAccessDescriptor = default, Option<string> magnetSpecialProgramEmphasisSchoolDescriptor = default, Option<string> schoolTypeDescriptor = default, Option<string> titleIPartASchoolDesignationDescriptor = default, Option<string> id = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetSchools(administrativeFundingControlDescriptor, charterApprovalAgencyTypeDescriptor, charterStatusDescriptor, internetAccessDescriptor, magnetSpecialProgramEmphasisSchoolDescriptor, schoolTypeDescriptor, titleIPartASchoolDesignationDescriptor, id);

                FormatGetSchools(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref schoolId, ref localEducationAgencyId, ref charterApprovalSchoolYear, ref administrativeFundingControlDescriptor, ref charterApprovalAgencyTypeDescriptor, ref charterStatusDescriptor, ref internetAccessDescriptor, ref magnetSpecialProgramEmphasisSchoolDescriptor, ref schoolTypeDescriptor, ref titleIPartASchoolDesignationDescriptor, ref id, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetSchoolsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, schoolId, localEducationAgencyId, charterApprovalSchoolYear, administrativeFundingControlDescriptor, charterApprovalAgencyTypeDescriptor, charterStatusDescriptor, internetAccessDescriptor, magnetSpecialProgramEmphasisSchoolDescriptor, schoolTypeDescriptor, titleIPartASchoolDesignationDescriptor, id, useSnapshot);
            ...
            {
                OnErrorGetSchoolsDefaultImplementation(e, "/ed-fi/schools", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, schoolId, localEducationAgencyId, charterApprovalSchoolYear, administrativeFundingControlDescriptor, charterApprovalAgencyTypeDescriptor, charterStatusDescriptor, internetAccessDescriptor, magnetSpecialProgramEmphasisSchoolDescriptor, schoolTypeDescriptor, titleIPartASchoolDesignationDescriptor, id, useSnapshot);
        ...
        /// </summary>
        public partial class GetSchoolsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetSchoolsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetSchoolsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetSchoolsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiSchool? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiSchool>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiSchool? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesSchoolsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesSchoolsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostSchoolApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostSchoolApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutSchoolApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutSchoolApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
