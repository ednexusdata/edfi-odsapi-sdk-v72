...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteContactByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesContactsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiContactDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetContactsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiContact>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetContactsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiContact?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesContactsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiContactKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostContactApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutContactApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class ContactsApi : IContactsApi
    {
        ...
        /// </summary>
        public partial class DeleteContactByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteContactByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesContactsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesContactsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        public async Task<IGetContactsApiResponse> GetContactsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> contactUniqueId = default, Option<string> personId = default, Option<string> sourceSystemDescriptor = default, Option<string> highestCompletedLevelOfEducationDescriptor = default, Option<string> sexDescriptor = default, Option<string> firstName = default, Option<string> genderIdentity = default, Option<string> generationCodeSuffix = default, Option<string> id = default, Option<string> lastSurname = default, Option<string> loginId = default, Option<string> maidenName = default, Option<string> middleName = default, Option<string> personalTitlePrefix = default, Option<string> preferredFirstName = default, Option<string> preferredLastSurname = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetContacts(contactUniqueId, personId, sourceSystemDescriptor, highestCompletedLevelOfEducationDescriptor, sexDescriptor, firstName, genderIdentity, generationCodeSuffix, id, lastSurname, loginId, maidenName, middleName, personalTitlePrefix, preferredFirstName, preferredLastSurname);

                FormatGetContacts(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref contactUniqueId, ref personId, ref sourceSystemDescriptor, ref highestCompletedLevelOfEducationDescriptor, ref sexDescriptor, ref firstName, ref genderIdentity, ref generationCodeSuffix, ref id, ref lastSurname, ref loginId, ref maidenName, ref middleName, ref personalTitlePrefix, ref preferredFirstName, ref preferredLastSurname, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetContactsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, contactUniqueId, personId, sourceSystemDescriptor, highestCompletedLevelOfEducationDescriptor, sexDescriptor, firstName, genderIdentity, generationCodeSuffix, id, lastSurname, loginId, maidenName, middleName, personalTitlePrefix, preferredFirstName, preferredLastSurname, useSnapshot);
        ...
        /// </summary>
        public partial class GetContactsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetContactsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetContactsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetContactsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiContact? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiContact>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiContact? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesContactsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesContactsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostContactApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostContactApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutContactApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutContactApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
