...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteAcademicHonorCategoryDescriptorByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesAcademicHonorCategoryDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiAcademicHonorCategoryDescriptorDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetAcademicHonorCategoryDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiAcademicHonorCategoryDescriptor>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetAcademicHonorCategoryDescriptorsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiAcademicHonorCategoryDescriptor?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesAcademicHonorCategoryDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiAcademicHonorCategoryDescriptorKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostAcademicHonorCategoryDescriptorApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutAcademicHonorCategoryDescriptorApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class AcademicHonorCategoryDescriptorsApi : IAcademicHonorCategoryDescriptorsApi
    {
        ...
        /// </summary>
        public partial class DeleteAcademicHonorCategoryDescriptorByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteAcademicHonorCategoryDescriptorByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesAcademicHonorCategoryDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesAcademicHonorCategoryDescriptorsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        partial void FormatGetAcademicHonorCategoryDescriptors(ref Option<int> offset, ref Option<int> limit, ref Option<long> minChangeVersion, ref Option<long> maxChangeVersion, ref Option<bool> totalCount, ref Option<string> codeValue, ref Option<string> id, ref Option<string> varNamespace, ref Option<bool> useSnapshot);
        ...
        /// <returns></returns>
        private void ValidateGetAcademicHonorCategoryDescriptors(Option<string> codeValue, Option<string> id, Option<string> varNamespace)
        {
        ...
        {
            bool suppressDefaultLog = false;
            AfterGetAcademicHonorCategoryDescriptors(ref suppressDefaultLog, apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetAcademicHonorCategoryDescriptors(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetAcademicHonorCategoryDescriptorsApiResponse?> GetAcademicHonorCategoryDescriptorsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> codeValue = default, Option<string> id = default, Option<string> varNamespace = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetAcademicHonorCategoryDescriptorsAsync(offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IGetAcademicHonorCategoryDescriptorsApiResponse> GetAcademicHonorCategoryDescriptorsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> codeValue = default, Option<string> id = default, Option<string> varNamespace = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetAcademicHonorCategoryDescriptors(codeValue, id, varNamespace);

                FormatGetAcademicHonorCategoryDescriptors(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref codeValue, ref id, ref varNamespace, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetAcademicHonorCategoryDescriptorsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
            ...
            {
                OnErrorGetAcademicHonorCategoryDescriptorsDefaultImplementation(e, "/ed-fi/academicHonorCategoryDescriptors", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
        ...
        /// </summary>
        public partial class GetAcademicHonorCategoryDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetAcademicHonorCategoryDescriptorsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetAcademicHonorCategoryDescriptorsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetAcademicHonorCategoryDescriptorsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiAcademicHonorCategoryDescriptor? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiAcademicHonorCategoryDescriptor>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiAcademicHonorCategoryDescriptor? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesAcademicHonorCategoryDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesAcademicHonorCategoryDescriptorsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostAcademicHonorCategoryDescriptorApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostAcademicHonorCategoryDescriptorApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutAcademicHonorCategoryDescriptorApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutAcademicHonorCategoryDescriptorApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
