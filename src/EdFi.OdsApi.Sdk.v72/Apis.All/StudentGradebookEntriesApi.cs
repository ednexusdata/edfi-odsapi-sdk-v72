...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteStudentGradebookEntryByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesStudentGradebookEntriesApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiStudentGradebookEntryDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetStudentGradebookEntriesApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiStudentGradebookEntry>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetStudentGradebookEntriesByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentGradebookEntry?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesStudentGradebookEntriesApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiStudentGradebookEntryKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostStudentGradebookEntryApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutStudentGradebookEntryApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class StudentGradebookEntriesApi : IStudentGradebookEntriesApi
    {
        ...
        /// </summary>
        public partial class DeleteStudentGradebookEntryByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteStudentGradebookEntryByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesStudentGradebookEntriesApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesStudentGradebookEntriesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetStudentGradebookEntries(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, gradebookEntryIdentifier, varNamespace, studentUniqueId, assignmentLateStatusDescriptor, competencyLevelDescriptor, submissionStatusDescriptor, dateFulfilled, diagnosticStatement, id, letterGradeEarned, numericGradeEarned, pointsEarned, timeFulfilled, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetStudentGradebookEntriesApiResponse> GetStudentGradebookEntriesAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> gradebookEntryIdentifier = default, Option<string> varNamespace = default, Option<string> studentUniqueId = default, Option<string> assignmentLateStatusDescriptor = default, Option<string> competencyLevelDescriptor = default, Option<string> submissionStatusDescriptor = default, Option<DateOnly> dateFulfilled = default, Option<string> diagnosticStatement = default, Option<string> id = default, Option<string> letterGradeEarned = default, Option<double> numericGradeEarned = default, Option<double> pointsEarned = default, Option<string> timeFulfilled = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetStudentGradebookEntries(gradebookEntryIdentifier, varNamespace, studentUniqueId, assignmentLateStatusDescriptor, competencyLevelDescriptor, submissionStatusDescriptor, diagnosticStatement, id, letterGradeEarned, timeFulfilled);

                FormatGetStudentGradebookEntries(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref gradebookEntryIdentifier, ref varNamespace, ref studentUniqueId, ref assignmentLateStatusDescriptor, ref competencyLevelDescriptor, ref submissionStatusDescriptor, ref dateFulfilled, ref diagnosticStatement, ref id, ref letterGradeEarned, ref numericGradeEarned, ref pointsEarned, ref timeFulfilled, ref useSnapshot);
        ...
        /// </summary>
        public partial class GetStudentGradebookEntriesApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetStudentGradebookEntriesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetStudentGradebookEntriesByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetStudentGradebookEntriesByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentGradebookEntry? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentGradebookEntry>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentGradebookEntry? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesStudentGradebookEntriesApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesStudentGradebookEntriesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostStudentGradebookEntryApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostStudentGradebookEntryApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutStudentGradebookEntryApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutStudentGradebookEntryApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
