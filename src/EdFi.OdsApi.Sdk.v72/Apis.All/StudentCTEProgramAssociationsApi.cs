...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteStudentCTEProgramAssociationByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesStudentCTEProgramAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiStudentCTEProgramAssociationDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetStudentCTEProgramAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiStudentCTEProgramAssociation>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetStudentCTEProgramAssociationsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentCTEProgramAssociation?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesStudentCTEProgramAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiStudentCTEProgramAssociationKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostStudentCTEProgramAssociationApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutStudentCTEProgramAssociationApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class StudentCTEProgramAssociationsApi : IStudentCTEProgramAssociationsApi
    {
        ...
        /// </summary>
        public partial class DeleteStudentCTEProgramAssociationByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteStudentCTEProgramAssociationByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesStudentCTEProgramAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesStudentCTEProgramAssociationsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        private void ValidateGetStudentCTEProgramAssociations(Option<string> programName, Option<string> programTypeDescriptor, Option<string> studentUniqueId, Option<string> technicalSkillsAssessmentDescriptor, Option<string> id)
        {
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetStudentCTEProgramAssociations(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, beginDate, educationOrganizationId, programEducationOrganizationId, programName, programTypeDescriptor, studentUniqueId, technicalSkillsAssessmentDescriptor, nonTraditionalGenderStatus, privateCTEProgram, id, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetStudentCTEProgramAssociationsApiResponse?> GetStudentCTEProgramAssociationsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<DateOnly> beginDate = default, Option<long> educationOrganizationId = default, Option<long> programEducationOrganizationId = default, Option<string> programName = default, Option<string> programTypeDescriptor = default, Option<string> studentUniqueId = default, Option<string> technicalSkillsAssessmentDescriptor = default, Option<bool> nonTraditionalGenderStatus = default, Option<bool> privateCTEProgram = default, Option<string> id = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetStudentCTEProgramAssociationsAsync(offset, limit, minChangeVersion, maxChangeVersion, totalCount, beginDate, educationOrganizationId, programEducationOrganizationId, programName, programTypeDescriptor, studentUniqueId, technicalSkillsAssessmentDescriptor, nonTraditionalGenderStatus, privateCTEProgram, id, useSnapshot, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IGetStudentCTEProgramAssociationsApiResponse> GetStudentCTEProgramAssociationsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<DateOnly> beginDate = default, Option<long> educationOrganizationId = default, Option<long> programEducationOrganizationId = default, Option<string> programName = default, Option<string> programTypeDescriptor = default, Option<string> studentUniqueId = default, Option<string> technicalSkillsAssessmentDescriptor = default, Option<bool> nonTraditionalGenderStatus = default, Option<bool> privateCTEProgram = default, Option<string> id = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            {
                OnErrorGetStudentCTEProgramAssociationsDefaultImplementation(e, "/ed-fi/studentCTEProgramAssociations", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, beginDate, educationOrganizationId, programEducationOrganizationId, programName, programTypeDescriptor, studentUniqueId, technicalSkillsAssessmentDescriptor, nonTraditionalGenderStatus, privateCTEProgram, id, useSnapshot);
        ...
        /// </summary>
        public partial class GetStudentCTEProgramAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetStudentCTEProgramAssociationsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetStudentCTEProgramAssociationsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetStudentCTEProgramAssociationsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentCTEProgramAssociation? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentCTEProgramAssociation>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentCTEProgramAssociation? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesStudentCTEProgramAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesStudentCTEProgramAssociationsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostStudentCTEProgramAssociationApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostStudentCTEProgramAssociationApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutStudentCTEProgramAssociationApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutStudentCTEProgramAssociationApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
