...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteInterventionByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesInterventionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiInterventionDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetInterventionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiIntervention>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetInterventionsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiIntervention?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesInterventionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiInterventionKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostInterventionApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutInterventionApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class InterventionsApi : IInterventionsApi
    {
        ...
        /// </summary>
        public partial class DeleteInterventionByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteInterventionByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesInterventionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesInterventionsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// <returns></returns>
        private void ValidateGetInterventions(Option<string> interventionIdentificationCode, Option<string> deliveryMethodDescriptor, Option<string> interventionClassDescriptor, Option<string> id, Option<string> varNamespace)
        {
        ...
        {
            bool suppressDefaultLog = false;
            AfterGetInterventions(ref suppressDefaultLog, apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, interventionIdentificationCode, educationOrganizationId, deliveryMethodDescriptor, interventionClassDescriptor, beginDate, endDate, id, maxDosage, minDosage, varNamespace, useSnapshot);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        public async Task<IGetInterventionsApiResponse> GetInterventionsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> interventionIdentificationCode = default, Option<long> educationOrganizationId = default, Option<string> deliveryMethodDescriptor = default, Option<string> interventionClassDescriptor = default, Option<DateOnly> beginDate = default, Option<DateOnly> endDate = default, Option<string> id = default, Option<int> maxDosage = default, Option<int> minDosage = default, Option<string> varNamespace = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetInterventions(interventionIdentificationCode, deliveryMethodDescriptor, interventionClassDescriptor, id, varNamespace);

                FormatGetInterventions(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref interventionIdentificationCode, ref educationOrganizationId, ref deliveryMethodDescriptor, ref interventionClassDescriptor, ref beginDate, ref endDate, ref id, ref maxDosage, ref minDosage, ref varNamespace, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetInterventionsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, interventionIdentificationCode, educationOrganizationId, deliveryMethodDescriptor, interventionClassDescriptor, beginDate, endDate, id, maxDosage, minDosage, varNamespace, useSnapshot);
            ...
            {
                OnErrorGetInterventionsDefaultImplementation(e, "/ed-fi/interventions", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, interventionIdentificationCode, educationOrganizationId, deliveryMethodDescriptor, interventionClassDescriptor, beginDate, endDate, id, maxDosage, minDosage, varNamespace, useSnapshot);
        ...
        /// </summary>
        public partial class GetInterventionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetInterventionsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetInterventionsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetInterventionsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiIntervention? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiIntervention>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiIntervention? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesInterventionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesInterventionsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostInterventionApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostInterventionApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutInterventionApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutInterventionApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
