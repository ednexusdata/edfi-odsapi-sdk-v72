...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteOpenStaffPositionByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesOpenStaffPositionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiOpenStaffPositionDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetOpenStaffPositionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiOpenStaffPosition>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetOpenStaffPositionsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiOpenStaffPosition?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesOpenStaffPositionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiOpenStaffPositionKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostOpenStaffPositionApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutOpenStaffPositionApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class OpenStaffPositionsApi : IOpenStaffPositionsApi
    {
        ...
        /// </summary>
        public partial class DeleteOpenStaffPositionByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteOpenStaffPositionByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesOpenStaffPositionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesOpenStaffPositionsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// <returns></returns>
        private void ValidateGetOpenStaffPositions(Option<string> requisitionNumber, Option<string> employmentStatusDescriptor, Option<string> postingResultDescriptor, Option<string> programAssignmentDescriptor, Option<string> staffClassificationDescriptor, Option<string> id, Option<string> positionTitle)
        {
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetOpenStaffPositions(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, requisitionNumber, educationOrganizationId, employmentStatusDescriptor, postingResultDescriptor, programAssignmentDescriptor, staffClassificationDescriptor, datePosted, datePostingRemoved, id, positionTitle, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetOpenStaffPositionsApiResponse?> GetOpenStaffPositionsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> requisitionNumber = default, Option<long> educationOrganizationId = default, Option<string> employmentStatusDescriptor = default, Option<string> postingResultDescriptor = default, Option<string> programAssignmentDescriptor = default, Option<string> staffClassificationDescriptor = default, Option<DateOnly> datePosted = default, Option<DateOnly> datePostingRemoved = default, Option<string> id = default, Option<string> positionTitle = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetOpenStaffPositionsAsync(offset, limit, minChangeVersion, maxChangeVersion, totalCount, requisitionNumber, educationOrganizationId, employmentStatusDescriptor, postingResultDescriptor, programAssignmentDescriptor, staffClassificationDescriptor, datePosted, datePostingRemoved, id, positionTitle, useSnapshot, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IGetOpenStaffPositionsApiResponse> GetOpenStaffPositionsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> requisitionNumber = default, Option<long> educationOrganizationId = default, Option<string> employmentStatusDescriptor = default, Option<string> postingResultDescriptor = default, Option<string> programAssignmentDescriptor = default, Option<string> staffClassificationDescriptor = default, Option<DateOnly> datePosted = default, Option<DateOnly> datePostingRemoved = default, Option<string> id = default, Option<string> positionTitle = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetOpenStaffPositions(requisitionNumber, employmentStatusDescriptor, postingResultDescriptor, programAssignmentDescriptor, staffClassificationDescriptor, id, positionTitle);

                FormatGetOpenStaffPositions(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref requisitionNumber, ref educationOrganizationId, ref employmentStatusDescriptor, ref postingResultDescriptor, ref programAssignmentDescriptor, ref staffClassificationDescriptor, ref datePosted, ref datePostingRemoved, ref id, ref positionTitle, ref useSnapshot);
            ...
            {
                OnErrorGetOpenStaffPositionsDefaultImplementation(e, "/ed-fi/openStaffPositions", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, requisitionNumber, educationOrganizationId, employmentStatusDescriptor, postingResultDescriptor, programAssignmentDescriptor, staffClassificationDescriptor, datePosted, datePostingRemoved, id, positionTitle, useSnapshot);
        ...
        /// </summary>
        public partial class GetOpenStaffPositionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetOpenStaffPositionsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetOpenStaffPositionsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetOpenStaffPositionsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiOpenStaffPosition? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiOpenStaffPosition>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiOpenStaffPosition? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesOpenStaffPositionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesOpenStaffPositionsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostOpenStaffPositionApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostOpenStaffPositionApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutOpenStaffPositionApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutOpenStaffPositionApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
