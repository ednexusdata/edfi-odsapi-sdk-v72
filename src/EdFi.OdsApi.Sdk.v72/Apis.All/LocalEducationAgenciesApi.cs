...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteLocalEducationAgencyByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesLocalEducationAgenciesApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiLocalEducationAgencyDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetLocalEducationAgenciesApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiLocalEducationAgency>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetLocalEducationAgenciesByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiLocalEducationAgency?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesLocalEducationAgenciesApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiLocalEducationAgencyKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostLocalEducationAgencyApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutLocalEducationAgencyApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class LocalEducationAgenciesApi : ILocalEducationAgenciesApi
    {
        ...
        /// </summary>
        public partial class DeleteLocalEducationAgencyByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteLocalEducationAgencyByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesLocalEducationAgenciesApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesLocalEducationAgenciesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        private void ValidateGetLocalEducationAgencies(Option<string> charterStatusDescriptor, Option<string> localEducationAgencyCategoryDescriptor, Option<string> id)
        {
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetLocalEducationAgencies(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, localEducationAgencyId, educationServiceCenterId, parentLocalEducationAgencyId, stateEducationAgencyId, charterStatusDescriptor, localEducationAgencyCategoryDescriptor, id, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetLocalEducationAgenciesApiResponse> GetLocalEducationAgenciesAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<long> localEducationAgencyId = default, Option<long> educationServiceCenterId = default, Option<long> parentLocalEducationAgencyId = default, Option<long> stateEducationAgencyId = default, Option<string> charterStatusDescriptor = default, Option<string> localEducationAgencyCategoryDescriptor = default, Option<string> id = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetLocalEducationAgencies(charterStatusDescriptor, localEducationAgencyCategoryDescriptor, id);

                FormatGetLocalEducationAgencies(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref localEducationAgencyId, ref educationServiceCenterId, ref parentLocalEducationAgencyId, ref stateEducationAgencyId, ref charterStatusDescriptor, ref localEducationAgencyCategoryDescriptor, ref id, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetLocalEducationAgenciesDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, localEducationAgencyId, educationServiceCenterId, parentLocalEducationAgencyId, stateEducationAgencyId, charterStatusDescriptor, localEducationAgencyCategoryDescriptor, id, useSnapshot);
        ...
        /// </summary>
        public partial class GetLocalEducationAgenciesApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetLocalEducationAgenciesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetLocalEducationAgenciesByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetLocalEducationAgenciesByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiLocalEducationAgency? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiLocalEducationAgency>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiLocalEducationAgency? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesLocalEducationAgenciesApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesLocalEducationAgenciesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostLocalEducationAgencyApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostLocalEducationAgencyApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutLocalEducationAgencyApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutLocalEducationAgencyApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
