...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteSectionAttendanceTakenEventByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesSectionAttendanceTakenEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiSectionAttendanceTakenEventDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetSectionAttendanceTakenEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiSectionAttendanceTakenEvent>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetSectionAttendanceTakenEventsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiSectionAttendanceTakenEvent?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesSectionAttendanceTakenEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiSectionAttendanceTakenEventKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostSectionAttendanceTakenEventApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutSectionAttendanceTakenEventApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class SectionAttendanceTakenEventsApi : ISectionAttendanceTakenEventsApi
    {
        ...
        /// </summary>
        public partial class DeleteSectionAttendanceTakenEventByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteSectionAttendanceTakenEventByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesSectionAttendanceTakenEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesSectionAttendanceTakenEventsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        private void ValidateGetSectionAttendanceTakenEvents(Option<string> calendarCode, Option<string> localCourseCode, Option<string> sectionIdentifier, Option<string> sessionName, Option<string> staffUniqueId, Option<string> id)
        {
        ...
        {
            bool suppressDefaultLog = false;
            AfterGetSectionAttendanceTakenEvents(ref suppressDefaultLog, apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, calendarCode, date, schoolId, schoolYear, localCourseCode, sectionIdentifier, sessionName, staffUniqueId, eventDate, id, useSnapshot);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetSectionAttendanceTakenEvents(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, calendarCode, date, schoolId, schoolYear, localCourseCode, sectionIdentifier, sessionName, staffUniqueId, eventDate, id, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetSectionAttendanceTakenEventsApiResponse?> GetSectionAttendanceTakenEventsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> calendarCode = default, Option<DateOnly> date = default, Option<long> schoolId = default, Option<int> schoolYear = default, Option<string> localCourseCode = default, Option<string> sectionIdentifier = default, Option<string> sessionName = default, Option<string> staffUniqueId = default, Option<DateOnly> eventDate = default, Option<string> id = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetSectionAttendanceTakenEventsAsync(offset, limit, minChangeVersion, maxChangeVersion, totalCount, calendarCode, date, schoolId, schoolYear, localCourseCode, sectionIdentifier, sessionName, staffUniqueId, eventDate, id, useSnapshot, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IGetSectionAttendanceTakenEventsApiResponse> GetSectionAttendanceTakenEventsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> calendarCode = default, Option<DateOnly> date = default, Option<long> schoolId = default, Option<int> schoolYear = default, Option<string> localCourseCode = default, Option<string> sectionIdentifier = default, Option<string> sessionName = default, Option<string> staffUniqueId = default, Option<DateOnly> eventDate = default, Option<string> id = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetSectionAttendanceTakenEvents(calendarCode, localCourseCode, sectionIdentifier, sessionName, staffUniqueId, id);

                FormatGetSectionAttendanceTakenEvents(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref calendarCode, ref date, ref schoolId, ref schoolYear, ref localCourseCode, ref sectionIdentifier, ref sessionName, ref staffUniqueId, ref eventDate, ref id, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetSectionAttendanceTakenEventsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, calendarCode, date, schoolId, schoolYear, localCourseCode, sectionIdentifier, sessionName, staffUniqueId, eventDate, id, useSnapshot);
        ...
        /// </summary>
        public partial class GetSectionAttendanceTakenEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetSectionAttendanceTakenEventsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetSectionAttendanceTakenEventsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetSectionAttendanceTakenEventsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiSectionAttendanceTakenEvent? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiSectionAttendanceTakenEvent>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiSectionAttendanceTakenEvent? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesSectionAttendanceTakenEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesSectionAttendanceTakenEventsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostSectionAttendanceTakenEventApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostSectionAttendanceTakenEventApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutSectionAttendanceTakenEventApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutSectionAttendanceTakenEventApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
