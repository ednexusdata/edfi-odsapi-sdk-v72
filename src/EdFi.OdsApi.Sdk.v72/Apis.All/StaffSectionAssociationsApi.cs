...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteStaffSectionAssociationByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesStaffSectionAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiStaffSectionAssociationDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetStaffSectionAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiStaffSectionAssociation>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetStaffSectionAssociationsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiStaffSectionAssociation?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesStaffSectionAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiStaffSectionAssociationKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostStaffSectionAssociationApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutStaffSectionAssociationApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class StaffSectionAssociationsApi : IStaffSectionAssociationsApi
    {
        ...
        /// </summary>
        public partial class DeleteStaffSectionAssociationByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteStaffSectionAssociationByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesStaffSectionAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesStaffSectionAssociationsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        private void ValidateGetStaffSectionAssociations(Option<string> localCourseCode, Option<string> sectionIdentifier, Option<string> sessionName, Option<string> staffUniqueId, Option<string> classroomPositionDescriptor, Option<string> id)
        {
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetStaffSectionAssociations(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, beginDate, localCourseCode, schoolId, schoolYear, sectionIdentifier, sessionName, staffUniqueId, classroomPositionDescriptor, endDate, highlyQualifiedTeacher, id, percentageContribution, teacherStudentDataLinkExclusion, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetStaffSectionAssociationsApiResponse?> GetStaffSectionAssociationsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<DateOnly> beginDate = default, Option<string> localCourseCode = default, Option<long> schoolId = default, Option<int> schoolYear = default, Option<string> sectionIdentifier = default, Option<string> sessionName = default, Option<string> staffUniqueId = default, Option<string> classroomPositionDescriptor = default, Option<DateOnly> endDate = default, Option<bool> highlyQualifiedTeacher = default, Option<string> id = default, Option<double> percentageContribution = default, Option<bool> teacherStudentDataLinkExclusion = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetStaffSectionAssociationsAsync(offset, limit, minChangeVersion, maxChangeVersion, totalCount, beginDate, localCourseCode, schoolId, schoolYear, sectionIdentifier, sessionName, staffUniqueId, classroomPositionDescriptor, endDate, highlyQualifiedTeacher, id, percentageContribution, teacherStudentDataLinkExclusion, useSnapshot, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IGetStaffSectionAssociationsApiResponse> GetStaffSectionAssociationsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<DateOnly> beginDate = default, Option<string> localCourseCode = default, Option<long> schoolId = default, Option<int> schoolYear = default, Option<string> sectionIdentifier = default, Option<string> sessionName = default, Option<string> staffUniqueId = default, Option<string> classroomPositionDescriptor = default, Option<DateOnly> endDate = default, Option<bool> highlyQualifiedTeacher = default, Option<string> id = default, Option<double> percentageContribution = default, Option<bool> teacherStudentDataLinkExclusion = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetStaffSectionAssociations(localCourseCode, sectionIdentifier, sessionName, staffUniqueId, classroomPositionDescriptor, id);

                FormatGetStaffSectionAssociations(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref beginDate, ref localCourseCode, ref schoolId, ref schoolYear, ref sectionIdentifier, ref sessionName, ref staffUniqueId, ref classroomPositionDescriptor, ref endDate, ref highlyQualifiedTeacher, ref id, ref percentageContribution, ref teacherStudentDataLinkExclusion, ref useSnapshot);
        ...
        /// </summary>
        public partial class GetStaffSectionAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetStaffSectionAssociationsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetStaffSectionAssociationsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetStaffSectionAssociationsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiStaffSectionAssociation? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiStaffSectionAssociation>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiStaffSectionAssociation? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesStaffSectionAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesStaffSectionAssociationsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostStaffSectionAssociationApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostStaffSectionAssociationApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutStaffSectionAssociationApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutStaffSectionAssociationApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
