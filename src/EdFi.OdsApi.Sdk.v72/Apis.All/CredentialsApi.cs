...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteCredentialByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesCredentialsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiCredentialDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetCredentialsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiCredential>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetCredentialsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiCredential?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesCredentialsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiCredentialKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostCredentialApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutCredentialApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class CredentialsApi : ICredentialsApi
    {
        ...
        /// </summary>
        public partial class DeleteCredentialByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteCredentialByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesCredentialsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesCredentialsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetCredentials(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, stateOfIssueStateAbbreviationDescriptor, credentialIdentifier, credentialFieldDescriptor, credentialTypeDescriptor, teachingCredentialBasisDescriptor, teachingCredentialDescriptor, effectiveDate, expirationDate, id, issuanceDate, varNamespace, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetCredentialsApiResponse?> GetCredentialsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> stateOfIssueStateAbbreviationDescriptor = default, Option<string> credentialIdentifier = default, Option<string> credentialFieldDescriptor = default, Option<string> credentialTypeDescriptor = default, Option<string> teachingCredentialBasisDescriptor = default, Option<string> teachingCredentialDescriptor = default, Option<DateOnly> effectiveDate = default, Option<DateOnly> expirationDate = default, Option<string> id = default, Option<DateOnly> issuanceDate = default, Option<string> varNamespace = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetCredentialsAsync(offset, limit, minChangeVersion, maxChangeVersion, totalCount, stateOfIssueStateAbbreviationDescriptor, credentialIdentifier, credentialFieldDescriptor, credentialTypeDescriptor, teachingCredentialBasisDescriptor, teachingCredentialDescriptor, effectiveDate, expirationDate, id, issuanceDate, varNamespace, useSnapshot, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IGetCredentialsApiResponse> GetCredentialsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> stateOfIssueStateAbbreviationDescriptor = default, Option<string> credentialIdentifier = default, Option<string> credentialFieldDescriptor = default, Option<string> credentialTypeDescriptor = default, Option<string> teachingCredentialBasisDescriptor = default, Option<string> teachingCredentialDescriptor = default, Option<DateOnly> effectiveDate = default, Option<DateOnly> expirationDate = default, Option<string> id = default, Option<DateOnly> issuanceDate = default, Option<string> varNamespace = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetCredentials(stateOfIssueStateAbbreviationDescriptor, credentialIdentifier, credentialFieldDescriptor, credentialTypeDescriptor, teachingCredentialBasisDescriptor, teachingCredentialDescriptor, id, varNamespace);

                FormatGetCredentials(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref stateOfIssueStateAbbreviationDescriptor, ref credentialIdentifier, ref credentialFieldDescriptor, ref credentialTypeDescriptor, ref teachingCredentialBasisDescriptor, ref teachingCredentialDescriptor, ref effectiveDate, ref expirationDate, ref id, ref issuanceDate, ref varNamespace, ref useSnapshot);
            ...
            {
                OnErrorGetCredentialsDefaultImplementation(e, "/ed-fi/credentials", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, stateOfIssueStateAbbreviationDescriptor, credentialIdentifier, credentialFieldDescriptor, credentialTypeDescriptor, teachingCredentialBasisDescriptor, teachingCredentialDescriptor, effectiveDate, expirationDate, id, issuanceDate, varNamespace, useSnapshot);
        ...
        /// </summary>
        public partial class GetCredentialsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetCredentialsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetCredentialsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetCredentialsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiCredential? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiCredential>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiCredential? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesCredentialsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesCredentialsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostCredentialApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostCredentialApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutCredentialApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutCredentialApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
