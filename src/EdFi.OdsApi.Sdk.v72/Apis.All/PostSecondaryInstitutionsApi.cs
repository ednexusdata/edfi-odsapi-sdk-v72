...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    public interface IPostSecondaryInstitutionsApi : IApi
    {
        ...
        Task<IGetPostSecondaryInstitutionsApiResponse> GetPostSecondaryInstitutionsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<long> postSecondaryInstitutionId = default, Option<string> administrativeFundingControlDescriptor = default, Option<string> postSecondaryInstitutionLevelDescriptor = default, Option<string> id = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// </summary>
    public interface IDeletePostSecondaryInstitutionByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesPostSecondaryInstitutionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiPostSecondaryInstitutionDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetPostSecondaryInstitutionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiPostSecondaryInstitution>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetPostSecondaryInstitutionsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiPostSecondaryInstitution?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesPostSecondaryInstitutionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiPostSecondaryInstitutionKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostPostSecondaryInstitutionApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutPostSecondaryInstitutionApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class PostSecondaryInstitutionsApi : IPostSecondaryInstitutionsApi
    {
        ...
        /// </summary>
        public partial class DeletePostSecondaryInstitutionByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletePostSecondaryInstitutionByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesPostSecondaryInstitutionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesPostSecondaryInstitutionsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        partial void FormatGetPostSecondaryInstitutions(ref Option<int> offset, ref Option<int> limit, ref Option<long> minChangeVersion, ref Option<long> maxChangeVersion, ref Option<bool> totalCount, ref Option<long> postSecondaryInstitutionId, ref Option<string> administrativeFundingControlDescriptor, ref Option<string> postSecondaryInstitutionLevelDescriptor, ref Option<string> id, ref Option<bool> useSnapshot);
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        private void ValidateGetPostSecondaryInstitutions(Option<string> administrativeFundingControlDescriptor, Option<string> postSecondaryInstitutionLevelDescriptor, Option<string> id)
        {
        ...
        {
            bool suppressDefaultLog = false;
            AfterGetPostSecondaryInstitutions(ref suppressDefaultLog, apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, postSecondaryInstitutionId, administrativeFundingControlDescriptor, postSecondaryInstitutionLevelDescriptor, id, useSnapshot);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetPostSecondaryInstitutions(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, postSecondaryInstitutionId, administrativeFundingControlDescriptor, postSecondaryInstitutionLevelDescriptor, id, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetPostSecondaryInstitutionsApiResponse?> GetPostSecondaryInstitutionsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<long> postSecondaryInstitutionId = default, Option<string> administrativeFundingControlDescriptor = default, Option<string> postSecondaryInstitutionLevelDescriptor = default, Option<string> id = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetPostSecondaryInstitutionsAsync(offset, limit, minChangeVersion, maxChangeVersion, totalCount, postSecondaryInstitutionId, administrativeFundingControlDescriptor, postSecondaryInstitutionLevelDescriptor, id, useSnapshot, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IGetPostSecondaryInstitutionsApiResponse> GetPostSecondaryInstitutionsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<long> postSecondaryInstitutionId = default, Option<string> administrativeFundingControlDescriptor = default, Option<string> postSecondaryInstitutionLevelDescriptor = default, Option<string> id = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetPostSecondaryInstitutions(administrativeFundingControlDescriptor, postSecondaryInstitutionLevelDescriptor, id);

                FormatGetPostSecondaryInstitutions(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref postSecondaryInstitutionId, ref administrativeFundingControlDescriptor, ref postSecondaryInstitutionLevelDescriptor, ref id, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetPostSecondaryInstitutionsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, postSecondaryInstitutionId, administrativeFundingControlDescriptor, postSecondaryInstitutionLevelDescriptor, id, useSnapshot);
            ...
            {
                OnErrorGetPostSecondaryInstitutionsDefaultImplementation(e, "/ed-fi/postSecondaryInstitutions", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, postSecondaryInstitutionId, administrativeFundingControlDescriptor, postSecondaryInstitutionLevelDescriptor, id, useSnapshot);
        ...
        /// </summary>
        public partial class GetPostSecondaryInstitutionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetPostSecondaryInstitutionsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetPostSecondaryInstitutionsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetPostSecondaryInstitutionsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiPostSecondaryInstitution? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiPostSecondaryInstitution>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiPostSecondaryInstitution? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesPostSecondaryInstitutionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesPostSecondaryInstitutionsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostPostSecondaryInstitutionApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostPostSecondaryInstitutionApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutPostSecondaryInstitutionApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutPostSecondaryInstitutionApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
