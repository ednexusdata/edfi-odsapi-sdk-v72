...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteStudentInterventionAttendanceEventByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesStudentInterventionAttendanceEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiStudentInterventionAttendanceEventDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetStudentInterventionAttendanceEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiStudentInterventionAttendanceEvent>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetStudentInterventionAttendanceEventsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentInterventionAttendanceEvent?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesStudentInterventionAttendanceEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiStudentInterventionAttendanceEventKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostStudentInterventionAttendanceEventApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutStudentInterventionAttendanceEventApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class StudentInterventionAttendanceEventsApi : IStudentInterventionAttendanceEventsApi
    {
        ...
        /// </summary>
        public partial class DeleteStudentInterventionAttendanceEventByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteStudentInterventionAttendanceEventByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesStudentInterventionAttendanceEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesStudentInterventionAttendanceEventsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        private void ValidateGetStudentInterventionAttendanceEvents(Option<string> attendanceEventCategoryDescriptor, Option<string> interventionIdentificationCode, Option<string> studentUniqueId, Option<string> educationalEnvironmentDescriptor, Option<string> attendanceEventReason, Option<string> id)
        {
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetStudentInterventionAttendanceEvents(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, attendanceEventCategoryDescriptor, eventDate, educationOrganizationId, interventionIdentificationCode, studentUniqueId, educationalEnvironmentDescriptor, attendanceEventReason, eventDuration, id, interventionDuration, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetStudentInterventionAttendanceEventsApiResponse> GetStudentInterventionAttendanceEventsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> attendanceEventCategoryDescriptor = default, Option<DateOnly> eventDate = default, Option<long> educationOrganizationId = default, Option<string> interventionIdentificationCode = default, Option<string> studentUniqueId = default, Option<string> educationalEnvironmentDescriptor = default, Option<string> attendanceEventReason = default, Option<double> eventDuration = default, Option<string> id = default, Option<int> interventionDuration = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetStudentInterventionAttendanceEvents(attendanceEventCategoryDescriptor, interventionIdentificationCode, studentUniqueId, educationalEnvironmentDescriptor, attendanceEventReason, id);

                FormatGetStudentInterventionAttendanceEvents(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref attendanceEventCategoryDescriptor, ref eventDate, ref educationOrganizationId, ref interventionIdentificationCode, ref studentUniqueId, ref educationalEnvironmentDescriptor, ref attendanceEventReason, ref eventDuration, ref id, ref interventionDuration, ref useSnapshot);
            ...
            {
                OnErrorGetStudentInterventionAttendanceEventsDefaultImplementation(e, "/ed-fi/studentInterventionAttendanceEvents", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, attendanceEventCategoryDescriptor, eventDate, educationOrganizationId, interventionIdentificationCode, studentUniqueId, educationalEnvironmentDescriptor, attendanceEventReason, eventDuration, id, interventionDuration, useSnapshot);
        ...
        /// </summary>
        public partial class GetStudentInterventionAttendanceEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetStudentInterventionAttendanceEventsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetStudentInterventionAttendanceEventsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetStudentInterventionAttendanceEventsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentInterventionAttendanceEvent? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentInterventionAttendanceEvent>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentInterventionAttendanceEvent? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesStudentInterventionAttendanceEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesStudentInterventionAttendanceEventsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostStudentInterventionAttendanceEventApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostStudentInterventionAttendanceEventApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutStudentInterventionAttendanceEventApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutStudentInterventionAttendanceEventApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
