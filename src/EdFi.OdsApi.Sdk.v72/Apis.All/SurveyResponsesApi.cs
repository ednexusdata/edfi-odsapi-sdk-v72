...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteSurveyResponseByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesSurveyResponsesApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiSurveyResponseDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetSurveyResponsesApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiSurveyResponse>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetSurveyResponsesByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiSurveyResponse?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesSurveyResponsesApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiSurveyResponseKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostSurveyResponseApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutSurveyResponseApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class SurveyResponsesApi : ISurveyResponsesApi
    {
        ...
        /// </summary>
        public partial class DeleteSurveyResponseByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteSurveyResponseByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesSurveyResponsesApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesSurveyResponsesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetSurveyResponses(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, surveyResponseIdentifier, varNamespace, surveyIdentifier, contactUniqueId, staffUniqueId, studentUniqueId, electronicMailAddress, fullName, id, location, responseDate, responseTime, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetSurveyResponsesApiResponse> GetSurveyResponsesAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> surveyResponseIdentifier = default, Option<string> varNamespace = default, Option<string> surveyIdentifier = default, Option<string> contactUniqueId = default, Option<string> staffUniqueId = default, Option<string> studentUniqueId = default, Option<string> electronicMailAddress = default, Option<string> fullName = default, Option<string> id = default, Option<string> location = default, Option<DateOnly> responseDate = default, Option<int> responseTime = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetSurveyResponses(surveyResponseIdentifier, varNamespace, surveyIdentifier, contactUniqueId, staffUniqueId, studentUniqueId, electronicMailAddress, fullName, id, location);

                FormatGetSurveyResponses(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref surveyResponseIdentifier, ref varNamespace, ref surveyIdentifier, ref contactUniqueId, ref staffUniqueId, ref studentUniqueId, ref electronicMailAddress, ref fullName, ref id, ref location, ref responseDate, ref responseTime, ref useSnapshot);
            ...
            {
                OnErrorGetSurveyResponsesDefaultImplementation(e, "/ed-fi/surveyResponses", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, surveyResponseIdentifier, varNamespace, surveyIdentifier, contactUniqueId, staffUniqueId, studentUniqueId, electronicMailAddress, fullName, id, location, responseDate, responseTime, useSnapshot);
        ...
        /// </summary>
        public partial class GetSurveyResponsesApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetSurveyResponsesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetSurveyResponsesByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetSurveyResponsesByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiSurveyResponse? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiSurveyResponse>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiSurveyResponse? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesSurveyResponsesApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesSurveyResponsesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostSurveyResponseApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostSurveyResponseApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutSurveyResponseApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutSurveyResponseApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
