...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteStudentSectionAttendanceEventByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesStudentSectionAttendanceEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiStudentSectionAttendanceEventDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetStudentSectionAttendanceEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiStudentSectionAttendanceEvent>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetStudentSectionAttendanceEventsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentSectionAttendanceEvent?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesStudentSectionAttendanceEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiStudentSectionAttendanceEventKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostStudentSectionAttendanceEventApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutStudentSectionAttendanceEventApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class StudentSectionAttendanceEventsApi : IStudentSectionAttendanceEventsApi
    {
        ...
        /// </summary>
        public partial class DeleteStudentSectionAttendanceEventByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteStudentSectionAttendanceEventByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesStudentSectionAttendanceEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesStudentSectionAttendanceEventsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        public async Task<IGetStudentSectionAttendanceEventsApiResponse> GetStudentSectionAttendanceEventsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> attendanceEventCategoryDescriptor = default, Option<DateOnly> eventDate = default, Option<string> localCourseCode = default, Option<long> schoolId = default, Option<int> schoolYear = default, Option<string> sectionIdentifier = default, Option<string> sessionName = default, Option<string> studentUniqueId = default, Option<string> educationalEnvironmentDescriptor = default, Option<string> arrivalTime = default, Option<string> attendanceEventReason = default, Option<string> departureTime = default, Option<double> eventDuration = default, Option<string> id = default, Option<int> sectionAttendanceDuration = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetStudentSectionAttendanceEvents(attendanceEventCategoryDescriptor, localCourseCode, sectionIdentifier, sessionName, studentUniqueId, educationalEnvironmentDescriptor, arrivalTime, attendanceEventReason, departureTime, id);

                FormatGetStudentSectionAttendanceEvents(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref attendanceEventCategoryDescriptor, ref eventDate, ref localCourseCode, ref schoolId, ref schoolYear, ref sectionIdentifier, ref sessionName, ref studentUniqueId, ref educationalEnvironmentDescriptor, ref arrivalTime, ref attendanceEventReason, ref departureTime, ref eventDuration, ref id, ref sectionAttendanceDuration, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetStudentSectionAttendanceEventsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, attendanceEventCategoryDescriptor, eventDate, localCourseCode, schoolId, schoolYear, sectionIdentifier, sessionName, studentUniqueId, educationalEnvironmentDescriptor, arrivalTime, attendanceEventReason, departureTime, eventDuration, id, sectionAttendanceDuration, useSnapshot);
        ...
        /// </summary>
        public partial class GetStudentSectionAttendanceEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetStudentSectionAttendanceEventsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetStudentSectionAttendanceEventsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetStudentSectionAttendanceEventsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentSectionAttendanceEvent? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentSectionAttendanceEvent>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentSectionAttendanceEvent? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesStudentSectionAttendanceEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesStudentSectionAttendanceEventsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostStudentSectionAttendanceEventApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostStudentSectionAttendanceEventApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutStudentSectionAttendanceEventApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutStudentSectionAttendanceEventApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
