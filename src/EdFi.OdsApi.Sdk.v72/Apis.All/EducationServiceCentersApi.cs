...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    public interface IEducationServiceCentersApi : IApi
    {
        ...
        Task<IGetEducationServiceCentersApiResponse> GetEducationServiceCentersAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<long> educationServiceCenterId = default, Option<long> stateEducationAgencyId = default, Option<string> id = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// </summary>
    public interface IDeleteEducationServiceCenterByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesEducationServiceCentersApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiEducationServiceCenterDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetEducationServiceCentersApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiEducationServiceCenter>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetEducationServiceCentersByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiEducationServiceCenter?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesEducationServiceCentersApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiEducationServiceCenterKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostEducationServiceCenterApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutEducationServiceCenterApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class EducationServiceCentersApi : IEducationServiceCentersApi
    {
        ...
        /// </summary>
        public partial class DeleteEducationServiceCenterByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteEducationServiceCenterByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesEducationServiceCentersApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesEducationServiceCentersApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        private void ValidateGetEducationServiceCenters(Option<string> id)
        {
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetEducationServiceCenters(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, educationServiceCenterId, stateEducationAgencyId, id, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetEducationServiceCentersApiResponse?> GetEducationServiceCentersOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<long> educationServiceCenterId = default, Option<long> stateEducationAgencyId = default, Option<string> id = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetEducationServiceCentersAsync(offset, limit, minChangeVersion, maxChangeVersion, totalCount, educationServiceCenterId, stateEducationAgencyId, id, useSnapshot, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IGetEducationServiceCentersApiResponse> GetEducationServiceCentersAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<long> educationServiceCenterId = default, Option<long> stateEducationAgencyId = default, Option<string> id = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetEducationServiceCenters(id);

                FormatGetEducationServiceCenters(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref educationServiceCenterId, ref stateEducationAgencyId, ref id, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetEducationServiceCentersDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, educationServiceCenterId, stateEducationAgencyId, id, useSnapshot);
            ...
            {
                OnErrorGetEducationServiceCentersDefaultImplementation(e, "/ed-fi/educationServiceCenters", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, educationServiceCenterId, stateEducationAgencyId, id, useSnapshot);
        ...
        /// </summary>
        public partial class GetEducationServiceCentersApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetEducationServiceCentersApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetEducationServiceCentersByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetEducationServiceCentersByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiEducationServiceCenter? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiEducationServiceCenter>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiEducationServiceCenter? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesEducationServiceCentersApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesEducationServiceCentersApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostEducationServiceCenterApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostEducationServiceCenterApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutEducationServiceCenterApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutEducationServiceCenterApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
