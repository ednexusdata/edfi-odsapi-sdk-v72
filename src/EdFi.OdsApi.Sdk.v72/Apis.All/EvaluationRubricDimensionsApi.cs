...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteEvaluationRubricDimensionByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesEvaluationRubricDimensionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiEvaluationRubricDimensionDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetEvaluationRubricDimensionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiEvaluationRubricDimension>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetEvaluationRubricDimensionsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiEvaluationRubricDimension?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesEvaluationRubricDimensionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiEvaluationRubricDimensionKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostEvaluationRubricDimensionApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutEvaluationRubricDimensionApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class EvaluationRubricDimensionsApi : IEvaluationRubricDimensionsApi
    {
        ...
        /// </summary>
        public partial class DeleteEvaluationRubricDimensionByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteEvaluationRubricDimensionByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesEvaluationRubricDimensionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesEvaluationRubricDimensionsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetEvaluationRubricDimensions(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, evaluationRubricRating, programEducationOrganizationId, programEvaluationElementTitle, programEvaluationPeriodDescriptor, programEvaluationTitle, programEvaluationTypeDescriptor, programName, programTypeDescriptor, evaluationRubricRatingLevelDescriptor, evaluationCriterionDescription, id, rubricDimensionSortOrder, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetEvaluationRubricDimensionsApiResponse> GetEvaluationRubricDimensionsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<int> evaluationRubricRating = default, Option<long> programEducationOrganizationId = default, Option<string> programEvaluationElementTitle = default, Option<string> programEvaluationPeriodDescriptor = default, Option<string> programEvaluationTitle = default, Option<string> programEvaluationTypeDescriptor = default, Option<string> programName = default, Option<string> programTypeDescriptor = default, Option<string> evaluationRubricRatingLevelDescriptor = default, Option<string> evaluationCriterionDescription = default, Option<string> id = default, Option<int> rubricDimensionSortOrder = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetEvaluationRubricDimensions(programEvaluationElementTitle, programEvaluationPeriodDescriptor, programEvaluationTitle, programEvaluationTypeDescriptor, programName, programTypeDescriptor, evaluationRubricRatingLevelDescriptor, evaluationCriterionDescription, id);

                FormatGetEvaluationRubricDimensions(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref evaluationRubricRating, ref programEducationOrganizationId, ref programEvaluationElementTitle, ref programEvaluationPeriodDescriptor, ref programEvaluationTitle, ref programEvaluationTypeDescriptor, ref programName, ref programTypeDescriptor, ref evaluationRubricRatingLevelDescriptor, ref evaluationCriterionDescription, ref id, ref rubricDimensionSortOrder, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetEvaluationRubricDimensionsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, evaluationRubricRating, programEducationOrganizationId, programEvaluationElementTitle, programEvaluationPeriodDescriptor, programEvaluationTitle, programEvaluationTypeDescriptor, programName, programTypeDescriptor, evaluationRubricRatingLevelDescriptor, evaluationCriterionDescription, id, rubricDimensionSortOrder, useSnapshot);
            ...
            {
                OnErrorGetEvaluationRubricDimensionsDefaultImplementation(e, "/ed-fi/evaluationRubricDimensions", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, evaluationRubricRating, programEducationOrganizationId, programEvaluationElementTitle, programEvaluationPeriodDescriptor, programEvaluationTitle, programEvaluationTypeDescriptor, programName, programTypeDescriptor, evaluationRubricRatingLevelDescriptor, evaluationCriterionDescription, id, rubricDimensionSortOrder, useSnapshot);
        ...
        /// </summary>
        public partial class GetEvaluationRubricDimensionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetEvaluationRubricDimensionsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetEvaluationRubricDimensionsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetEvaluationRubricDimensionsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiEvaluationRubricDimension? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiEvaluationRubricDimension>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiEvaluationRubricDimension? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesEvaluationRubricDimensionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesEvaluationRubricDimensionsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostEvaluationRubricDimensionApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostEvaluationRubricDimensionApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutEvaluationRubricDimensionApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutEvaluationRubricDimensionApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
