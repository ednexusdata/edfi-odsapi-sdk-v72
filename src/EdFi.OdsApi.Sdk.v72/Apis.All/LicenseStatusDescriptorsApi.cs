...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteLicenseStatusDescriptorByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesLicenseStatusDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiLicenseStatusDescriptorDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetLicenseStatusDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiLicenseStatusDescriptor>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetLicenseStatusDescriptorsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiLicenseStatusDescriptor?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesLicenseStatusDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiLicenseStatusDescriptorKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostLicenseStatusDescriptorApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutLicenseStatusDescriptorApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class LicenseStatusDescriptorsApi : ILicenseStatusDescriptorsApi
    {
        ...
        /// </summary>
        public partial class DeleteLicenseStatusDescriptorByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteLicenseStatusDescriptorByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesLicenseStatusDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesLicenseStatusDescriptorsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        partial void FormatGetLicenseStatusDescriptors(ref Option<int> offset, ref Option<int> limit, ref Option<long> minChangeVersion, ref Option<long> maxChangeVersion, ref Option<bool> totalCount, ref Option<string> codeValue, ref Option<string> id, ref Option<string> varNamespace, ref Option<bool> useSnapshot);
        ...
        /// <returns></returns>
        private void ValidateGetLicenseStatusDescriptors(Option<string> codeValue, Option<string> id, Option<string> varNamespace)
        {
        ...
        {
            bool suppressDefaultLog = false;
            AfterGetLicenseStatusDescriptors(ref suppressDefaultLog, apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetLicenseStatusDescriptors(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetLicenseStatusDescriptorsApiResponse?> GetLicenseStatusDescriptorsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> codeValue = default, Option<string> id = default, Option<string> varNamespace = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetLicenseStatusDescriptorsAsync(offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IGetLicenseStatusDescriptorsApiResponse> GetLicenseStatusDescriptorsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> codeValue = default, Option<string> id = default, Option<string> varNamespace = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetLicenseStatusDescriptors(codeValue, id, varNamespace);

                FormatGetLicenseStatusDescriptors(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref codeValue, ref id, ref varNamespace, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetLicenseStatusDescriptorsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
            ...
            {
                OnErrorGetLicenseStatusDescriptorsDefaultImplementation(e, "/ed-fi/licenseStatusDescriptors", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
        ...
        /// </summary>
        public partial class GetLicenseStatusDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetLicenseStatusDescriptorsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetLicenseStatusDescriptorsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetLicenseStatusDescriptorsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiLicenseStatusDescriptor? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiLicenseStatusDescriptor>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiLicenseStatusDescriptor? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesLicenseStatusDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesLicenseStatusDescriptorsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostLicenseStatusDescriptorApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostLicenseStatusDescriptorApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutLicenseStatusDescriptorApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutLicenseStatusDescriptorApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
