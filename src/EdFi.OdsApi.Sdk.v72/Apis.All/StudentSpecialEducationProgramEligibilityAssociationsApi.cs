...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteStudentSpecialEducationProgramEligibilityAssociationByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesStudentSpecialEducationProgramEligibilityAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiStudentSpecialEducationProgramEligibilityAssociationDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetStudentSpecialEducationProgramEligibilityAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiStudentSpecialEducationProgramEligibilityAssociation>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetStudentSpecialEducationProgramEligibilityAssociationsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentSpecialEducationProgramEligibilityAssociation?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesStudentSpecialEducationProgramEligibilityAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiStudentSpecialEducationProgramEligibilityAssociationKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostStudentSpecialEducationProgramEligibilityAssociationApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutStudentSpecialEducationProgramEligibilityAssociationApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class StudentSpecialEducationProgramEligibilityAssociationsApi : IStudentSpecialEducationProgramEligibilityAssociationsApi
    {
        ...
        /// </summary>
        public partial class DeleteStudentSpecialEducationProgramEligibilityAssociationByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteStudentSpecialEducationProgramEligibilityAssociationByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesStudentSpecialEducationProgramEligibilityAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesStudentSpecialEducationProgramEligibilityAssociationsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        public async Task<IGetStudentSpecialEducationProgramEligibilityAssociationsApiResponse?> GetStudentSpecialEducationProgramEligibilityAssociationsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<DateOnly> consentToEvaluationReceivedDate = default, Option<long> educationOrganizationId = default, Option<string> programName = default, Option<string> programTypeDescriptor = default, Option<string> studentUniqueId = default, Option<string> eligibilityDelayReasonDescriptor = default, Option<string> eligibilityEvaluationTypeDescriptor = default, Option<string> evaluationDelayReasonDescriptor = default, Option<string> ideaPartDescriptor = default, Option<DateOnly> consentToEvaluationDate = default, Option<DateOnly> eligibilityConferenceDate = default, Option<DateOnly> eligibilityDeterminationDate = default, Option<DateOnly> eligibilityEvaluationDate = default, Option<bool> evaluationCompleteIndicator = default, Option<int> evaluationDelayDays = default, Option<string> evaluationLateReason = default, Option<string> id = default, Option<bool> ideaIndicator = default, Option<DateOnly> originalECIServicesDate = default, Option<DateOnly> transitionConferenceDate = default, Option<DateOnly> transitionNotificationDate = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetStudentSpecialEducationProgramEligibilityAssociationsAsync(offset, limit, minChangeVersion, maxChangeVersion, totalCount, consentToEvaluationReceivedDate, educationOrganizationId, programName, programTypeDescriptor, studentUniqueId, eligibilityDelayReasonDescriptor, eligibilityEvaluationTypeDescriptor, evaluationDelayReasonDescriptor, ideaPartDescriptor, consentToEvaluationDate, eligibilityConferenceDate, eligibilityDeterminationDate, eligibilityEvaluationDate, evaluationCompleteIndicator, evaluationDelayDays, evaluationLateReason, id, ideaIndicator, originalECIServicesDate, transitionConferenceDate, transitionNotificationDate, useSnapshot, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// </summary>
        public partial class GetStudentSpecialEducationProgramEligibilityAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetStudentSpecialEducationProgramEligibilityAssociationsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetStudentSpecialEducationProgramEligibilityAssociationsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetStudentSpecialEducationProgramEligibilityAssociationsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentSpecialEducationProgramEligibilityAssociation? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentSpecialEducationProgramEligibilityAssociation>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentSpecialEducationProgramEligibilityAssociation? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesStudentSpecialEducationProgramEligibilityAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesStudentSpecialEducationProgramEligibilityAssociationsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostStudentSpecialEducationProgramEligibilityAssociationApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostStudentSpecialEducationProgramEligibilityAssociationApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutStudentSpecialEducationProgramEligibilityAssociationApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutStudentSpecialEducationProgramEligibilityAssociationApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
