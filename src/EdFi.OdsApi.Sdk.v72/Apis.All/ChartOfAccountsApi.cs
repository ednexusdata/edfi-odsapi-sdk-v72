...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteChartOfAccountByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesChartOfAccountsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiChartOfAccountDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetChartOfAccountsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiChartOfAccount>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetChartOfAccountsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiChartOfAccount?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesChartOfAccountsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiChartOfAccountKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostChartOfAccountApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutChartOfAccountApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class ChartOfAccountsApi : IChartOfAccountsApi
    {
        ...
        /// </summary>
        public partial class DeleteChartOfAccountByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteChartOfAccountByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesChartOfAccountsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesChartOfAccountsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetChartOfAccounts(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, accountIdentifier, fiscalYear, educationOrganizationId, balanceSheetCode, functionCode, fundCode, objectCode, operationalUnitCode, programCode, projectCode, sourceCode, accountTypeDescriptor, accountName, id, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetChartOfAccountsApiResponse?> GetChartOfAccountsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> accountIdentifier = default, Option<int> fiscalYear = default, Option<long> educationOrganizationId = default, Option<string> balanceSheetCode = default, Option<string> functionCode = default, Option<string> fundCode = default, Option<string> objectCode = default, Option<string> operationalUnitCode = default, Option<string> programCode = default, Option<string> projectCode = default, Option<string> sourceCode = default, Option<string> accountTypeDescriptor = default, Option<string> accountName = default, Option<string> id = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetChartOfAccountsAsync(offset, limit, minChangeVersion, maxChangeVersion, totalCount, accountIdentifier, fiscalYear, educationOrganizationId, balanceSheetCode, functionCode, fundCode, objectCode, operationalUnitCode, programCode, projectCode, sourceCode, accountTypeDescriptor, accountName, id, useSnapshot, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IGetChartOfAccountsApiResponse> GetChartOfAccountsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> accountIdentifier = default, Option<int> fiscalYear = default, Option<long> educationOrganizationId = default, Option<string> balanceSheetCode = default, Option<string> functionCode = default, Option<string> fundCode = default, Option<string> objectCode = default, Option<string> operationalUnitCode = default, Option<string> programCode = default, Option<string> projectCode = default, Option<string> sourceCode = default, Option<string> accountTypeDescriptor = default, Option<string> accountName = default, Option<string> id = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetChartOfAccounts(accountIdentifier, balanceSheetCode, functionCode, fundCode, objectCode, operationalUnitCode, programCode, projectCode, sourceCode, accountTypeDescriptor, accountName, id);

                FormatGetChartOfAccounts(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref accountIdentifier, ref fiscalYear, ref educationOrganizationId, ref balanceSheetCode, ref functionCode, ref fundCode, ref objectCode, ref operationalUnitCode, ref programCode, ref projectCode, ref sourceCode, ref accountTypeDescriptor, ref accountName, ref id, ref useSnapshot);
        ...
        /// </summary>
        public partial class GetChartOfAccountsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetChartOfAccountsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetChartOfAccountsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetChartOfAccountsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiChartOfAccount? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiChartOfAccount>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiChartOfAccount? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesChartOfAccountsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesChartOfAccountsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostChartOfAccountApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostChartOfAccountApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutChartOfAccountApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutChartOfAccountApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
