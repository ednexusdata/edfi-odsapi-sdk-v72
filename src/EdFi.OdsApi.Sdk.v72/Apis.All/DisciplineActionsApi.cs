...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteDisciplineActionByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesDisciplineActionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiDisciplineActionDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetDisciplineActionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiDisciplineAction>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetDisciplineActionsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiDisciplineAction?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesDisciplineActionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiDisciplineActionKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostDisciplineActionApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutDisciplineActionApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class DisciplineActionsApi : IDisciplineActionsApi
    {
        ...
        /// </summary>
        public partial class DeleteDisciplineActionByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteDisciplineActionByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesDisciplineActionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesDisciplineActionsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        private void ValidateGetDisciplineActions(Option<string> disciplineActionIdentifier, Option<string> studentUniqueId, Option<string> disciplineActionLengthDifferenceReasonDescriptor, Option<string> id)
        {
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetDisciplineActions(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, disciplineActionIdentifier, disciplineDate, studentUniqueId, responsibilitySchoolId, assignmentSchoolId, disciplineActionLengthDifferenceReasonDescriptor, actualDisciplineActionLength, disciplineActionLength, id, iepPlacementMeetingIndicator, relatedToZeroTolerancePolicy, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetDisciplineActionsApiResponse> GetDisciplineActionsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> disciplineActionIdentifier = default, Option<DateOnly> disciplineDate = default, Option<string> studentUniqueId = default, Option<long> responsibilitySchoolId = default, Option<long> assignmentSchoolId = default, Option<string> disciplineActionLengthDifferenceReasonDescriptor = default, Option<double> actualDisciplineActionLength = default, Option<double> disciplineActionLength = default, Option<string> id = default, Option<bool> iepPlacementMeetingIndicator = default, Option<bool> relatedToZeroTolerancePolicy = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetDisciplineActions(disciplineActionIdentifier, studentUniqueId, disciplineActionLengthDifferenceReasonDescriptor, id);

                FormatGetDisciplineActions(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref disciplineActionIdentifier, ref disciplineDate, ref studentUniqueId, ref responsibilitySchoolId, ref assignmentSchoolId, ref disciplineActionLengthDifferenceReasonDescriptor, ref actualDisciplineActionLength, ref disciplineActionLength, ref id, ref iepPlacementMeetingIndicator, ref relatedToZeroTolerancePolicy, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetDisciplineActionsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, disciplineActionIdentifier, disciplineDate, studentUniqueId, responsibilitySchoolId, assignmentSchoolId, disciplineActionLengthDifferenceReasonDescriptor, actualDisciplineActionLength, disciplineActionLength, id, iepPlacementMeetingIndicator, relatedToZeroTolerancePolicy, useSnapshot);
            ...
            {
                OnErrorGetDisciplineActionsDefaultImplementation(e, "/ed-fi/disciplineActions", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, disciplineActionIdentifier, disciplineDate, studentUniqueId, responsibilitySchoolId, assignmentSchoolId, disciplineActionLengthDifferenceReasonDescriptor, actualDisciplineActionLength, disciplineActionLength, id, iepPlacementMeetingIndicator, relatedToZeroTolerancePolicy, useSnapshot);
        ...
        /// </summary>
        public partial class GetDisciplineActionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetDisciplineActionsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetDisciplineActionsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetDisciplineActionsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiDisciplineAction? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiDisciplineAction>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiDisciplineAction? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesDisciplineActionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesDisciplineActionsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostDisciplineActionApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostDisciplineActionApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutDisciplineActionApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutDisciplineActionApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
