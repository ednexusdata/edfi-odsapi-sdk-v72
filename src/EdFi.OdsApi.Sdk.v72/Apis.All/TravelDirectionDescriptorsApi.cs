...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteTravelDirectionDescriptorByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesTravelDirectionDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiTravelDirectionDescriptorDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetTravelDirectionDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiTravelDirectionDescriptor>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetTravelDirectionDescriptorsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiTravelDirectionDescriptor?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesTravelDirectionDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiTravelDirectionDescriptorKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostTravelDirectionDescriptorApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutTravelDirectionDescriptorApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class TravelDirectionDescriptorsApi : ITravelDirectionDescriptorsApi
    {
        ...
        /// </summary>
        public partial class DeleteTravelDirectionDescriptorByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteTravelDirectionDescriptorByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesTravelDirectionDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesTravelDirectionDescriptorsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        partial void FormatGetTravelDirectionDescriptors(ref Option<int> offset, ref Option<int> limit, ref Option<long> minChangeVersion, ref Option<long> maxChangeVersion, ref Option<bool> totalCount, ref Option<string> codeValue, ref Option<string> id, ref Option<string> varNamespace, ref Option<bool> useSnapshot);
        ...
        /// <returns></returns>
        private void ValidateGetTravelDirectionDescriptors(Option<string> codeValue, Option<string> id, Option<string> varNamespace)
        {
        ...
        {
            bool suppressDefaultLog = false;
            AfterGetTravelDirectionDescriptors(ref suppressDefaultLog, apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetTravelDirectionDescriptors(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetTravelDirectionDescriptorsApiResponse?> GetTravelDirectionDescriptorsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> codeValue = default, Option<string> id = default, Option<string> varNamespace = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetTravelDirectionDescriptorsAsync(offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IGetTravelDirectionDescriptorsApiResponse> GetTravelDirectionDescriptorsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> codeValue = default, Option<string> id = default, Option<string> varNamespace = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetTravelDirectionDescriptors(codeValue, id, varNamespace);

                FormatGetTravelDirectionDescriptors(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref codeValue, ref id, ref varNamespace, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetTravelDirectionDescriptorsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
            ...
            {
                OnErrorGetTravelDirectionDescriptorsDefaultImplementation(e, "/ed-fi/travelDirectionDescriptors", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
        ...
        /// </summary>
        public partial class GetTravelDirectionDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetTravelDirectionDescriptorsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetTravelDirectionDescriptorsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetTravelDirectionDescriptorsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiTravelDirectionDescriptor? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiTravelDirectionDescriptor>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiTravelDirectionDescriptor? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesTravelDirectionDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesTravelDirectionDescriptorsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostTravelDirectionDescriptorApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostTravelDirectionDescriptorApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutTravelDirectionDescriptorApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutTravelDirectionDescriptorApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
