...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteCourseByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesCoursesApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiCourseDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetCoursesApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiCourse>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetCoursesByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiCourse?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesCoursesApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiCourseKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostCourseApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutCourseApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class CoursesApi : ICoursesApi
    {
        ...
        /// </summary>
        public partial class DeleteCourseByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteCourseByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesCoursesApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesCoursesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        private void ValidateGetCourses(Option<string> courseCode, Option<string> careerPathwayDescriptor, Option<string> courseDefinedByDescriptor, Option<string> courseGPAApplicabilityDescriptor, Option<string> minimumAvailableCreditTypeDescriptor, Option<string> maximumAvailableCreditTypeDescriptor, Option<string> courseDescription, Option<string> courseTitle, Option<string> id)
        {
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetCourses(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, courseCode, educationOrganizationId, careerPathwayDescriptor, courseDefinedByDescriptor, courseGPAApplicabilityDescriptor, minimumAvailableCreditTypeDescriptor, maximumAvailableCreditTypeDescriptor, courseDescription, courseTitle, dateCourseAdopted, highSchoolCourseRequirement, id, maxCompletionsForCredit, maximumAvailableCreditConversion, maximumAvailableCredits, minimumAvailableCreditConversion, minimumAvailableCredits, numberOfParts, timeRequiredForCompletion, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetCoursesApiResponse?> GetCoursesOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> courseCode = default, Option<long> educationOrganizationId = default, Option<string> careerPathwayDescriptor = default, Option<string> courseDefinedByDescriptor = default, Option<string> courseGPAApplicabilityDescriptor = default, Option<string> minimumAvailableCreditTypeDescriptor = default, Option<string> maximumAvailableCreditTypeDescriptor = default, Option<string> courseDescription = default, Option<string> courseTitle = default, Option<DateOnly> dateCourseAdopted = default, Option<bool> highSchoolCourseRequirement = default, Option<string> id = default, Option<int> maxCompletionsForCredit = default, Option<double> maximumAvailableCreditConversion = default, Option<double> maximumAvailableCredits = default, Option<double> minimumAvailableCreditConversion = default, Option<double> minimumAvailableCredits = default, Option<int> numberOfParts = default, Option<int> timeRequiredForCompletion = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetCoursesAsync(offset, limit, minChangeVersion, maxChangeVersion, totalCount, courseCode, educationOrganizationId, careerPathwayDescriptor, courseDefinedByDescriptor, courseGPAApplicabilityDescriptor, minimumAvailableCreditTypeDescriptor, maximumAvailableCreditTypeDescriptor, courseDescription, courseTitle, dateCourseAdopted, highSchoolCourseRequirement, id, maxCompletionsForCredit, maximumAvailableCreditConversion, maximumAvailableCredits, minimumAvailableCreditConversion, minimumAvailableCredits, numberOfParts, timeRequiredForCompletion, useSnapshot, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IGetCoursesApiResponse> GetCoursesAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> courseCode = default, Option<long> educationOrganizationId = default, Option<string> careerPathwayDescriptor = default, Option<string> courseDefinedByDescriptor = default, Option<string> courseGPAApplicabilityDescriptor = default, Option<string> minimumAvailableCreditTypeDescriptor = default, Option<string> maximumAvailableCreditTypeDescriptor = default, Option<string> courseDescription = default, Option<string> courseTitle = default, Option<DateOnly> dateCourseAdopted = default, Option<bool> highSchoolCourseRequirement = default, Option<string> id = default, Option<int> maxCompletionsForCredit = default, Option<double> maximumAvailableCreditConversion = default, Option<double> maximumAvailableCredits = default, Option<double> minimumAvailableCreditConversion = default, Option<double> minimumAvailableCredits = default, Option<int> numberOfParts = default, Option<int> timeRequiredForCompletion = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetCourses(courseCode, careerPathwayDescriptor, courseDefinedByDescriptor, courseGPAApplicabilityDescriptor, minimumAvailableCreditTypeDescriptor, maximumAvailableCreditTypeDescriptor, courseDescription, courseTitle, id);

                FormatGetCourses(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref courseCode, ref educationOrganizationId, ref careerPathwayDescriptor, ref courseDefinedByDescriptor, ref courseGPAApplicabilityDescriptor, ref minimumAvailableCreditTypeDescriptor, ref maximumAvailableCreditTypeDescriptor, ref courseDescription, ref courseTitle, ref dateCourseAdopted, ref highSchoolCourseRequirement, ref id, ref maxCompletionsForCredit, ref maximumAvailableCreditConversion, ref maximumAvailableCredits, ref minimumAvailableCreditConversion, ref minimumAvailableCredits, ref numberOfParts, ref timeRequiredForCompletion, ref useSnapshot);
            ...
            {
                OnErrorGetCoursesDefaultImplementation(e, "/ed-fi/courses", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, courseCode, educationOrganizationId, careerPathwayDescriptor, courseDefinedByDescriptor, courseGPAApplicabilityDescriptor, minimumAvailableCreditTypeDescriptor, maximumAvailableCreditTypeDescriptor, courseDescription, courseTitle, dateCourseAdopted, highSchoolCourseRequirement, id, maxCompletionsForCredit, maximumAvailableCreditConversion, maximumAvailableCredits, minimumAvailableCreditConversion, minimumAvailableCredits, numberOfParts, timeRequiredForCompletion, useSnapshot);
        ...
        /// </summary>
        public partial class GetCoursesApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetCoursesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetCoursesByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetCoursesByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiCourse? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiCourse>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiCourse? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesCoursesApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesCoursesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostCourseApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostCourseApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutCourseApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutCourseApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
