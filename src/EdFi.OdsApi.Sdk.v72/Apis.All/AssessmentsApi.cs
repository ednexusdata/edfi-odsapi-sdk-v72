...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteAssessmentByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesAssessmentsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiAssessmentDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetAssessmentsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiAssessment>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetAssessmentsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiAssessment?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesAssessmentsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiAssessmentKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostAssessmentApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutAssessmentApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class AssessmentsApi : IAssessmentsApi
    {
        ...
        /// </summary>
        public partial class DeleteAssessmentByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteAssessmentByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesAssessmentsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesAssessmentsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// <returns></returns>
        private void ValidateGetAssessments(Option<string> assessmentIdentifier, Option<string> varNamespace, Option<string> assessmentCategoryDescriptor, Option<string> assessmentFamily, Option<string> assessmentForm, Option<string> assessmentTitle, Option<string> id, Option<string> nomenclature)
        {
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetAssessments(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, assessmentIdentifier, varNamespace, educationOrganizationId, assessmentCategoryDescriptor, adaptiveAssessment, assessmentFamily, assessmentForm, assessmentTitle, assessmentVersion, id, maxRawScore, nomenclature, revisionDate, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetAssessmentsApiResponse?> GetAssessmentsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> assessmentIdentifier = default, Option<string> varNamespace = default, Option<long> educationOrganizationId = default, Option<string> assessmentCategoryDescriptor = default, Option<bool> adaptiveAssessment = default, Option<string> assessmentFamily = default, Option<string> assessmentForm = default, Option<string> assessmentTitle = default, Option<int> assessmentVersion = default, Option<string> id = default, Option<double> maxRawScore = default, Option<string> nomenclature = default, Option<DateOnly> revisionDate = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetAssessmentsAsync(offset, limit, minChangeVersion, maxChangeVersion, totalCount, assessmentIdentifier, varNamespace, educationOrganizationId, assessmentCategoryDescriptor, adaptiveAssessment, assessmentFamily, assessmentForm, assessmentTitle, assessmentVersion, id, maxRawScore, nomenclature, revisionDate, useSnapshot, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IGetAssessmentsApiResponse> GetAssessmentsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> assessmentIdentifier = default, Option<string> varNamespace = default, Option<long> educationOrganizationId = default, Option<string> assessmentCategoryDescriptor = default, Option<bool> adaptiveAssessment = default, Option<string> assessmentFamily = default, Option<string> assessmentForm = default, Option<string> assessmentTitle = default, Option<int> assessmentVersion = default, Option<string> id = default, Option<double> maxRawScore = default, Option<string> nomenclature = default, Option<DateOnly> revisionDate = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetAssessments(assessmentIdentifier, varNamespace, assessmentCategoryDescriptor, assessmentFamily, assessmentForm, assessmentTitle, id, nomenclature);

                FormatGetAssessments(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref assessmentIdentifier, ref varNamespace, ref educationOrganizationId, ref assessmentCategoryDescriptor, ref adaptiveAssessment, ref assessmentFamily, ref assessmentForm, ref assessmentTitle, ref assessmentVersion, ref id, ref maxRawScore, ref nomenclature, ref revisionDate, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetAssessmentsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, assessmentIdentifier, varNamespace, educationOrganizationId, assessmentCategoryDescriptor, adaptiveAssessment, assessmentFamily, assessmentForm, assessmentTitle, assessmentVersion, id, maxRawScore, nomenclature, revisionDate, useSnapshot);
        ...
        /// </summary>
        public partial class GetAssessmentsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetAssessmentsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetAssessmentsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetAssessmentsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiAssessment? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiAssessment>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiAssessment? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesAssessmentsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesAssessmentsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostAssessmentApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostAssessmentApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutAssessmentApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutAssessmentApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
