...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteSectionByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesSectionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiSectionDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetSectionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiSection>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetSectionsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiSection?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesSectionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiSectionKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostSectionApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutSectionApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class SectionsApi : ISectionsApi
    {
        ...
        /// </summary>
        public partial class DeleteSectionByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteSectionByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesSectionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesSectionsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetSections(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, sectionIdentifier, localCourseCode, schoolId, schoolYear, sessionName, locationClassroomIdentificationCode, locationSchoolId, availableCreditTypeDescriptor, educationalEnvironmentDescriptor, instructionLanguageDescriptor, mediumOfInstructionDescriptor, populationServedDescriptor, sectionTypeDescriptor, availableCreditConversion, availableCredits, id, officialAttendancePeriod, sectionName, sequenceOfCourse, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetSectionsApiResponse> GetSectionsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> sectionIdentifier = default, Option<string> localCourseCode = default, Option<long> schoolId = default, Option<int> schoolYear = default, Option<string> sessionName = default, Option<string> locationClassroomIdentificationCode = default, Option<long> locationSchoolId = default, Option<string> availableCreditTypeDescriptor = default, Option<string> educationalEnvironmentDescriptor = default, Option<string> instructionLanguageDescriptor = default, Option<string> mediumOfInstructionDescriptor = default, Option<string> populationServedDescriptor = default, Option<string> sectionTypeDescriptor = default, Option<double> availableCreditConversion = default, Option<double> availableCredits = default, Option<string> id = default, Option<bool> officialAttendancePeriod = default, Option<string> sectionName = default, Option<int> sequenceOfCourse = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetSections(sectionIdentifier, localCourseCode, sessionName, locationClassroomIdentificationCode, availableCreditTypeDescriptor, educationalEnvironmentDescriptor, instructionLanguageDescriptor, mediumOfInstructionDescriptor, populationServedDescriptor, sectionTypeDescriptor, id, sectionName);

                FormatGetSections(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref sectionIdentifier, ref localCourseCode, ref schoolId, ref schoolYear, ref sessionName, ref locationClassroomIdentificationCode, ref locationSchoolId, ref availableCreditTypeDescriptor, ref educationalEnvironmentDescriptor, ref instructionLanguageDescriptor, ref mediumOfInstructionDescriptor, ref populationServedDescriptor, ref sectionTypeDescriptor, ref availableCreditConversion, ref availableCredits, ref id, ref officialAttendancePeriod, ref sectionName, ref sequenceOfCourse, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetSectionsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, sectionIdentifier, localCourseCode, schoolId, schoolYear, sessionName, locationClassroomIdentificationCode, locationSchoolId, availableCreditTypeDescriptor, educationalEnvironmentDescriptor, instructionLanguageDescriptor, mediumOfInstructionDescriptor, populationServedDescriptor, sectionTypeDescriptor, availableCreditConversion, availableCredits, id, officialAttendancePeriod, sectionName, sequenceOfCourse, useSnapshot);
            ...
            {
                OnErrorGetSectionsDefaultImplementation(e, "/ed-fi/sections", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, sectionIdentifier, localCourseCode, schoolId, schoolYear, sessionName, locationClassroomIdentificationCode, locationSchoolId, availableCreditTypeDescriptor, educationalEnvironmentDescriptor, instructionLanguageDescriptor, mediumOfInstructionDescriptor, populationServedDescriptor, sectionTypeDescriptor, availableCreditConversion, availableCredits, id, officialAttendancePeriod, sectionName, sequenceOfCourse, useSnapshot);
        ...
        /// </summary>
        public partial class GetSectionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetSectionsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetSectionsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetSectionsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiSection? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiSection>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiSection? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesSectionsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesSectionsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostSectionApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostSectionApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutSectionApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutSectionApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
