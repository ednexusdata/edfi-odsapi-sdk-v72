...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteEducationContentByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesEducationContentsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiEducationContentDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetEducationContentsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiEducationContent>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetEducationContentsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiEducationContent?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesEducationContentsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiEducationContentKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostEducationContentApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutEducationContentApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class EducationContentsApi : IEducationContentsApi
    {
        ...
        /// </summary>
        public partial class DeleteEducationContentByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteEducationContentByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesEducationContentsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesEducationContentsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetEducationContents(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, contentIdentifier, learningStandardId, contentClassDescriptor, costRateDescriptor, interactivityStyleDescriptor, additionalAuthorsIndicator, cost, description, id, learningResourceMetadataURI, varNamespace, publicationDate, publicationYear, publisher, shortDescription, timeRequired, useRightsURL, version, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetEducationContentsApiResponse> GetEducationContentsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> contentIdentifier = default, Option<string> learningStandardId = default, Option<string> contentClassDescriptor = default, Option<string> costRateDescriptor = default, Option<string> interactivityStyleDescriptor = default, Option<bool> additionalAuthorsIndicator = default, Option<double> cost = default, Option<string> description = default, Option<string> id = default, Option<string> learningResourceMetadataURI = default, Option<string> varNamespace = default, Option<DateOnly> publicationDate = default, Option<int> publicationYear = default, Option<string> publisher = default, Option<string> shortDescription = default, Option<string> timeRequired = default, Option<string> useRightsURL = default, Option<string> version = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetEducationContents(contentIdentifier, learningStandardId, contentClassDescriptor, costRateDescriptor, interactivityStyleDescriptor, description, id, learningResourceMetadataURI, varNamespace, publisher, shortDescription, timeRequired, useRightsURL, version);

                FormatGetEducationContents(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref contentIdentifier, ref learningStandardId, ref contentClassDescriptor, ref costRateDescriptor, ref interactivityStyleDescriptor, ref additionalAuthorsIndicator, ref cost, ref description, ref id, ref learningResourceMetadataURI, ref varNamespace, ref publicationDate, ref publicationYear, ref publisher, ref shortDescription, ref timeRequired, ref useRightsURL, ref version, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetEducationContentsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, contentIdentifier, learningStandardId, contentClassDescriptor, costRateDescriptor, interactivityStyleDescriptor, additionalAuthorsIndicator, cost, description, id, learningResourceMetadataURI, varNamespace, publicationDate, publicationYear, publisher, shortDescription, timeRequired, useRightsURL, version, useSnapshot);
        ...
        /// </summary>
        public partial class GetEducationContentsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetEducationContentsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetEducationContentsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetEducationContentsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiEducationContent? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiEducationContent>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiEducationContent? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesEducationContentsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesEducationContentsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostEducationContentApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostEducationContentApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutEducationContentApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutEducationContentApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
