...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteGradebookEntryByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesGradebookEntriesApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiGradebookEntryDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetGradebookEntriesApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiGradebookEntry>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetGradebookEntriesByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiGradebookEntry?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesGradebookEntriesApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiGradebookEntryKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostGradebookEntryApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutGradebookEntryApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class GradebookEntriesApi : IGradebookEntriesApi
    {
        ...
        /// </summary>
        public partial class DeleteGradebookEntryByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteGradebookEntryByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesGradebookEntriesApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesGradebookEntriesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetGradebookEntries(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, gradebookEntryIdentifier, varNamespace, gradingPeriodDescriptor, gradingPeriodName, schoolId, schoolYear, localCourseCode, sectionIdentifier, sessionName, gradebookEntryTypeDescriptor, dateAssigned, description, dueDate, dueTime, id, maxPoints, sourceSectionIdentifier, title, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetGradebookEntriesApiResponse> GetGradebookEntriesAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> gradebookEntryIdentifier = default, Option<string> varNamespace = default, Option<string> gradingPeriodDescriptor = default, Option<string> gradingPeriodName = default, Option<long> schoolId = default, Option<int> schoolYear = default, Option<string> localCourseCode = default, Option<string> sectionIdentifier = default, Option<string> sessionName = default, Option<string> gradebookEntryTypeDescriptor = default, Option<DateOnly> dateAssigned = default, Option<string> description = default, Option<DateOnly> dueDate = default, Option<string> dueTime = default, Option<string> id = default, Option<double> maxPoints = default, Option<string> sourceSectionIdentifier = default, Option<string> title = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetGradebookEntries(gradebookEntryIdentifier, varNamespace, gradingPeriodDescriptor, gradingPeriodName, localCourseCode, sectionIdentifier, sessionName, gradebookEntryTypeDescriptor, description, dueTime, id, sourceSectionIdentifier, title);

                FormatGetGradebookEntries(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref gradebookEntryIdentifier, ref varNamespace, ref gradingPeriodDescriptor, ref gradingPeriodName, ref schoolId, ref schoolYear, ref localCourseCode, ref sectionIdentifier, ref sessionName, ref gradebookEntryTypeDescriptor, ref dateAssigned, ref description, ref dueDate, ref dueTime, ref id, ref maxPoints, ref sourceSectionIdentifier, ref title, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetGradebookEntriesDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, gradebookEntryIdentifier, varNamespace, gradingPeriodDescriptor, gradingPeriodName, schoolId, schoolYear, localCourseCode, sectionIdentifier, sessionName, gradebookEntryTypeDescriptor, dateAssigned, description, dueDate, dueTime, id, maxPoints, sourceSectionIdentifier, title, useSnapshot);
            ...
            {
                OnErrorGetGradebookEntriesDefaultImplementation(e, "/ed-fi/gradebookEntries", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, gradebookEntryIdentifier, varNamespace, gradingPeriodDescriptor, gradingPeriodName, schoolId, schoolYear, localCourseCode, sectionIdentifier, sessionName, gradebookEntryTypeDescriptor, dateAssigned, description, dueDate, dueTime, id, maxPoints, sourceSectionIdentifier, title, useSnapshot);
        ...
        /// </summary>
        public partial class GetGradebookEntriesApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetGradebookEntriesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetGradebookEntriesByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetGradebookEntriesByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiGradebookEntry? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiGradebookEntry>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiGradebookEntry? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesGradebookEntriesApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesGradebookEntriesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostGradebookEntryApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostGradebookEntryApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutGradebookEntryApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutGradebookEntryApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
