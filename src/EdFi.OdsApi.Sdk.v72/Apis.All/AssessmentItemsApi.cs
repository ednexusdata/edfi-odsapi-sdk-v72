...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteAssessmentItemByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesAssessmentItemsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiAssessmentItemDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetAssessmentItemsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiAssessmentItem>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetAssessmentItemsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiAssessmentItem?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesAssessmentItemsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiAssessmentItemKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostAssessmentItemApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutAssessmentItemApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class AssessmentItemsApi : IAssessmentItemsApi
    {
        ...
        /// </summary>
        public partial class DeleteAssessmentItemByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteAssessmentItemByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesAssessmentItemsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesAssessmentItemsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// <returns></returns>
        private void ValidateGetAssessmentItems(Option<string> identificationCode, Option<string> assessmentIdentifier, Option<string> varNamespace, Option<string> assessmentItemCategoryDescriptor, Option<string> assessmentItemURI, Option<string> expectedTimeAssessed, Option<string> id, Option<string> itemText, Option<string> nomenclature)
        {
        ...
        {
            bool suppressDefaultLog = false;
            AfterGetAssessmentItems(ref suppressDefaultLog, apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, identificationCode, assessmentIdentifier, varNamespace, assessmentItemCategoryDescriptor, assessmentItemURI, expectedTimeAssessed, id, itemText, maxRawScore, nomenclature, useSnapshot);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        public async Task<IGetAssessmentItemsApiResponse> GetAssessmentItemsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> identificationCode = default, Option<string> assessmentIdentifier = default, Option<string> varNamespace = default, Option<string> assessmentItemCategoryDescriptor = default, Option<string> assessmentItemURI = default, Option<string> expectedTimeAssessed = default, Option<string> id = default, Option<string> itemText = default, Option<double> maxRawScore = default, Option<string> nomenclature = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetAssessmentItems(identificationCode, assessmentIdentifier, varNamespace, assessmentItemCategoryDescriptor, assessmentItemURI, expectedTimeAssessed, id, itemText, nomenclature);

                FormatGetAssessmentItems(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref identificationCode, ref assessmentIdentifier, ref varNamespace, ref assessmentItemCategoryDescriptor, ref assessmentItemURI, ref expectedTimeAssessed, ref id, ref itemText, ref maxRawScore, ref nomenclature, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetAssessmentItemsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, identificationCode, assessmentIdentifier, varNamespace, assessmentItemCategoryDescriptor, assessmentItemURI, expectedTimeAssessed, id, itemText, maxRawScore, nomenclature, useSnapshot);
            ...
            {
                OnErrorGetAssessmentItemsDefaultImplementation(e, "/ed-fi/assessmentItems", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, identificationCode, assessmentIdentifier, varNamespace, assessmentItemCategoryDescriptor, assessmentItemURI, expectedTimeAssessed, id, itemText, maxRawScore, nomenclature, useSnapshot);
        ...
        /// </summary>
        public partial class GetAssessmentItemsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetAssessmentItemsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetAssessmentItemsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetAssessmentItemsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiAssessmentItem? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiAssessmentItem>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiAssessmentItem? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesAssessmentItemsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesAssessmentItemsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostAssessmentItemApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostAssessmentItemApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutAssessmentItemApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutAssessmentItemApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
