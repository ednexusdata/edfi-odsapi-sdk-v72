...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteStudentSchoolAttendanceEventByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesStudentSchoolAttendanceEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiStudentSchoolAttendanceEventDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetStudentSchoolAttendanceEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiStudentSchoolAttendanceEvent>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetStudentSchoolAttendanceEventsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentSchoolAttendanceEvent?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesStudentSchoolAttendanceEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiStudentSchoolAttendanceEventKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostStudentSchoolAttendanceEventApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutStudentSchoolAttendanceEventApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class StudentSchoolAttendanceEventsApi : IStudentSchoolAttendanceEventsApi
    {
        ...
        /// </summary>
        public partial class DeleteStudentSchoolAttendanceEventByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteStudentSchoolAttendanceEventByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesStudentSchoolAttendanceEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesStudentSchoolAttendanceEventsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetStudentSchoolAttendanceEvents(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, attendanceEventCategoryDescriptor, eventDate, schoolId, schoolYear, sessionName, studentUniqueId, educationalEnvironmentDescriptor, arrivalTime, attendanceEventReason, departureTime, eventDuration, id, schoolAttendanceDuration, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetStudentSchoolAttendanceEventsApiResponse> GetStudentSchoolAttendanceEventsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> attendanceEventCategoryDescriptor = default, Option<DateOnly> eventDate = default, Option<long> schoolId = default, Option<int> schoolYear = default, Option<string> sessionName = default, Option<string> studentUniqueId = default, Option<string> educationalEnvironmentDescriptor = default, Option<string> arrivalTime = default, Option<string> attendanceEventReason = default, Option<string> departureTime = default, Option<double> eventDuration = default, Option<string> id = default, Option<int> schoolAttendanceDuration = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetStudentSchoolAttendanceEvents(attendanceEventCategoryDescriptor, sessionName, studentUniqueId, educationalEnvironmentDescriptor, arrivalTime, attendanceEventReason, departureTime, id);

                FormatGetStudentSchoolAttendanceEvents(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref attendanceEventCategoryDescriptor, ref eventDate, ref schoolId, ref schoolYear, ref sessionName, ref studentUniqueId, ref educationalEnvironmentDescriptor, ref arrivalTime, ref attendanceEventReason, ref departureTime, ref eventDuration, ref id, ref schoolAttendanceDuration, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetStudentSchoolAttendanceEventsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, attendanceEventCategoryDescriptor, eventDate, schoolId, schoolYear, sessionName, studentUniqueId, educationalEnvironmentDescriptor, arrivalTime, attendanceEventReason, departureTime, eventDuration, id, schoolAttendanceDuration, useSnapshot);
            ...
            {
                OnErrorGetStudentSchoolAttendanceEventsDefaultImplementation(e, "/ed-fi/studentSchoolAttendanceEvents", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, attendanceEventCategoryDescriptor, eventDate, schoolId, schoolYear, sessionName, studentUniqueId, educationalEnvironmentDescriptor, arrivalTime, attendanceEventReason, departureTime, eventDuration, id, schoolAttendanceDuration, useSnapshot);
        ...
        /// </summary>
        public partial class GetStudentSchoolAttendanceEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetStudentSchoolAttendanceEventsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetStudentSchoolAttendanceEventsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetStudentSchoolAttendanceEventsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentSchoolAttendanceEvent? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentSchoolAttendanceEvent>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentSchoolAttendanceEvent? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesStudentSchoolAttendanceEventsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesStudentSchoolAttendanceEventsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostStudentSchoolAttendanceEventApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostStudentSchoolAttendanceEventApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutStudentSchoolAttendanceEventApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutStudentSchoolAttendanceEventApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
