...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteStudentSpecialEducationProgramAssociationByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesStudentSpecialEducationProgramAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiStudentSpecialEducationProgramAssociationDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetStudentSpecialEducationProgramAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiStudentSpecialEducationProgramAssociation>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetStudentSpecialEducationProgramAssociationsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentSpecialEducationProgramAssociation?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesStudentSpecialEducationProgramAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiStudentSpecialEducationProgramAssociationKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostStudentSpecialEducationProgramAssociationApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutStudentSpecialEducationProgramAssociationApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class StudentSpecialEducationProgramAssociationsApi : IStudentSpecialEducationProgramAssociationsApi
    {
        ...
        /// </summary>
        public partial class DeleteStudentSpecialEducationProgramAssociationByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteStudentSpecialEducationProgramAssociationByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesStudentSpecialEducationProgramAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesStudentSpecialEducationProgramAssociationsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        private void ValidateGetStudentSpecialEducationProgramAssociations(Option<string> programName, Option<string> programTypeDescriptor, Option<string> studentUniqueId, Option<string> specialEducationExitReasonDescriptor, Option<string> specialEducationSettingDescriptor, Option<string> specialEducationExitExplained, Option<string> id)
        {
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetStudentSpecialEducationProgramAssociations(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, beginDate, educationOrganizationId, programEducationOrganizationId, programName, programTypeDescriptor, studentUniqueId, specialEducationExitReasonDescriptor, specialEducationSettingDescriptor, ideaEligibility, iepBeginDate, iepEndDate, iepReviewDate, lastEvaluationDate, medicallyFragile, multiplyDisabled, schoolHoursPerWeek, specialEducationExitDate, specialEducationExitExplained, specialEducationHoursPerWeek, id, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetStudentSpecialEducationProgramAssociationsApiResponse> GetStudentSpecialEducationProgramAssociationsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<DateOnly> beginDate = default, Option<long> educationOrganizationId = default, Option<long> programEducationOrganizationId = default, Option<string> programName = default, Option<string> programTypeDescriptor = default, Option<string> studentUniqueId = default, Option<string> specialEducationExitReasonDescriptor = default, Option<string> specialEducationSettingDescriptor = default, Option<bool> ideaEligibility = default, Option<DateOnly> iepBeginDate = default, Option<DateOnly> iepEndDate = default, Option<DateOnly> iepReviewDate = default, Option<DateOnly> lastEvaluationDate = default, Option<bool> medicallyFragile = default, Option<bool> multiplyDisabled = default, Option<double> schoolHoursPerWeek = default, Option<DateOnly> specialEducationExitDate = default, Option<string> specialEducationExitExplained = default, Option<double> specialEducationHoursPerWeek = default, Option<string> id = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetStudentSpecialEducationProgramAssociations(programName, programTypeDescriptor, studentUniqueId, specialEducationExitReasonDescriptor, specialEducationSettingDescriptor, specialEducationExitExplained, id);

                FormatGetStudentSpecialEducationProgramAssociations(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref beginDate, ref educationOrganizationId, ref programEducationOrganizationId, ref programName, ref programTypeDescriptor, ref studentUniqueId, ref specialEducationExitReasonDescriptor, ref specialEducationSettingDescriptor, ref ideaEligibility, ref iepBeginDate, ref iepEndDate, ref iepReviewDate, ref lastEvaluationDate, ref medicallyFragile, ref multiplyDisabled, ref schoolHoursPerWeek, ref specialEducationExitDate, ref specialEducationExitExplained, ref specialEducationHoursPerWeek, ref id, ref useSnapshot);
        ...
        /// </summary>
        public partial class GetStudentSpecialEducationProgramAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetStudentSpecialEducationProgramAssociationsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetStudentSpecialEducationProgramAssociationsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetStudentSpecialEducationProgramAssociationsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentSpecialEducationProgramAssociation? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentSpecialEducationProgramAssociation>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentSpecialEducationProgramAssociation? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesStudentSpecialEducationProgramAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesStudentSpecialEducationProgramAssociationsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostStudentSpecialEducationProgramAssociationApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostStudentSpecialEducationProgramAssociationApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutStudentSpecialEducationProgramAssociationApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutStudentSpecialEducationProgramAssociationApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
