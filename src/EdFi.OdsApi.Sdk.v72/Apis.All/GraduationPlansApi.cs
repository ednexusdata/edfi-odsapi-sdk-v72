...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteGraduationPlanByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesGraduationPlansApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiGraduationPlanDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetGraduationPlansApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiGraduationPlan>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetGraduationPlansByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiGraduationPlan?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesGraduationPlansApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiGraduationPlanKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostGraduationPlanApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutGraduationPlanApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class GraduationPlansApi : IGraduationPlansApi
    {
        ...
        /// </summary>
        public partial class DeleteGraduationPlanByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteGraduationPlanByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesGraduationPlansApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesGraduationPlansApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        private void ValidateGetGraduationPlans(Option<string> graduationPlanTypeDescriptor, Option<string> totalRequiredCreditTypeDescriptor, Option<string> id)
        {
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetGraduationPlans(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, graduationPlanTypeDescriptor, educationOrganizationId, graduationSchoolYear, totalRequiredCreditTypeDescriptor, id, individualPlan, totalRequiredCreditConversion, totalRequiredCredits, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetGraduationPlansApiResponse> GetGraduationPlansAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> graduationPlanTypeDescriptor = default, Option<long> educationOrganizationId = default, Option<int> graduationSchoolYear = default, Option<string> totalRequiredCreditTypeDescriptor = default, Option<string> id = default, Option<bool> individualPlan = default, Option<double> totalRequiredCreditConversion = default, Option<double> totalRequiredCredits = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetGraduationPlans(graduationPlanTypeDescriptor, totalRequiredCreditTypeDescriptor, id);

                FormatGetGraduationPlans(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref graduationPlanTypeDescriptor, ref educationOrganizationId, ref graduationSchoolYear, ref totalRequiredCreditTypeDescriptor, ref id, ref individualPlan, ref totalRequiredCreditConversion, ref totalRequiredCredits, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetGraduationPlansDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, graduationPlanTypeDescriptor, educationOrganizationId, graduationSchoolYear, totalRequiredCreditTypeDescriptor, id, individualPlan, totalRequiredCreditConversion, totalRequiredCredits, useSnapshot);
            ...
            {
                OnErrorGetGraduationPlansDefaultImplementation(e, "/ed-fi/graduationPlans", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, graduationPlanTypeDescriptor, educationOrganizationId, graduationSchoolYear, totalRequiredCreditTypeDescriptor, id, individualPlan, totalRequiredCreditConversion, totalRequiredCredits, useSnapshot);
        ...
        /// </summary>
        public partial class GetGraduationPlansApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetGraduationPlansApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetGraduationPlansByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetGraduationPlansByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiGraduationPlan? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiGraduationPlan>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiGraduationPlan? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesGraduationPlansApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesGraduationPlansApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostGraduationPlanApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostGraduationPlanApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutGraduationPlanApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutGraduationPlanApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
