...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteDisciplineIncidentByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesDisciplineIncidentsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiDisciplineIncidentDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetDisciplineIncidentsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiDisciplineIncident>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetDisciplineIncidentsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiDisciplineIncident?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesDisciplineIncidentsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiDisciplineIncidentKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostDisciplineIncidentApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutDisciplineIncidentApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class DisciplineIncidentsApi : IDisciplineIncidentsApi
    {
        ...
        /// </summary>
        public partial class DeleteDisciplineIncidentByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteDisciplineIncidentByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesDisciplineIncidentsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesDisciplineIncidentsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// <returns></returns>
        private void ValidateGetDisciplineIncidents(Option<string> incidentIdentifier, Option<string> incidentLocationDescriptor, Option<string> reporterDescriptionDescriptor, Option<string> caseNumber, Option<string> id, Option<string> incidentDescription, Option<string> incidentTime, Option<string> reporterName)
        {
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetDisciplineIncidents(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, incidentIdentifier, schoolId, incidentLocationDescriptor, reporterDescriptionDescriptor, caseNumber, id, incidentCost, incidentDate, incidentDescription, incidentTime, reportedToLawEnforcement, reporterName, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetDisciplineIncidentsApiResponse> GetDisciplineIncidentsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> incidentIdentifier = default, Option<long> schoolId = default, Option<string> incidentLocationDescriptor = default, Option<string> reporterDescriptionDescriptor = default, Option<string> caseNumber = default, Option<string> id = default, Option<double> incidentCost = default, Option<DateOnly> incidentDate = default, Option<string> incidentDescription = default, Option<string> incidentTime = default, Option<bool> reportedToLawEnforcement = default, Option<string> reporterName = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetDisciplineIncidents(incidentIdentifier, incidentLocationDescriptor, reporterDescriptionDescriptor, caseNumber, id, incidentDescription, incidentTime, reporterName);

                FormatGetDisciplineIncidents(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref incidentIdentifier, ref schoolId, ref incidentLocationDescriptor, ref reporterDescriptionDescriptor, ref caseNumber, ref id, ref incidentCost, ref incidentDate, ref incidentDescription, ref incidentTime, ref reportedToLawEnforcement, ref reporterName, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetDisciplineIncidentsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, incidentIdentifier, schoolId, incidentLocationDescriptor, reporterDescriptionDescriptor, caseNumber, id, incidentCost, incidentDate, incidentDescription, incidentTime, reportedToLawEnforcement, reporterName, useSnapshot);
        ...
        /// </summary>
        public partial class GetDisciplineIncidentsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetDisciplineIncidentsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetDisciplineIncidentsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetDisciplineIncidentsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiDisciplineIncident? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiDisciplineIncident>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiDisciplineIncident? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesDisciplineIncidentsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesDisciplineIncidentsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostDisciplineIncidentApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostDisciplineIncidentApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutDisciplineIncidentApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutDisciplineIncidentApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
