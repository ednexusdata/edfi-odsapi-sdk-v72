...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteReasonNotTestedDescriptorByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesReasonNotTestedDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiReasonNotTestedDescriptorDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetReasonNotTestedDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiReasonNotTestedDescriptor>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetReasonNotTestedDescriptorsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiReasonNotTestedDescriptor?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesReasonNotTestedDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiReasonNotTestedDescriptorKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostReasonNotTestedDescriptorApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutReasonNotTestedDescriptorApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class ReasonNotTestedDescriptorsApi : IReasonNotTestedDescriptorsApi
    {
        ...
        /// </summary>
        public partial class DeleteReasonNotTestedDescriptorByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteReasonNotTestedDescriptorByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesReasonNotTestedDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesReasonNotTestedDescriptorsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        partial void FormatGetReasonNotTestedDescriptors(ref Option<int> offset, ref Option<int> limit, ref Option<long> minChangeVersion, ref Option<long> maxChangeVersion, ref Option<bool> totalCount, ref Option<string> codeValue, ref Option<string> id, ref Option<string> varNamespace, ref Option<bool> useSnapshot);
        ...
        /// <returns></returns>
        private void ValidateGetReasonNotTestedDescriptors(Option<string> codeValue, Option<string> id, Option<string> varNamespace)
        {
        ...
        {
            bool suppressDefaultLog = false;
            AfterGetReasonNotTestedDescriptors(ref suppressDefaultLog, apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetReasonNotTestedDescriptors(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetReasonNotTestedDescriptorsApiResponse?> GetReasonNotTestedDescriptorsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> codeValue = default, Option<string> id = default, Option<string> varNamespace = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetReasonNotTestedDescriptorsAsync(offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IGetReasonNotTestedDescriptorsApiResponse> GetReasonNotTestedDescriptorsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> codeValue = default, Option<string> id = default, Option<string> varNamespace = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetReasonNotTestedDescriptors(codeValue, id, varNamespace);

                FormatGetReasonNotTestedDescriptors(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref codeValue, ref id, ref varNamespace, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetReasonNotTestedDescriptorsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
            ...
            {
                OnErrorGetReasonNotTestedDescriptorsDefaultImplementation(e, "/ed-fi/reasonNotTestedDescriptors", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
        ...
        /// </summary>
        public partial class GetReasonNotTestedDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetReasonNotTestedDescriptorsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetReasonNotTestedDescriptorsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetReasonNotTestedDescriptorsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiReasonNotTestedDescriptor? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiReasonNotTestedDescriptor>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiReasonNotTestedDescriptor? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesReasonNotTestedDescriptorsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesReasonNotTestedDescriptorsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostReasonNotTestedDescriptorApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostReasonNotTestedDescriptorApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutReasonNotTestedDescriptorApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutReasonNotTestedDescriptorApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
