...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteStudentMigrantEducationProgramAssociationByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesStudentMigrantEducationProgramAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiStudentMigrantEducationProgramAssociationDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetStudentMigrantEducationProgramAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiStudentMigrantEducationProgramAssociation>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetStudentMigrantEducationProgramAssociationsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentMigrantEducationProgramAssociation?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesStudentMigrantEducationProgramAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiStudentMigrantEducationProgramAssociationKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostStudentMigrantEducationProgramAssociationApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutStudentMigrantEducationProgramAssociationApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class StudentMigrantEducationProgramAssociationsApi : IStudentMigrantEducationProgramAssociationsApi
    {
        ...
        /// </summary>
        public partial class DeleteStudentMigrantEducationProgramAssociationByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteStudentMigrantEducationProgramAssociationByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesStudentMigrantEducationProgramAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesStudentMigrantEducationProgramAssociationsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        private void ValidateGetStudentMigrantEducationProgramAssociations(Option<string> programName, Option<string> programTypeDescriptor, Option<string> studentUniqueId, Option<string> continuationOfServicesReasonDescriptor, Option<string> id)
        {
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetStudentMigrantEducationProgramAssociations(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, beginDate, educationOrganizationId, programEducationOrganizationId, programName, programTypeDescriptor, studentUniqueId, continuationOfServicesReasonDescriptor, eligibilityExpirationDate, lastQualifyingMove, priorityForServices, qualifyingArrivalDate, stateResidencyDate, usInitialEntry, usInitialSchoolEntry, usMostRecentEntry, id, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetStudentMigrantEducationProgramAssociationsApiResponse?> GetStudentMigrantEducationProgramAssociationsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<DateOnly> beginDate = default, Option<long> educationOrganizationId = default, Option<long> programEducationOrganizationId = default, Option<string> programName = default, Option<string> programTypeDescriptor = default, Option<string> studentUniqueId = default, Option<string> continuationOfServicesReasonDescriptor = default, Option<DateOnly> eligibilityExpirationDate = default, Option<DateOnly> lastQualifyingMove = default, Option<bool> priorityForServices = default, Option<DateOnly> qualifyingArrivalDate = default, Option<DateOnly> stateResidencyDate = default, Option<DateOnly> usInitialEntry = default, Option<DateOnly> usInitialSchoolEntry = default, Option<DateOnly> usMostRecentEntry = default, Option<string> id = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetStudentMigrantEducationProgramAssociationsAsync(offset, limit, minChangeVersion, maxChangeVersion, totalCount, beginDate, educationOrganizationId, programEducationOrganizationId, programName, programTypeDescriptor, studentUniqueId, continuationOfServicesReasonDescriptor, eligibilityExpirationDate, lastQualifyingMove, priorityForServices, qualifyingArrivalDate, stateResidencyDate, usInitialEntry, usInitialSchoolEntry, usMostRecentEntry, id, useSnapshot, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IGetStudentMigrantEducationProgramAssociationsApiResponse> GetStudentMigrantEducationProgramAssociationsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<DateOnly> beginDate = default, Option<long> educationOrganizationId = default, Option<long> programEducationOrganizationId = default, Option<string> programName = default, Option<string> programTypeDescriptor = default, Option<string> studentUniqueId = default, Option<string> continuationOfServicesReasonDescriptor = default, Option<DateOnly> eligibilityExpirationDate = default, Option<DateOnly> lastQualifyingMove = default, Option<bool> priorityForServices = default, Option<DateOnly> qualifyingArrivalDate = default, Option<DateOnly> stateResidencyDate = default, Option<DateOnly> usInitialEntry = default, Option<DateOnly> usInitialSchoolEntry = default, Option<DateOnly> usMostRecentEntry = default, Option<string> id = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetStudentMigrantEducationProgramAssociations(programName, programTypeDescriptor, studentUniqueId, continuationOfServicesReasonDescriptor, id);

                FormatGetStudentMigrantEducationProgramAssociations(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref beginDate, ref educationOrganizationId, ref programEducationOrganizationId, ref programName, ref programTypeDescriptor, ref studentUniqueId, ref continuationOfServicesReasonDescriptor, ref eligibilityExpirationDate, ref lastQualifyingMove, ref priorityForServices, ref qualifyingArrivalDate, ref stateResidencyDate, ref usInitialEntry, ref usInitialSchoolEntry, ref usMostRecentEntry, ref id, ref useSnapshot);
        ...
        /// </summary>
        public partial class GetStudentMigrantEducationProgramAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetStudentMigrantEducationProgramAssociationsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetStudentMigrantEducationProgramAssociationsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetStudentMigrantEducationProgramAssociationsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentMigrantEducationProgramAssociation? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentMigrantEducationProgramAssociation>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiStudentMigrantEducationProgramAssociation? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesStudentMigrantEducationProgramAssociationsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesStudentMigrantEducationProgramAssociationsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostStudentMigrantEducationProgramAssociationApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostStudentMigrantEducationProgramAssociationApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutStudentMigrantEducationProgramAssociationApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutStudentMigrantEducationProgramAssociationApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
