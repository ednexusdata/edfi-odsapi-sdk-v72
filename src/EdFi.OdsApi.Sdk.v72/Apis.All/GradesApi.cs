...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteGradeByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesGradesApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiGradeDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetGradesApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiGrade>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetGradesByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiGrade?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesGradesApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiGradeKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostGradeApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutGradeApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class GradesApi : IGradesApi
    {
        ...
        /// </summary>
        public partial class DeleteGradeByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteGradeByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesGradesApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesGradesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        public async Task<IGetGradesApiResponse> GetGradesAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> gradeTypeDescriptor = default, Option<string> gradingPeriodDescriptor = default, Option<string> gradingPeriodName = default, Option<long> schoolId = default, Option<int> gradingPeriodSchoolYear = default, Option<DateOnly> beginDate = default, Option<string> localCourseCode = default, Option<int> schoolYear = default, Option<string> sectionIdentifier = default, Option<string> sessionName = default, Option<string> studentUniqueId = default, Option<string> performanceBaseConversionDescriptor = default, Option<DateOnly> currentGradeAsOfDate = default, Option<bool> currentGradeIndicator = default, Option<string> diagnosticStatement = default, Option<string> gradeEarnedDescription = default, Option<string> id = default, Option<string> letterGradeEarned = default, Option<double> numericGradeEarned = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetGrades(gradeTypeDescriptor, gradingPeriodDescriptor, gradingPeriodName, localCourseCode, sectionIdentifier, sessionName, studentUniqueId, performanceBaseConversionDescriptor, diagnosticStatement, gradeEarnedDescription, id, letterGradeEarned);

                FormatGetGrades(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref gradeTypeDescriptor, ref gradingPeriodDescriptor, ref gradingPeriodName, ref schoolId, ref gradingPeriodSchoolYear, ref beginDate, ref localCourseCode, ref schoolYear, ref sectionIdentifier, ref sessionName, ref studentUniqueId, ref performanceBaseConversionDescriptor, ref currentGradeAsOfDate, ref currentGradeIndicator, ref diagnosticStatement, ref gradeEarnedDescription, ref id, ref letterGradeEarned, ref numericGradeEarned, ref useSnapshot);
            ...
            {
                OnErrorGetGradesDefaultImplementation(e, "/ed-fi/grades", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, gradeTypeDescriptor, gradingPeriodDescriptor, gradingPeriodName, schoolId, gradingPeriodSchoolYear, beginDate, localCourseCode, schoolYear, sectionIdentifier, sessionName, studentUniqueId, performanceBaseConversionDescriptor, currentGradeAsOfDate, currentGradeIndicator, diagnosticStatement, gradeEarnedDescription, id, letterGradeEarned, numericGradeEarned, useSnapshot);
        ...
        /// </summary>
        public partial class GetGradesApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetGradesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetGradesByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetGradesByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiGrade? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiGrade>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiGrade? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesGradesApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesGradesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostGradeApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostGradeApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutGradeApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutGradeApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
