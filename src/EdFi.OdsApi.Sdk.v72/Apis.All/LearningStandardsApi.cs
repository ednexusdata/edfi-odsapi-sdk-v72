...
namespace EdFi.OdsApi.Sdk.v72.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteLearningStandardByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesLearningStandardsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiLearningStandardDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetLearningStandardsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<EdFiLearningStandard>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetLearningStandardsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v72.Models.All.EdFiLearningStandard?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesLearningStandardsApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse, IOk<List<TrackedChangesEdFiLearningStandardKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostLearningStandardApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutLearningStandardApiResponse : EdFi.OdsApi.Sdk.v72.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class LearningStandardsApi : ILearningStandardsApi
    {
        ...
        /// </summary>
        public partial class DeleteLearningStandardByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeleteLearningStandardByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesLearningStandardsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IDeletesLearningStandardsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetLearningStandards(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, learningStandardId, parentLearningStandardId, learningStandardCategoryDescriptor, learningStandardScopeDescriptor, courseTitle, description, id, learningStandardItemCode, varNamespace, successCriteria, uri, useSnapshot);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IGetLearningStandardsApiResponse?> GetLearningStandardsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> learningStandardId = default, Option<string> parentLearningStandardId = default, Option<string> learningStandardCategoryDescriptor = default, Option<string> learningStandardScopeDescriptor = default, Option<string> courseTitle = default, Option<string> description = default, Option<string> id = default, Option<string> learningStandardItemCode = default, Option<string> varNamespace = default, Option<string> successCriteria = default, Option<string> uri = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetLearningStandardsAsync(offset, limit, minChangeVersion, maxChangeVersion, totalCount, learningStandardId, parentLearningStandardId, learningStandardCategoryDescriptor, learningStandardScopeDescriptor, courseTitle, description, id, learningStandardItemCode, varNamespace, successCriteria, uri, useSnapshot, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IGetLearningStandardsApiResponse> GetLearningStandardsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> learningStandardId = default, Option<string> parentLearningStandardId = default, Option<string> learningStandardCategoryDescriptor = default, Option<string> learningStandardScopeDescriptor = default, Option<string> courseTitle = default, Option<string> description = default, Option<string> id = default, Option<string> learningStandardItemCode = default, Option<string> varNamespace = default, Option<string> successCriteria = default, Option<string> uri = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetLearningStandards(learningStandardId, parentLearningStandardId, learningStandardCategoryDescriptor, learningStandardScopeDescriptor, courseTitle, description, id, learningStandardItemCode, varNamespace, successCriteria, uri);

                FormatGetLearningStandards(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref learningStandardId, ref parentLearningStandardId, ref learningStandardCategoryDescriptor, ref learningStandardScopeDescriptor, ref courseTitle, ref description, ref id, ref learningStandardItemCode, ref varNamespace, ref successCriteria, ref uri, ref useSnapshot);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetLearningStandardsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, totalCount, learningStandardId, parentLearningStandardId, learningStandardCategoryDescriptor, learningStandardScopeDescriptor, courseTitle, description, id, learningStandardItemCode, varNamespace, successCriteria, uri, useSnapshot);
            ...
            {
                OnErrorGetLearningStandardsDefaultImplementation(e, "/ed-fi/learningStandards", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, totalCount, learningStandardId, parentLearningStandardId, learningStandardCategoryDescriptor, learningStandardScopeDescriptor, courseTitle, description, id, learningStandardItemCode, varNamespace, successCriteria, uri, useSnapshot);
        ...
        /// </summary>
        public partial class GetLearningStandardsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetLearningStandardsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetLearningStandardsByIdApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IGetLearningStandardsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v72.Models.All.EdFiLearningStandard? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v72.Models.All.EdFiLearningStandard>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v72.Models.All.EdFiLearningStandard? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesLearningStandardsApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IKeyChangesLearningStandardsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostLearningStandardApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPostLearningStandardApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutLearningStandardApiResponse : EdFi.OdsApi.Sdk.v72.Client.ApiResponse, IPutLearningStandardApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
