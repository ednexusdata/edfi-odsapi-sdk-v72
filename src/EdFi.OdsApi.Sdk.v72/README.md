...
$properties = @(
    ...
    'packageName=EdFi.OdsApi.Sdk.v72',
    'packageTags=',
...
using EdFi.OdsApi.Sdk.v72.Api;
using EdFi.OdsApi.Sdk.v72.Client;
using EdFi.OdsApi.Sdk.v72.Model;
...
- How do I validate requests and process responses?
  Use the provided On and After methods in the Api class from the namespace EdFi.OdsApi.Sdk.v72.Rest.DefaultApi.
...
- packageCopyright: No Copyright
- packageDescription: A library generated from a OpenAPI doc
- packageGuid: {51901FD7-B937-4203-A5B5-39AD7A1CCBA2}
- packageName: EdFi.OdsApi.Sdk.v72
- packageTags: 
- packageTitle: OpenAPI Library
- packageVersion: 1.0.0
