# EdFi.OdsApi.Sdk.v72.Apis.All.SurveyQuestionsApi
...
> List&lt;TrackedChangesEdFiSurveyQuestionDelete&gt; DeletesSurveyQuestions (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, bool? useSnapshot = null)
...
namespace Example
{
    public class DeletesSurveyQuestionsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiSurveyQuestionDelete> result = apiInstance.DeletesSurveyQuestions(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiSurveyQuestionDelete>> response = apiInstance.DeletesSurveyQuestionsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
namespace Example
{
    public class GetSurveyQuestionsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiSurveyQuestion> result = apiInstance.GetSurveyQuestions(offset, limit, minChangeVersion, maxChangeVersion, totalCount, questionCode, varNamespace, surveyIdentifier, surveySectionTitle, questionFormDescriptor, id, questionText, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiSurveyQuestion>> response = apiInstance.GetSurveyQuestionsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, questionCode, varNamespace, surveyIdentifier, surveySectionTitle, questionFormDescriptor, id, questionText, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> EdFiSurveyQuestion GetSurveyQuestionsById (string id, string? ifNoneMatch = null, bool? useSnapshot = null)
...
namespace Example
{
    public class GetSurveyQuestionsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiSurveyQuestion result = apiInstance.GetSurveyQuestionsById(id, ifNoneMatch, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiSurveyQuestion> response = apiInstance.GetSurveyQuestionsByIdWithHttpInfo(id, ifNoneMatch, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="keychangessurveyquestions"></a>
# **KeyChangesSurveyQuestions**
> List&lt;TrackedChangesEdFiSurveyQuestionKeyChange&gt; KeyChangesSurveyQuestions (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, bool? useSnapshot = null)
...
namespace Example
{
    public class KeyChangesSurveyQuestionsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiSurveyQuestionKeyChange> result = apiInstance.KeyChangesSurveyQuestions(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling SurveyQuestionsApi.KeyChangesSurveyQuestions: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the KeyChangesSurveyQuestionsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiSurveyQuestionKeyChange>> response = apiInstance.KeyChangesSurveyQuestionsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling SurveyQuestionsApi.KeyChangesSurveyQuestionsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
# **PostSurveyQuestion**
> void PostSurveyQuestion (EdFiSurveyQuestion edFiSurveyQuestion)
...
namespace Example
{
    public class PostSurveyQuestionExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new SurveyQuestionsApi(config);
            var edFiSurveyQuestion = new EdFiSurveyQuestion(); // EdFiSurveyQuestion | The JSON representation of the \"surveyQuestion\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostSurveyQuestion(edFiSurveyQuestion);
            }
            catch (ApiException  e)
            {
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostSurveyQuestionWithHttpInfo(edFiSurveyQuestion);
}
catch (ApiException e)
{
...
# **PutSurveyQuestion**
> void PutSurveyQuestion (string id, EdFiSurveyQuestion edFiSurveyQuestion, string? ifMatch = null)
...
namespace Example
{
    public class PutSurveyQuestionExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutSurveyQuestion(id, edFiSurveyQuestion, ifMatch);
            }
            catch (ApiException  e)
            {
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutSurveyQuestionWithHttpInfo(id, edFiSurveyQuestion, ifMatch);
}
catch (ApiException e)
{
