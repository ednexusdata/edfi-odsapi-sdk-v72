# EdFi.OdsApi.Sdk.v72.Apis.All.EducationOrganizationNetworksApi
...
> List&lt;EdFiEducationOrganizationNetwork&gt; GetEducationOrganizationNetworks (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, long? educationOrganizationNetworkId = null, string? networkPurposeDescriptor = null, string? id = null, bool? useSnapshot = null)
...
namespace Example
{
    public class GetEducationOrganizationNetworksExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiEducationOrganizationNetwork> result = apiInstance.GetEducationOrganizationNetworks(offset, limit, minChangeVersion, maxChangeVersion, totalCount, educationOrganizationNetworkId, networkPurposeDescriptor, id, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiEducationOrganizationNetwork>> response = apiInstance.GetEducationOrganizationNetworksWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, educationOrganizationNetworkId, networkPurposeDescriptor, id, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
