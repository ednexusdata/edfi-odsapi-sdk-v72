# EdFi.OdsApi.Sdk.v72.Apis.All.CteProgramServiceDescriptorsApi
...
<a id="deletecteprogramservicedescriptorbyid"></a>
...
<a id="deletescteprogramservicedescriptors"></a>
# **DeletesCTEProgramServiceDescriptors**
> List&lt;TrackedChangesEdFiCteProgramServiceDescriptorDelete&gt; DeletesCTEProgramServiceDescriptors (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, bool? useSnapshot = null)
...
namespace Example
{
    public class DeletesCTEProgramServiceDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiCteProgramServiceDescriptorDelete> result = apiInstance.DeletesCTEProgramServiceDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiCteProgramServiceDescriptorDelete>> response = apiInstance.DeletesCTEProgramServiceDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
<a id="getcteprogramservicedescriptors"></a>
# **GetCTEProgramServiceDescriptors**
> List&lt;EdFiCteProgramServiceDescriptor&gt; GetCTEProgramServiceDescriptors (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? codeValue = null, string? id = null, string? varNamespace = null, bool? useSnapshot = null)
...
namespace Example
{
    public class GetCTEProgramServiceDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiCteProgramServiceDescriptor> result = apiInstance.GetCTEProgramServiceDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiCteProgramServiceDescriptor>> response = apiInstance.GetCTEProgramServiceDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="getcteprogramservicedescriptorsbyid"></a>
# **GetCTEProgramServiceDescriptorsById**
> EdFiCteProgramServiceDescriptor GetCTEProgramServiceDescriptorsById (string id, string? ifNoneMatch = null, bool? useSnapshot = null)
...
namespace Example
{
    public class GetCTEProgramServiceDescriptorsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiCteProgramServiceDescriptor result = apiInstance.GetCTEProgramServiceDescriptorsById(id, ifNoneMatch, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiCteProgramServiceDescriptor> response = apiInstance.GetCTEProgramServiceDescriptorsByIdWithHttpInfo(id, ifNoneMatch, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="keychangescteprogramservicedescriptors"></a>
# **KeyChangesCTEProgramServiceDescriptors**
> List&lt;TrackedChangesEdFiCteProgramServiceDescriptorKeyChange&gt; KeyChangesCTEProgramServiceDescriptors (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, bool? useSnapshot = null)
...
namespace Example
{
    public class KeyChangesCTEProgramServiceDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiCteProgramServiceDescriptorKeyChange> result = apiInstance.KeyChangesCTEProgramServiceDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiCteProgramServiceDescriptorKeyChange>> response = apiInstance.KeyChangesCTEProgramServiceDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="postcteprogramservicedescriptor"></a>
# **PostCTEProgramServiceDescriptor**
> void PostCTEProgramServiceDescriptor (EdFiCteProgramServiceDescriptor edFiCteProgramServiceDescriptor)
...
namespace Example
{
    public class PostCTEProgramServiceDescriptorExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new CteProgramServiceDescriptorsApi(config);
            var edFiCteProgramServiceDescriptor = new EdFiCteProgramServiceDescriptor(); // EdFiCteProgramServiceDescriptor | The JSON representation of the \"cteProgramServiceDescriptor\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostCTEProgramServiceDescriptor(edFiCteProgramServiceDescriptor);
            }
            catch (ApiException  e)
            {
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostCTEProgramServiceDescriptorWithHttpInfo(edFiCteProgramServiceDescriptor);
}
catch (ApiException e)
{
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **edFiCteProgramServiceDescriptor** | [**EdFiCteProgramServiceDescriptor**](EdFiCteProgramServiceDescriptor.md) | The JSON representation of the \&quot;cteProgramServiceDescriptor\&quot; resource to be created or updated. |  |
...
<a id="putcteprogramservicedescriptor"></a>
# **PutCTEProgramServiceDescriptor**
> void PutCTEProgramServiceDescriptor (string id, EdFiCteProgramServiceDescriptor edFiCteProgramServiceDescriptor, string? ifMatch = null)
...
namespace Example
{
    public class PutCTEProgramServiceDescriptorExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutCTEProgramServiceDescriptor(id, edFiCteProgramServiceDescriptor, ifMatch);
            }
            catch (ApiException  e)
            {
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutCTEProgramServiceDescriptorWithHttpInfo(id, edFiCteProgramServiceDescriptor, ifMatch);
}
catch (ApiException e)
{
