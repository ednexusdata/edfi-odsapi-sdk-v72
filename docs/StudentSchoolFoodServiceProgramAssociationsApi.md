# EdFi.OdsApi.Sdk.v72.Apis.All.StudentSchoolFoodServiceProgramAssociationsApi
...
<a id="deletestudentschoolfoodserviceprogramassociationbyid"></a>
...
<a id="deletesstudentschoolfoodserviceprogramassociations"></a>
# **DeletesStudentSchoolFoodServiceProgramAssociations**
> List&lt;TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationDelete&gt; DeletesStudentSchoolFoodServiceProgramAssociations (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, bool? useSnapshot = null)
...
namespace Example
{
    public class DeletesStudentSchoolFoodServiceProgramAssociationsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationDelete> result = apiInstance.DeletesStudentSchoolFoodServiceProgramAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationDelete>> response = apiInstance.DeletesStudentSchoolFoodServiceProgramAssociationsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
[**List&lt;TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationDelete&gt;**](TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationDelete.md)
...
namespace Example
{
    public class GetStudentSchoolFoodServiceProgramAssociationsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiStudentSchoolFoodServiceProgramAssociation> result = apiInstance.GetStudentSchoolFoodServiceProgramAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, beginDate, educationOrganizationId, programEducationOrganizationId, programName, programTypeDescriptor, studentUniqueId, directCertification, id, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiStudentSchoolFoodServiceProgramAssociation>> response = apiInstance.GetStudentSchoolFoodServiceProgramAssociationsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, beginDate, educationOrganizationId, programEducationOrganizationId, programName, programTypeDescriptor, studentUniqueId, directCertification, id, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="getstudentschoolfoodserviceprogramassociationsbyid"></a>
# **GetStudentSchoolFoodServiceProgramAssociationsById**
> EdFiStudentSchoolFoodServiceProgramAssociation GetStudentSchoolFoodServiceProgramAssociationsById (string id, string? ifNoneMatch = null, bool? useSnapshot = null)
...
namespace Example
{
    public class GetStudentSchoolFoodServiceProgramAssociationsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiStudentSchoolFoodServiceProgramAssociation result = apiInstance.GetStudentSchoolFoodServiceProgramAssociationsById(id, ifNoneMatch, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiStudentSchoolFoodServiceProgramAssociation> response = apiInstance.GetStudentSchoolFoodServiceProgramAssociationsByIdWithHttpInfo(id, ifNoneMatch, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="keychangesstudentschoolfoodserviceprogramassociations"></a>
# **KeyChangesStudentSchoolFoodServiceProgramAssociations**
> List&lt;TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKeyChange&gt; KeyChangesStudentSchoolFoodServiceProgramAssociations (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, bool? useSnapshot = null)
...
namespace Example
{
    public class KeyChangesStudentSchoolFoodServiceProgramAssociationsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKeyChange> result = apiInstance.KeyChangesStudentSchoolFoodServiceProgramAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling StudentSchoolFoodServiceProgramAssociationsApi.KeyChangesStudentSchoolFoodServiceProgramAssociations: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the KeyChangesStudentSchoolFoodServiceProgramAssociationsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKeyChange>> response = apiInstance.KeyChangesStudentSchoolFoodServiceProgramAssociationsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling StudentSchoolFoodServiceProgramAssociationsApi.KeyChangesStudentSchoolFoodServiceProgramAssociationsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
[**List&lt;TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKeyChange&gt;**](TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKeyChange.md)
...
<a id="poststudentschoolfoodserviceprogramassociation"></a>
# **PostStudentSchoolFoodServiceProgramAssociation**
> void PostStudentSchoolFoodServiceProgramAssociation (EdFiStudentSchoolFoodServiceProgramAssociation edFiStudentSchoolFoodServiceProgramAssociation)
...
namespace Example
{
    public class PostStudentSchoolFoodServiceProgramAssociationExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new StudentSchoolFoodServiceProgramAssociationsApi(config);
            var edFiStudentSchoolFoodServiceProgramAssociation = new EdFiStudentSchoolFoodServiceProgramAssociation(); // EdFiStudentSchoolFoodServiceProgramAssociation | The JSON representation of the \"studentSchoolFoodServiceProgramAssociation\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostStudentSchoolFoodServiceProgramAssociation(edFiStudentSchoolFoodServiceProgramAssociation);
            }
            catch (ApiException  e)
            {
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostStudentSchoolFoodServiceProgramAssociationWithHttpInfo(edFiStudentSchoolFoodServiceProgramAssociation);
}
catch (ApiException e)
{
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **edFiStudentSchoolFoodServiceProgramAssociation** | [**EdFiStudentSchoolFoodServiceProgramAssociation**](EdFiStudentSchoolFoodServiceProgramAssociation.md) | The JSON representation of the \&quot;studentSchoolFoodServiceProgramAssociation\&quot; resource to be created or updated. |  |
...
<a id="putstudentschoolfoodserviceprogramassociation"></a>
# **PutStudentSchoolFoodServiceProgramAssociation**
> void PutStudentSchoolFoodServiceProgramAssociation (string id, EdFiStudentSchoolFoodServiceProgramAssociation edFiStudentSchoolFoodServiceProgramAssociation, string? ifMatch = null)
...
namespace Example
{
    public class PutStudentSchoolFoodServiceProgramAssociationExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutStudentSchoolFoodServiceProgramAssociation(id, edFiStudentSchoolFoodServiceProgramAssociation, ifMatch);
            }
            catch (ApiException  e)
            {
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutStudentSchoolFoodServiceProgramAssociationWithHttpInfo(id, edFiStudentSchoolFoodServiceProgramAssociation, ifMatch);
}
catch (ApiException e)
{
