# EdFi.OdsApi.Sdk.v72.Apis.All.AttemptStatusDescriptorsApi
...
<a id="deleteattemptstatusdescriptorbyid"></a>
...
<a id="deletesattemptstatusdescriptors"></a>
# **DeletesAttemptStatusDescriptors**
> List&lt;TrackedChangesEdFiAttemptStatusDescriptorDelete&gt; DeletesAttemptStatusDescriptors (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, bool? useSnapshot = null)
...
namespace Example
{
    public class DeletesAttemptStatusDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiAttemptStatusDescriptorDelete> result = apiInstance.DeletesAttemptStatusDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiAttemptStatusDescriptorDelete>> response = apiInstance.DeletesAttemptStatusDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
[**List&lt;TrackedChangesEdFiAttemptStatusDescriptorDelete&gt;**](TrackedChangesEdFiAttemptStatusDescriptorDelete.md)
...
<a id="getattemptstatusdescriptors"></a>
# **GetAttemptStatusDescriptors**
> List&lt;EdFiAttemptStatusDescriptor&gt; GetAttemptStatusDescriptors (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? codeValue = null, string? id = null, string? varNamespace = null, bool? useSnapshot = null)
...
namespace Example
{
    public class GetAttemptStatusDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiAttemptStatusDescriptor> result = apiInstance.GetAttemptStatusDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiAttemptStatusDescriptor>> response = apiInstance.GetAttemptStatusDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="getattemptstatusdescriptorsbyid"></a>
# **GetAttemptStatusDescriptorsById**
> EdFiAttemptStatusDescriptor GetAttemptStatusDescriptorsById (string id, string? ifNoneMatch = null, bool? useSnapshot = null)
...
namespace Example
{
    public class GetAttemptStatusDescriptorsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiAttemptStatusDescriptor result = apiInstance.GetAttemptStatusDescriptorsById(id, ifNoneMatch, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiAttemptStatusDescriptor> response = apiInstance.GetAttemptStatusDescriptorsByIdWithHttpInfo(id, ifNoneMatch, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="keychangesattemptstatusdescriptors"></a>
# **KeyChangesAttemptStatusDescriptors**
> List&lt;TrackedChangesEdFiAttemptStatusDescriptorKeyChange&gt; KeyChangesAttemptStatusDescriptors (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, bool? useSnapshot = null)
...
namespace Example
{
    public class KeyChangesAttemptStatusDescriptorsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiAttemptStatusDescriptorKeyChange> result = apiInstance.KeyChangesAttemptStatusDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling AttemptStatusDescriptorsApi.KeyChangesAttemptStatusDescriptors: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the KeyChangesAttemptStatusDescriptorsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiAttemptStatusDescriptorKeyChange>> response = apiInstance.KeyChangesAttemptStatusDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling AttemptStatusDescriptorsApi.KeyChangesAttemptStatusDescriptorsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
[**List&lt;TrackedChangesEdFiAttemptStatusDescriptorKeyChange&gt;**](TrackedChangesEdFiAttemptStatusDescriptorKeyChange.md)
...
<a id="postattemptstatusdescriptor"></a>
# **PostAttemptStatusDescriptor**
> void PostAttemptStatusDescriptor (EdFiAttemptStatusDescriptor edFiAttemptStatusDescriptor)
...
namespace Example
{
    public class PostAttemptStatusDescriptorExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new AttemptStatusDescriptorsApi(config);
            var edFiAttemptStatusDescriptor = new EdFiAttemptStatusDescriptor(); // EdFiAttemptStatusDescriptor | The JSON representation of the \"attemptStatusDescriptor\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostAttemptStatusDescriptor(edFiAttemptStatusDescriptor);
            }
            catch (ApiException  e)
            {
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostAttemptStatusDescriptorWithHttpInfo(edFiAttemptStatusDescriptor);
}
catch (ApiException e)
{
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **edFiAttemptStatusDescriptor** | [**EdFiAttemptStatusDescriptor**](EdFiAttemptStatusDescriptor.md) | The JSON representation of the \&quot;attemptStatusDescriptor\&quot; resource to be created or updated. |  |
...
<a id="putattemptstatusdescriptor"></a>
# **PutAttemptStatusDescriptor**
> void PutAttemptStatusDescriptor (string id, EdFiAttemptStatusDescriptor edFiAttemptStatusDescriptor, string? ifMatch = null)
...
namespace Example
{
    public class PutAttemptStatusDescriptorExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutAttemptStatusDescriptor(id, edFiAttemptStatusDescriptor, ifMatch);
            }
            catch (ApiException  e)
            {
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutAttemptStatusDescriptorWithHttpInfo(id, edFiAttemptStatusDescriptor, ifMatch);
}
catch (ApiException e)
{
