# EdFi.OdsApi.Sdk.v72.Apis.All.SectionAttendanceTakenEventsApi
...
namespace Example
{
    public class GetSectionAttendanceTakenEventsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiSectionAttendanceTakenEvent> result = apiInstance.GetSectionAttendanceTakenEvents(offset, limit, minChangeVersion, maxChangeVersion, totalCount, calendarCode, date, schoolId, schoolYear, localCourseCode, sectionIdentifier, sessionName, staffUniqueId, eventDate, id, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiSectionAttendanceTakenEvent>> response = apiInstance.GetSectionAttendanceTakenEventsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, calendarCode, date, schoolId, schoolYear, localCourseCode, sectionIdentifier, sessionName, staffUniqueId, eventDate, id, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
