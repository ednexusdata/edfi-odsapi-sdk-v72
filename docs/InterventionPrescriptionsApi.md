# EdFi.OdsApi.Sdk.v72.Apis.All.InterventionPrescriptionsApi
...
<a id="deleteinterventionprescriptionbyid"></a>
...
namespace Example
{
    public class DeleteInterventionPrescriptionByIdExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new InterventionPrescriptionsApi(config);
...
#### Using the DeleteInterventionPrescriptionByIdWithHttpInfo variant
...
{
    // Deletes an existing resource using the resource identifier.
    apiInstance.DeleteInterventionPrescriptionByIdWithHttpInfo(id, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling InterventionPrescriptionsApi.DeleteInterventionPrescriptionByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="deletesinterventionprescriptions"></a>
# **DeletesInterventionPrescriptions**
> List&lt;TrackedChangesEdFiInterventionPrescriptionDelete&gt; DeletesInterventionPrescriptions (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, bool? useSnapshot = null)
...
namespace Example
{
    public class DeletesInterventionPrescriptionsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiInterventionPrescriptionDelete> result = apiInstance.DeletesInterventionPrescriptions(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
#### Using the DeletesInterventionPrescriptionsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiInterventionPrescriptionDelete>> response = apiInstance.DeletesInterventionPrescriptionsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
{
    Debug.Print("Exception when calling InterventionPrescriptionsApi.DeletesInterventionPrescriptionsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="getinterventionprescriptions"></a>
# **GetInterventionPrescriptions**
> List&lt;EdFiInterventionPrescription&gt; GetInterventionPrescriptions (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? interventionPrescriptionIdentificationCode = null, long? educationOrganizationId = null, string? deliveryMethodDescriptor = null, string? interventionClassDescriptor = null, string? id = null, int? maxDosage = null, int? minDosage = null, string? varNamespace = null, bool? useSnapshot = null)
...
namespace Example
{
    public class GetInterventionPrescriptionsExample
    {
        public static void Main()
        {
            ...
            var varNamespace = "varNamespace_example";  // string? | Namespace for the intervention. (optional) 
            var useSnapshot = false;  // bool? | Indicates if the configured Snapshot should be used. (optional)  (default to false)
...
#### Using the GetInterventionPrescriptionsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiInterventionPrescription>> response = apiInstance.GetInterventionPrescriptionsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, interventionPrescriptionIdentificationCode, educationOrganizationId, deliveryMethodDescriptor, interventionClassDescriptor, id, maxDosage, minDosage, varNamespace, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling InterventionPrescriptionsApi.GetInterventionPrescriptionsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
| **varNamespace** | **string?** | Namespace for the intervention. | [optional]  |
| **useSnapshot** | **bool?** | Indicates if the configured Snapshot should be used. | [optional] [default to false] |
...
<a id="getinterventionprescriptionsbyid"></a>
# **GetInterventionPrescriptionsById**
> EdFiInterventionPrescription GetInterventionPrescriptionsById (string id, string? ifNoneMatch = null, bool? useSnapshot = null)
...
namespace Example
{
    public class GetInterventionPrescriptionsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiInterventionPrescription result = apiInstance.GetInterventionPrescriptionsById(id, ifNoneMatch, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the GetInterventionPrescriptionsByIdWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiInterventionPrescription> response = apiInstance.GetInterventionPrescriptionsByIdWithHttpInfo(id, ifNoneMatch, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling InterventionPrescriptionsApi.GetInterventionPrescriptionsByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="keychangesinterventionprescriptions"></a>
# **KeyChangesInterventionPrescriptions**
> List&lt;TrackedChangesEdFiInterventionPrescriptionKeyChange&gt; KeyChangesInterventionPrescriptions (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, bool? useSnapshot = null)
...
namespace Example
{
    public class KeyChangesInterventionPrescriptionsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiInterventionPrescriptionKeyChange> result = apiInstance.KeyChangesInterventionPrescriptions(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling InterventionPrescriptionsApi.KeyChangesInterventionPrescriptions: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the KeyChangesInterventionPrescriptionsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiInterventionPrescriptionKeyChange>> response = apiInstance.KeyChangesInterventionPrescriptionsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling InterventionPrescriptionsApi.KeyChangesInterventionPrescriptionsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="postinterventionprescription"></a>
# **PostInterventionPrescription**
> void PostInterventionPrescription (EdFiInterventionPrescription edFiInterventionPrescription)
...
namespace Example
{
    public class PostInterventionPrescriptionExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new InterventionPrescriptionsApi(config);
            var edFiInterventionPrescription = new EdFiInterventionPrescription(); // EdFiInterventionPrescription | The JSON representation of the \"interventionPrescription\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostInterventionPrescription(edFiInterventionPrescription);
            }
            catch (ApiException  e)
            {
...
#### Using the PostInterventionPrescriptionWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostInterventionPrescriptionWithHttpInfo(edFiInterventionPrescription);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling InterventionPrescriptionsApi.PostInterventionPrescriptionWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="putinterventionprescription"></a>
# **PutInterventionPrescription**
> void PutInterventionPrescription (string id, EdFiInterventionPrescription edFiInterventionPrescription, string? ifMatch = null)
...
namespace Example
{
    public class PutInterventionPrescriptionExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutInterventionPrescription(id, edFiInterventionPrescription, ifMatch);
            }
            catch (ApiException  e)
            {
...
#### Using the PutInterventionPrescriptionWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutInterventionPrescriptionWithHttpInfo(id, edFiInterventionPrescription, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling InterventionPrescriptionsApi.PutInterventionPrescriptionWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
