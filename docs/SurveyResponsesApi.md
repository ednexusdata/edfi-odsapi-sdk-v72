# EdFi.OdsApi.Sdk.v72.Apis.All.SurveyResponsesApi
...
<a id="deletesurveyresponsebyid"></a>
...
namespace Example
{
    public class DeleteSurveyResponseByIdExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new SurveyResponsesApi(config);
...
#### Using the DeleteSurveyResponseByIdWithHttpInfo variant
...
{
    // Deletes an existing resource using the resource identifier.
    apiInstance.DeleteSurveyResponseByIdWithHttpInfo(id, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling SurveyResponsesApi.DeleteSurveyResponseByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="deletessurveyresponses"></a>
# **DeletesSurveyResponses**
> List&lt;TrackedChangesEdFiSurveyResponseDelete&gt; DeletesSurveyResponses (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, bool? useSnapshot = null)
...
namespace Example
{
    public class DeletesSurveyResponsesExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiSurveyResponseDelete> result = apiInstance.DeletesSurveyResponses(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
#### Using the DeletesSurveyResponsesWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiSurveyResponseDelete>> response = apiInstance.DeletesSurveyResponsesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
{
    Debug.Print("Exception when calling SurveyResponsesApi.DeletesSurveyResponsesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="getsurveyresponses"></a>
# **GetSurveyResponses**
> List&lt;EdFiSurveyResponse&gt; GetSurveyResponses (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? surveyResponseIdentifier = null, string? varNamespace = null, string? surveyIdentifier = null, string? contactUniqueId = null, string? staffUniqueId = null, string? studentUniqueId = null, string? electronicMailAddress = null, string? fullName = null, string? id = null, string? location = null, DateOnly? responseDate = null, int? responseTime = null, bool? useSnapshot = null)
...
namespace Example
{
    public class GetSurveyResponsesExample
    {
        public static void Main()
        {
            ...
            var responseDate = DateOnly.Parse("2013-10-20");  // DateOnly? | Date of the survey response. (optional) 
...
#### Using the GetSurveyResponsesWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiSurveyResponse>> response = apiInstance.GetSurveyResponsesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, surveyResponseIdentifier, varNamespace, surveyIdentifier, contactUniqueId, staffUniqueId, studentUniqueId, electronicMailAddress, fullName, id, location, responseDate, responseTime, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling SurveyResponsesApi.GetSurveyResponsesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
| **responseDate** | **DateOnly?** | Date of the survey response. | [optional]  |
...
<a id="getsurveyresponsesbyid"></a>
# **GetSurveyResponsesById**
> EdFiSurveyResponse GetSurveyResponsesById (string id, string? ifNoneMatch = null, bool? useSnapshot = null)
...
namespace Example
{
    public class GetSurveyResponsesByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiSurveyResponse result = apiInstance.GetSurveyResponsesById(id, ifNoneMatch, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the GetSurveyResponsesByIdWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiSurveyResponse> response = apiInstance.GetSurveyResponsesByIdWithHttpInfo(id, ifNoneMatch, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling SurveyResponsesApi.GetSurveyResponsesByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="keychangessurveyresponses"></a>
# **KeyChangesSurveyResponses**
> List&lt;TrackedChangesEdFiSurveyResponseKeyChange&gt; KeyChangesSurveyResponses (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, bool? useSnapshot = null)
...
namespace Example
{
    public class KeyChangesSurveyResponsesExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiSurveyResponseKeyChange> result = apiInstance.KeyChangesSurveyResponses(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling SurveyResponsesApi.KeyChangesSurveyResponses: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the KeyChangesSurveyResponsesWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiSurveyResponseKeyChange>> response = apiInstance.KeyChangesSurveyResponsesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling SurveyResponsesApi.KeyChangesSurveyResponsesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="postsurveyresponse"></a>
# **PostSurveyResponse**
> void PostSurveyResponse (EdFiSurveyResponse edFiSurveyResponse)
...
namespace Example
{
    public class PostSurveyResponseExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new SurveyResponsesApi(config);
            var edFiSurveyResponse = new EdFiSurveyResponse(); // EdFiSurveyResponse | The JSON representation of the \"surveyResponse\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostSurveyResponse(edFiSurveyResponse);
            }
            catch (ApiException  e)
            {
...
#### Using the PostSurveyResponseWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostSurveyResponseWithHttpInfo(edFiSurveyResponse);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling SurveyResponsesApi.PostSurveyResponseWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="putsurveyresponse"></a>
# **PutSurveyResponse**
> void PutSurveyResponse (string id, EdFiSurveyResponse edFiSurveyResponse, string? ifMatch = null)
...
namespace Example
{
    public class PutSurveyResponseExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutSurveyResponse(id, edFiSurveyResponse, ifMatch);
            }
            catch (ApiException  e)
            {
...
#### Using the PutSurveyResponseWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutSurveyResponseWithHttpInfo(id, edFiSurveyResponse, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling SurveyResponsesApi.PutSurveyResponseWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
