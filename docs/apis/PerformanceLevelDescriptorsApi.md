# EdFi.OdsApi.Sdk.v72.Apis.All.PerformanceLevelDescriptorsApi
...
| [**KeyChangesPerformanceLevelDescriptors**](PerformanceLevelDescriptorsApi.md#keychangesperformanceleveldescriptors) | **GET** /ed-fi/performanceLevelDescriptors/keyChanges | Retrieves resources key changes based on change version. |
...
<a id="deleteperformanceleveldescriptorbyid"></a>
...
<a id="deletesperformanceleveldescriptors"></a>
# **DeletesPerformanceLevelDescriptors**
> List&lt;TrackedChangesEdFiPerformanceLevelDescriptorDelete&gt; DeletesPerformanceLevelDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class DeletesPerformanceLevelDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiPerformanceLevelDescriptorDelete> result = apiInstance.DeletesPerformanceLevelDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiPerformanceLevelDescriptorDelete>> response = apiInstance.DeletesPerformanceLevelDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
[**List&lt;TrackedChangesEdFiPerformanceLevelDescriptorDelete&gt;**](TrackedChangesEdFiPerformanceLevelDescriptorDelete.md)
...
<a id="getperformanceleveldescriptors"></a>
# **GetPerformanceLevelDescriptors**
> List&lt;EdFiPerformanceLevelDescriptor&gt; GetPerformanceLevelDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string codeValue = null, string id = null, string varNamespace = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetPerformanceLevelDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiPerformanceLevelDescriptor> result = apiInstance.GetPerformanceLevelDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiPerformanceLevelDescriptor>> response = apiInstance.GetPerformanceLevelDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="getperformanceleveldescriptorsbyid"></a>
# **GetPerformanceLevelDescriptorsById**
> EdFiPerformanceLevelDescriptor GetPerformanceLevelDescriptorsById (string id, string ifNoneMatch = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetPerformanceLevelDescriptorsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiPerformanceLevelDescriptor result = apiInstance.GetPerformanceLevelDescriptorsById(id, ifNoneMatch, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiPerformanceLevelDescriptor> response = apiInstance.GetPerformanceLevelDescriptorsByIdWithHttpInfo(id, ifNoneMatch, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="keychangesperformanceleveldescriptors"></a>
# **KeyChangesPerformanceLevelDescriptors**
> List&lt;TrackedChangesEdFiPerformanceLevelDescriptorKeyChange&gt; KeyChangesPerformanceLevelDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class KeyChangesPerformanceLevelDescriptorsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiPerformanceLevelDescriptorKeyChange> result = apiInstance.KeyChangesPerformanceLevelDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling PerformanceLevelDescriptorsApi.KeyChangesPerformanceLevelDescriptors: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the KeyChangesPerformanceLevelDescriptorsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiPerformanceLevelDescriptorKeyChange>> response = apiInstance.KeyChangesPerformanceLevelDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling PerformanceLevelDescriptorsApi.KeyChangesPerformanceLevelDescriptorsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
[**List&lt;TrackedChangesEdFiPerformanceLevelDescriptorKeyChange&gt;**](TrackedChangesEdFiPerformanceLevelDescriptorKeyChange.md)
...
<a id="postperformanceleveldescriptor"></a>
# **PostPerformanceLevelDescriptor**
> void PostPerformanceLevelDescriptor (EdFiPerformanceLevelDescriptor edFiPerformanceLevelDescriptor)
...
namespace Example
{
    public class PostPerformanceLevelDescriptorExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new PerformanceLevelDescriptorsApi(config);
            var edFiPerformanceLevelDescriptor = new EdFiPerformanceLevelDescriptor(); // EdFiPerformanceLevelDescriptor | The JSON representation of the \"performanceLevelDescriptor\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostPerformanceLevelDescriptor(edFiPerformanceLevelDescriptor);
            }
            catch (ApiException  e)
            {
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostPerformanceLevelDescriptorWithHttpInfo(edFiPerformanceLevelDescriptor);
}
catch (ApiException e)
{
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **edFiPerformanceLevelDescriptor** | [**EdFiPerformanceLevelDescriptor**](EdFiPerformanceLevelDescriptor.md) | The JSON representation of the \&quot;performanceLevelDescriptor\&quot; resource to be created or updated. |  |
...
<a id="putperformanceleveldescriptor"></a>
# **PutPerformanceLevelDescriptor**
> void PutPerformanceLevelDescriptor (string id, EdFiPerformanceLevelDescriptor edFiPerformanceLevelDescriptor, string ifMatch = null)
...
namespace Example
{
    public class PutPerformanceLevelDescriptorExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutPerformanceLevelDescriptor(id, edFiPerformanceLevelDescriptor, ifMatch);
            }
            catch (ApiException  e)
            {
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutPerformanceLevelDescriptorWithHttpInfo(id, edFiPerformanceLevelDescriptor, ifMatch);
}
catch (ApiException e)
{
