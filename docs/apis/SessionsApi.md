# EdFi.OdsApi.Sdk.v72.Apis.All.SessionsApi
...
<a id="deletessessions"></a>
# **DeletesSessions**
> List&lt;TrackedChangesEdFiSessionDelete&gt; DeletesSessions (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class DeletesSessionsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiSessionDelete> result = apiInstance.DeletesSessions(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiSessionDelete>> response = apiInstance.DeletesSessionsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
<a id="getsessions"></a>
# **GetSessions**
> List&lt;EdFiSession&gt; GetSessions (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string sessionName = null, long schoolId = null, int schoolYear = null, string termDescriptor = null, DateOnly beginDate = null, DateOnly endDate = null, string id = null, int totalInstructionalDays = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetSessionsExample
    {
        public static void Main()
        {
            ...
            var termDescriptor = "termDescriptor_example";  // string | A descriptor value to indicate the term that the session is associated with. (optional) 
            var beginDate = DateOnly.Parse("2013-10-20");  // DateOnly | Month, day, and year of the first day of the session. (optional) 
            var endDate = DateOnly.Parse("2013-10-20");  // DateOnly | Month, day and year of the last day of the session. (optional) 
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiSession> result = apiInstance.GetSessions(offset, limit, minChangeVersion, maxChangeVersion, totalCount, sessionName, schoolId, schoolYear, termDescriptor, beginDate, endDate, id, totalInstructionalDays, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiSession>> response = apiInstance.GetSessionsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, sessionName, schoolId, schoolYear, termDescriptor, beginDate, endDate, id, totalInstructionalDays, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
| **beginDate** | **DateOnly** | Month, day, and year of the first day of the session. | [optional]  |
| **endDate** | **DateOnly** | Month, day and year of the last day of the session. | [optional]  |
| **id** | **string** |  | [optional]  |
...
<a id="getsessionsbyid"></a>
# **GetSessionsById**
> EdFiSession GetSessionsById (string id, string ifNoneMatch = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetSessionsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiSession result = apiInstance.GetSessionsById(id, ifNoneMatch, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiSession> response = apiInstance.GetSessionsByIdWithHttpInfo(id, ifNoneMatch, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="keychangessessions"></a>
# **KeyChangesSessions**
> List&lt;TrackedChangesEdFiSessionKeyChange&gt; KeyChangesSessions (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class KeyChangesSessionsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiSessionKeyChange> result = apiInstance.KeyChangesSessions(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiSessionKeyChange>> response = apiInstance.KeyChangesSessionsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="postsession"></a>
# **PostSession**
> void PostSession (EdFiSession edFiSession)
...
namespace Example
{
    public class PostSessionExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new SessionsApi(config);
            var edFiSession = new EdFiSession(); // EdFiSession | The JSON representation of the \"session\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostSession(edFiSession);
            }
            catch (ApiException  e)
            {
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostSessionWithHttpInfo(edFiSession);
}
catch (ApiException e)
{
...
<a id="putsession"></a>
# **PutSession**
> void PutSession (string id, EdFiSession edFiSession, string ifMatch = null)
...
namespace Example
{
    public class PutSessionExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutSession(id, edFiSession, ifMatch);
            }
            catch (ApiException  e)
            {
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutSessionWithHttpInfo(id, edFiSession, ifMatch);
}
catch (ApiException e)
{
