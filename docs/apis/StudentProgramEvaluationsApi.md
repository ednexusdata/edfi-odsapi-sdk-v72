# EdFi.OdsApi.Sdk.v72.Apis.All.StudentProgramEvaluationsApi
...
namespace Example
{
    public class GetStudentProgramEvaluationsExample
    {
        public static void Main()
        {
            ...
            var evaluationDuration = 56;  // int | The actual or estimated number of clock minutes during which the evaluation was conducted. (optional) 
