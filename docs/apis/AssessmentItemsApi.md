# EdFi.OdsApi.Sdk.v72.Apis.All.AssessmentItemsApi
...
<a id="deleteassessmentitembyid"></a>
...
namespace Example
{
    public class DeleteAssessmentItemByIdExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new AssessmentItemsApi(config);
...
#### Using the DeleteAssessmentItemByIdWithHttpInfo variant
...
{
    // Deletes an existing resource using the resource identifier.
    apiInstance.DeleteAssessmentItemByIdWithHttpInfo(id, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling AssessmentItemsApi.DeleteAssessmentItemByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="deletesassessmentitems"></a>
# **DeletesAssessmentItems**
> List&lt;TrackedChangesEdFiAssessmentItemDelete&gt; DeletesAssessmentItems (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class DeletesAssessmentItemsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiAssessmentItemDelete> result = apiInstance.DeletesAssessmentItems(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
#### Using the DeletesAssessmentItemsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiAssessmentItemDelete>> response = apiInstance.DeletesAssessmentItemsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
{
    Debug.Print("Exception when calling AssessmentItemsApi.DeletesAssessmentItemsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="getassessmentitems"></a>
# **GetAssessmentItems**
> List&lt;EdFiAssessmentItem&gt; GetAssessmentItems (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string identificationCode = null, string assessmentIdentifier = null, string varNamespace = null, string assessmentItemCategoryDescriptor = null, string assessmentItemURI = null, string expectedTimeAssessed = null, string id = null, string itemText = null, double maxRawScore = null, string nomenclature = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetAssessmentItemsExample
    {
        public static void Main()
        {
            ...
            var assessmentItemCategoryDescriptor = "assessmentItemCategoryDescriptor_example";  // string | Category or type of the assessment item. (optional) 
            ...
            var expectedTimeAssessed = "expectedTimeAssessed_example";  // string | The duration of time allotted for the assessment item. (optional) 
            ...
            var nomenclature = "nomenclature_example";  // string | Reflects the specific nomenclature used for assessment item. (optional) 
            var useSnapshot = false;  // bool | Indicates if the configured Snapshot should be used. (optional)  (default to false)

            try
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiAssessmentItem> result = apiInstance.GetAssessmentItems(offset, limit, minChangeVersion, maxChangeVersion, totalCount, identificationCode, assessmentIdentifier, varNamespace, assessmentItemCategoryDescriptor, assessmentItemURI, expectedTimeAssessed, id, itemText, maxRawScore, nomenclature, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the GetAssessmentItemsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    Debug.Print("Exception when calling AssessmentItemsApi.GetAssessmentItemsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="getassessmentitemsbyid"></a>
# **GetAssessmentItemsById**
> EdFiAssessmentItem GetAssessmentItemsById (string id, string ifNoneMatch = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetAssessmentItemsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiAssessmentItem result = apiInstance.GetAssessmentItemsById(id, ifNoneMatch, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the GetAssessmentItemsByIdWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiAssessmentItem> response = apiInstance.GetAssessmentItemsByIdWithHttpInfo(id, ifNoneMatch, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling AssessmentItemsApi.GetAssessmentItemsByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="keychangesassessmentitems"></a>
# **KeyChangesAssessmentItems**
> List&lt;TrackedChangesEdFiAssessmentItemKeyChange&gt; KeyChangesAssessmentItems (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class KeyChangesAssessmentItemsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiAssessmentItemKeyChange> result = apiInstance.KeyChangesAssessmentItems(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling AssessmentItemsApi.KeyChangesAssessmentItems: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the KeyChangesAssessmentItemsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiAssessmentItemKeyChange>> response = apiInstance.KeyChangesAssessmentItemsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling AssessmentItemsApi.KeyChangesAssessmentItemsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="postassessmentitem"></a>
# **PostAssessmentItem**
> void PostAssessmentItem (EdFiAssessmentItem edFiAssessmentItem)
...
namespace Example
{
    public class PostAssessmentItemExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new AssessmentItemsApi(config);
            var edFiAssessmentItem = new EdFiAssessmentItem(); // EdFiAssessmentItem | The JSON representation of the \"assessmentItem\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostAssessmentItem(edFiAssessmentItem);
            }
            catch (ApiException  e)
            {
...
#### Using the PostAssessmentItemWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostAssessmentItemWithHttpInfo(edFiAssessmentItem);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling AssessmentItemsApi.PostAssessmentItemWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="putassessmentitem"></a>
# **PutAssessmentItem**
> void PutAssessmentItem (string id, EdFiAssessmentItem edFiAssessmentItem, string ifMatch = null)
...
namespace Example
{
    public class PutAssessmentItemExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutAssessmentItem(id, edFiAssessmentItem, ifMatch);
            }
            catch (ApiException  e)
            {
...
#### Using the PutAssessmentItemWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutAssessmentItemWithHttpInfo(id, edFiAssessmentItem, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling AssessmentItemsApi.PutAssessmentItemWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
