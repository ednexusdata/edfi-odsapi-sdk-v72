# EdFi.OdsApi.Sdk.v72.Apis.All.ObjectiveAssessmentsApi
...
> List&lt;TrackedChangesEdFiObjectiveAssessmentDelete&gt; DeletesObjectiveAssessments (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class DeletesObjectiveAssessmentsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiObjectiveAssessmentDelete> result = apiInstance.DeletesObjectiveAssessments(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiObjectiveAssessmentDelete>> response = apiInstance.DeletesObjectiveAssessmentsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
namespace Example
{
    public class GetObjectiveAssessmentsExample
    {
        public static void Main()
        {
            ...
            var parentIdentificationCode = "parentIdentificationCode_example";  // string | A unique number or alphanumeric code assigned to an objective assessment by a school, school system, a state, or other agency or entity. (optional) 
            ...
            var description = "description_example";  // string | The description of the objective assessment (e.g., vocabulary, measurement, or geometry). (optional) 
            ...
            var nomenclature = "nomenclature_example";  // string | Reflects the specific nomenclature used for this level of objective assessment. (optional) 
...
> EdFiObjectiveAssessment GetObjectiveAssessmentsById (string id, string ifNoneMatch = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetObjectiveAssessmentsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiObjectiveAssessment result = apiInstance.GetObjectiveAssessmentsById(id, ifNoneMatch, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiObjectiveAssessment> response = apiInstance.GetObjectiveAssessmentsByIdWithHttpInfo(id, ifNoneMatch, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="keychangesobjectiveassessments"></a>
# **KeyChangesObjectiveAssessments**
> List&lt;TrackedChangesEdFiObjectiveAssessmentKeyChange&gt; KeyChangesObjectiveAssessments (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class KeyChangesObjectiveAssessmentsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiObjectiveAssessmentKeyChange> result = apiInstance.KeyChangesObjectiveAssessments(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling ObjectiveAssessmentsApi.KeyChangesObjectiveAssessments: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the KeyChangesObjectiveAssessmentsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiObjectiveAssessmentKeyChange>> response = apiInstance.KeyChangesObjectiveAssessmentsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling ObjectiveAssessmentsApi.KeyChangesObjectiveAssessmentsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> void PostObjectiveAssessment (EdFiObjectiveAssessment edFiObjectiveAssessment)
...
namespace Example
{
    public class PostObjectiveAssessmentExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new ObjectiveAssessmentsApi(config);
            var edFiObjectiveAssessment = new EdFiObjectiveAssessment(); // EdFiObjectiveAssessment | The JSON representation of the \"objectiveAssessment\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostObjectiveAssessment(edFiObjectiveAssessment);
            }
            catch (ApiException  e)
            {
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostObjectiveAssessmentWithHttpInfo(edFiObjectiveAssessment);
}
catch (ApiException e)
{
...
> void PutObjectiveAssessment (string id, EdFiObjectiveAssessment edFiObjectiveAssessment, string ifMatch = null)
...
namespace Example
{
    public class PutObjectiveAssessmentExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutObjectiveAssessment(id, edFiObjectiveAssessment, ifMatch);
            }
            catch (ApiException  e)
            {
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutObjectiveAssessmentWithHttpInfo(id, edFiObjectiveAssessment, ifMatch);
}
catch (ApiException e)
{
