# EdFi.OdsApi.Sdk.v72.Apis.All.LicenseTypeDescriptorsApi
...
<a id="deletelicensetypedescriptorbyid"></a>
...
<a id="deleteslicensetypedescriptors"></a>
# **DeletesLicenseTypeDescriptors**
> List&lt;TrackedChangesEdFiLicenseTypeDescriptorDelete&gt; DeletesLicenseTypeDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class DeletesLicenseTypeDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiLicenseTypeDescriptorDelete> result = apiInstance.DeletesLicenseTypeDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiLicenseTypeDescriptorDelete>> response = apiInstance.DeletesLicenseTypeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
<a id="getlicensetypedescriptors"></a>
# **GetLicenseTypeDescriptors**
> List&lt;EdFiLicenseTypeDescriptor&gt; GetLicenseTypeDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string codeValue = null, string id = null, string varNamespace = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetLicenseTypeDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiLicenseTypeDescriptor> result = apiInstance.GetLicenseTypeDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiLicenseTypeDescriptor>> response = apiInstance.GetLicenseTypeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="getlicensetypedescriptorsbyid"></a>
# **GetLicenseTypeDescriptorsById**
> EdFiLicenseTypeDescriptor GetLicenseTypeDescriptorsById (string id, string ifNoneMatch = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetLicenseTypeDescriptorsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiLicenseTypeDescriptor result = apiInstance.GetLicenseTypeDescriptorsById(id, ifNoneMatch, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiLicenseTypeDescriptor> response = apiInstance.GetLicenseTypeDescriptorsByIdWithHttpInfo(id, ifNoneMatch, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="keychangeslicensetypedescriptors"></a>
# **KeyChangesLicenseTypeDescriptors**
> List&lt;TrackedChangesEdFiLicenseTypeDescriptorKeyChange&gt; KeyChangesLicenseTypeDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class KeyChangesLicenseTypeDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiLicenseTypeDescriptorKeyChange> result = apiInstance.KeyChangesLicenseTypeDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiLicenseTypeDescriptorKeyChange>> response = apiInstance.KeyChangesLicenseTypeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="postlicensetypedescriptor"></a>
# **PostLicenseTypeDescriptor**
> void PostLicenseTypeDescriptor (EdFiLicenseTypeDescriptor edFiLicenseTypeDescriptor)
...
namespace Example
{
    public class PostLicenseTypeDescriptorExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new LicenseTypeDescriptorsApi(config);
            var edFiLicenseTypeDescriptor = new EdFiLicenseTypeDescriptor(); // EdFiLicenseTypeDescriptor | The JSON representation of the \"licenseTypeDescriptor\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostLicenseTypeDescriptor(edFiLicenseTypeDescriptor);
            }
            catch (ApiException  e)
            {
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostLicenseTypeDescriptorWithHttpInfo(edFiLicenseTypeDescriptor);
}
catch (ApiException e)
{
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **edFiLicenseTypeDescriptor** | [**EdFiLicenseTypeDescriptor**](EdFiLicenseTypeDescriptor.md) | The JSON representation of the \&quot;licenseTypeDescriptor\&quot; resource to be created or updated. |  |
...
<a id="putlicensetypedescriptor"></a>
# **PutLicenseTypeDescriptor**
> void PutLicenseTypeDescriptor (string id, EdFiLicenseTypeDescriptor edFiLicenseTypeDescriptor, string ifMatch = null)
...
namespace Example
{
    public class PutLicenseTypeDescriptorExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutLicenseTypeDescriptor(id, edFiLicenseTypeDescriptor, ifMatch);
            }
            catch (ApiException  e)
            {
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutLicenseTypeDescriptorWithHttpInfo(id, edFiLicenseTypeDescriptor, ifMatch);
}
catch (ApiException e)
{
