# EdFi.OdsApi.Sdk.v72.Apis.All.CredentialsApi
...
namespace Example
{
    public class DeleteCredentialByIdExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new CredentialsApi(config);
...
#### Using the DeleteCredentialByIdWithHttpInfo variant
...
{
    // Deletes an existing resource using the resource identifier.
    apiInstance.DeleteCredentialByIdWithHttpInfo(id, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling CredentialsApi.DeleteCredentialByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="deletescredentials"></a>
# **DeletesCredentials**
> List&lt;TrackedChangesEdFiCredentialDelete&gt; DeletesCredentials (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class DeletesCredentialsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiCredentialDelete> result = apiInstance.DeletesCredentials(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
#### Using the DeletesCredentialsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiCredentialDelete>> response = apiInstance.DeletesCredentialsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
{
    Debug.Print("Exception when calling CredentialsApi.DeletesCredentialsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class GetCredentialsExample
    {
        public static void Main()
        {
            ...
            var effectiveDate = DateOnly.Parse("2013-10-20");  // DateOnly | The year, month and day on which an active credential held by an individual was issued. (optional) 
            var expirationDate = DateOnly.Parse("2013-10-20");  // DateOnly | The month, day, and year on which an active credential held by an individual will expire. (optional) 
            var id = "id_example";  // string |  (optional) 
            var issuanceDate = DateOnly.Parse("2013-10-20");  // DateOnly | The month, day, and year on which an active credential was issued to an individual. (optional) 
            var varNamespace = "varNamespace_example";  // string | Namespace for the credential. (optional) 
            var useSnapshot = false;  // bool | Indicates if the configured Snapshot should be used. (optional)  (default to false)
...
#### Using the GetCredentialsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiCredential>> response = apiInstance.GetCredentialsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, stateOfIssueStateAbbreviationDescriptor, credentialIdentifier, credentialFieldDescriptor, credentialTypeDescriptor, teachingCredentialBasisDescriptor, teachingCredentialDescriptor, effectiveDate, expirationDate, id, issuanceDate, varNamespace, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CredentialsApi.GetCredentialsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
| **id** | **string** |  | [optional]  |
| **issuanceDate** | **DateOnly** | The month, day, and year on which an active credential was issued to an individual. | [optional]  |
| **varNamespace** | **string** | Namespace for the credential. | [optional]  |
| **useSnapshot** | **bool** | Indicates if the configured Snapshot should be used. | [optional] [default to false] |
...
<a id="getcredentialsbyid"></a>
# **GetCredentialsById**
> EdFiCredential GetCredentialsById (string id, string ifNoneMatch = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetCredentialsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiCredential result = apiInstance.GetCredentialsById(id, ifNoneMatch, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the GetCredentialsByIdWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiCredential> response = apiInstance.GetCredentialsByIdWithHttpInfo(id, ifNoneMatch, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CredentialsApi.GetCredentialsByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="keychangescredentials"></a>
# **KeyChangesCredentials**
> List&lt;TrackedChangesEdFiCredentialKeyChange&gt; KeyChangesCredentials (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class KeyChangesCredentialsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiCredentialKeyChange> result = apiInstance.KeyChangesCredentials(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling CredentialsApi.KeyChangesCredentials: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the KeyChangesCredentialsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiCredentialKeyChange>> response = apiInstance.KeyChangesCredentialsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CredentialsApi.KeyChangesCredentialsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="postcredential"></a>
# **PostCredential**
> void PostCredential (EdFiCredential edFiCredential)
...
namespace Example
{
    public class PostCredentialExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new CredentialsApi(config);
            var edFiCredential = new EdFiCredential(); // EdFiCredential | The JSON representation of the \"credential\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostCredential(edFiCredential);
            }
            catch (ApiException  e)
            {
...
#### Using the PostCredentialWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostCredentialWithHttpInfo(edFiCredential);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling CredentialsApi.PostCredentialWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="putcredential"></a>
# **PutCredential**
> void PutCredential (string id, EdFiCredential edFiCredential, string ifMatch = null)
...
namespace Example
{
    public class PutCredentialExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutCredential(id, edFiCredential, ifMatch);
            }
            catch (ApiException  e)
            {
...
#### Using the PutCredentialWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutCredentialWithHttpInfo(id, edFiCredential, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling CredentialsApi.PutCredentialWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
