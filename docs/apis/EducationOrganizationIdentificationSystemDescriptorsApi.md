# EdFi.OdsApi.Sdk.v72.Apis.All.EducationOrganizationIdentificationSystemDescriptorsApi
...
<a id="deleteeducationorganizationidentificationsystemdescriptorbyid"></a>
...
<a id="deleteseducationorganizationidentificationsystemdescriptors"></a>
# **DeletesEducationOrganizationIdentificationSystemDescriptors**
> List&lt;TrackedChangesEdFiEducationOrganizationIdentificationSystemDescriptorDelete&gt; DeletesEducationOrganizationIdentificationSystemDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class DeletesEducationOrganizationIdentificationSystemDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiEducationOrganizationIdentificationSystemDescriptorDelete> result = apiInstance.DeletesEducationOrganizationIdentificationSystemDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiEducationOrganizationIdentificationSystemDescriptorDelete>> response = apiInstance.DeletesEducationOrganizationIdentificationSystemDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
<a id="geteducationorganizationidentificationsystemdescriptors"></a>
# **GetEducationOrganizationIdentificationSystemDescriptors**
...
namespace Example
{
    public class GetEducationOrganizationIdentificationSystemDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiEducationOrganizationIdentificationSystemDescriptor> result = apiInstance.GetEducationOrganizationIdentificationSystemDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiEducationOrganizationIdentificationSystemDescriptor>> response = apiInstance.GetEducationOrganizationIdentificationSystemDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="geteducationorganizationidentificationsystemdescriptorsbyid"></a>
# **GetEducationOrganizationIdentificationSystemDescriptorsById**
> EdFiEducationOrganizationIdentificationSystemDescriptor GetEducationOrganizationIdentificationSystemDescriptorsById (string id, string ifNoneMatch = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetEducationOrganizationIdentificationSystemDescriptorsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiEducationOrganizationIdentificationSystemDescriptor result = apiInstance.GetEducationOrganizationIdentificationSystemDescriptorsById(id, ifNoneMatch, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiEducationOrganizationIdentificationSystemDescriptor> response = apiInstance.GetEducationOrganizationIdentificationSystemDescriptorsByIdWithHttpInfo(id, ifNoneMatch, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="keychangeseducationorganizationidentificationsystemdescriptors"></a>
# **KeyChangesEducationOrganizationIdentificationSystemDescriptors**
> List&lt;TrackedChangesEdFiEducationOrganizationIdentificationSystemDescriptorKeyChange&gt; KeyChangesEducationOrganizationIdentificationSystemDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class KeyChangesEducationOrganizationIdentificationSystemDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiEducationOrganizationIdentificationSystemDescriptorKeyChange> result = apiInstance.KeyChangesEducationOrganizationIdentificationSystemDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiEducationOrganizationIdentificationSystemDescriptorKeyChange>> response = apiInstance.KeyChangesEducationOrganizationIdentificationSystemDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="posteducationorganizationidentificationsystemdescriptor"></a>
# **PostEducationOrganizationIdentificationSystemDescriptor**
> void PostEducationOrganizationIdentificationSystemDescriptor (EdFiEducationOrganizationIdentificationSystemDescriptor edFiEducationOrganizationIdentificationSystemDescriptor)
...
namespace Example
{
    public class PostEducationOrganizationIdentificationSystemDescriptorExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new EducationOrganizationIdentificationSystemDescriptorsApi(config);
            var edFiEducationOrganizationIdentificationSystemDescriptor = new EdFiEducationOrganizationIdentificationSystemDescriptor(); // EdFiEducationOrganizationIdentificationSystemDescriptor | The JSON representation of the \"educationOrganizationIdentificationSystemDescriptor\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostEducationOrganizationIdentificationSystemDescriptor(edFiEducationOrganizationIdentificationSystemDescriptor);
            }
            catch (ApiException  e)
            {
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostEducationOrganizationIdentificationSystemDescriptorWithHttpInfo(edFiEducationOrganizationIdentificationSystemDescriptor);
}
catch (ApiException e)
{
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **edFiEducationOrganizationIdentificationSystemDescriptor** | [**EdFiEducationOrganizationIdentificationSystemDescriptor**](EdFiEducationOrganizationIdentificationSystemDescriptor.md) | The JSON representation of the \&quot;educationOrganizationIdentificationSystemDescriptor\&quot; resource to be created or updated. |  |
...
<a id="puteducationorganizationidentificationsystemdescriptor"></a>
# **PutEducationOrganizationIdentificationSystemDescriptor**
> void PutEducationOrganizationIdentificationSystemDescriptor (string id, EdFiEducationOrganizationIdentificationSystemDescriptor edFiEducationOrganizationIdentificationSystemDescriptor, string ifMatch = null)
...
namespace Example
{
    public class PutEducationOrganizationIdentificationSystemDescriptorExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutEducationOrganizationIdentificationSystemDescriptor(id, edFiEducationOrganizationIdentificationSystemDescriptor, ifMatch);
            }
            catch (ApiException  e)
            {
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutEducationOrganizationIdentificationSystemDescriptorWithHttpInfo(id, edFiEducationOrganizationIdentificationSystemDescriptor, ifMatch);
}
catch (ApiException e)
{
