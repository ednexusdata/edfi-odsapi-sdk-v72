# EdFi.OdsApi.Sdk.v72.Apis.All.AssessmentsApi
...
namespace Example
{
    public class DeleteAssessmentByIdExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new AssessmentsApi(config);
...
#### Using the DeleteAssessmentByIdWithHttpInfo variant
...
{
    // Deletes an existing resource using the resource identifier.
    apiInstance.DeleteAssessmentByIdWithHttpInfo(id, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling AssessmentsApi.DeleteAssessmentByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="deletesassessments"></a>
# **DeletesAssessments**
> List&lt;TrackedChangesEdFiAssessmentDelete&gt; DeletesAssessments (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class DeletesAssessmentsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiAssessmentDelete> result = apiInstance.DeletesAssessments(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
#### Using the DeletesAssessmentsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiAssessmentDelete>> response = apiInstance.DeletesAssessmentsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
{
    Debug.Print("Exception when calling AssessmentsApi.DeletesAssessmentsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="getassessments"></a>
# **GetAssessments**
> List&lt;EdFiAssessment&gt; GetAssessments (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string assessmentIdentifier = null, string varNamespace = null, long educationOrganizationId = null, string assessmentCategoryDescriptor = null, bool adaptiveAssessment = null, string assessmentFamily = null, string assessmentForm = null, string assessmentTitle = null, int assessmentVersion = null, string id = null, double maxRawScore = null, string nomenclature = null, DateOnly revisionDate = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetAssessmentsExample
    {
        public static void Main()
        {
            ...
            var assessmentCategoryDescriptor = "assessmentCategoryDescriptor_example";  // string | The category of an assessment based on format and content. (optional) 
            var adaptiveAssessment = true;  // bool | Indicates that the assessment is adaptive. (optional) 
            var assessmentFamily = "assessmentFamily_example";  // string | The assessment family this assessment is a member of. (optional) 
            ...
            var revisionDate = DateOnly.Parse("2013-10-20");  // DateOnly | The month, day, and year that the conceptual design for the assessment was most recently revised substantially. (optional) 
            var useSnapshot = false;  // bool | Indicates if the configured Snapshot should be used. (optional)  (default to false)

            try
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiAssessment> result = apiInstance.GetAssessments(offset, limit, minChangeVersion, maxChangeVersion, totalCount, assessmentIdentifier, varNamespace, educationOrganizationId, assessmentCategoryDescriptor, adaptiveAssessment, assessmentFamily, assessmentForm, assessmentTitle, assessmentVersion, id, maxRawScore, nomenclature, revisionDate, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the GetAssessmentsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    Debug.Print("Exception when calling AssessmentsApi.GetAssessmentsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="getassessmentsbyid"></a>
# **GetAssessmentsById**
> EdFiAssessment GetAssessmentsById (string id, string ifNoneMatch = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetAssessmentsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiAssessment result = apiInstance.GetAssessmentsById(id, ifNoneMatch, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the GetAssessmentsByIdWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiAssessment> response = apiInstance.GetAssessmentsByIdWithHttpInfo(id, ifNoneMatch, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling AssessmentsApi.GetAssessmentsByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="keychangesassessments"></a>
# **KeyChangesAssessments**
> List&lt;TrackedChangesEdFiAssessmentKeyChange&gt; KeyChangesAssessments (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class KeyChangesAssessmentsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiAssessmentKeyChange> result = apiInstance.KeyChangesAssessments(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling AssessmentsApi.KeyChangesAssessments: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the KeyChangesAssessmentsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiAssessmentKeyChange>> response = apiInstance.KeyChangesAssessmentsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling AssessmentsApi.KeyChangesAssessmentsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="postassessment"></a>
# **PostAssessment**
> void PostAssessment (EdFiAssessment edFiAssessment)
...
namespace Example
{
    public class PostAssessmentExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new AssessmentsApi(config);
            var edFiAssessment = new EdFiAssessment(); // EdFiAssessment | The JSON representation of the \"assessment\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostAssessment(edFiAssessment);
            }
            catch (ApiException  e)
            {
...
#### Using the PostAssessmentWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostAssessmentWithHttpInfo(edFiAssessment);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling AssessmentsApi.PostAssessmentWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="putassessment"></a>
# **PutAssessment**
> void PutAssessment (string id, EdFiAssessment edFiAssessment, string ifMatch = null)
...
namespace Example
{
    public class PutAssessmentExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutAssessment(id, edFiAssessment, ifMatch);
            }
            catch (ApiException  e)
            {
...
#### Using the PutAssessmentWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutAssessmentWithHttpInfo(id, edFiAssessment, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling AssessmentsApi.PutAssessmentWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
