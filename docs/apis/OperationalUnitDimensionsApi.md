# EdFi.OdsApi.Sdk.v72.Apis.All.OperationalUnitDimensionsApi
...
> List&lt;EdFiOperationalUnitDimension&gt; GetOperationalUnitDimensions (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string code = null, int fiscalYear = null, string codeName = null, string id = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetOperationalUnitDimensionsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiOperationalUnitDimension> result = apiInstance.GetOperationalUnitDimensions(offset, limit, minChangeVersion, maxChangeVersion, totalCount, code, fiscalYear, codeName, id, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiOperationalUnitDimension>> response = apiInstance.GetOperationalUnitDimensionsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, code, fiscalYear, codeName, id, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
