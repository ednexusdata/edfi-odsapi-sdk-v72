# EdFi.OdsApi.Sdk.v72.Apis.All.CurriculumUsedDescriptorsApi
...
<a id="deletecurriculumuseddescriptorbyid"></a>
...
<a id="deletescurriculumuseddescriptors"></a>
# **DeletesCurriculumUsedDescriptors**
> List&lt;TrackedChangesEdFiCurriculumUsedDescriptorDelete&gt; DeletesCurriculumUsedDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class DeletesCurriculumUsedDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiCurriculumUsedDescriptorDelete> result = apiInstance.DeletesCurriculumUsedDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiCurriculumUsedDescriptorDelete>> response = apiInstance.DeletesCurriculumUsedDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
<a id="getcurriculumuseddescriptors"></a>
# **GetCurriculumUsedDescriptors**
> List&lt;EdFiCurriculumUsedDescriptor&gt; GetCurriculumUsedDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string codeValue = null, string id = null, string varNamespace = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetCurriculumUsedDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiCurriculumUsedDescriptor> result = apiInstance.GetCurriculumUsedDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiCurriculumUsedDescriptor>> response = apiInstance.GetCurriculumUsedDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, codeValue, id, varNamespace, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="getcurriculumuseddescriptorsbyid"></a>
# **GetCurriculumUsedDescriptorsById**
> EdFiCurriculumUsedDescriptor GetCurriculumUsedDescriptorsById (string id, string ifNoneMatch = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetCurriculumUsedDescriptorsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiCurriculumUsedDescriptor result = apiInstance.GetCurriculumUsedDescriptorsById(id, ifNoneMatch, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiCurriculumUsedDescriptor> response = apiInstance.GetCurriculumUsedDescriptorsByIdWithHttpInfo(id, ifNoneMatch, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="keychangescurriculumuseddescriptors"></a>
# **KeyChangesCurriculumUsedDescriptors**
> List&lt;TrackedChangesEdFiCurriculumUsedDescriptorKeyChange&gt; KeyChangesCurriculumUsedDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class KeyChangesCurriculumUsedDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiCurriculumUsedDescriptorKeyChange> result = apiInstance.KeyChangesCurriculumUsedDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiCurriculumUsedDescriptorKeyChange>> response = apiInstance.KeyChangesCurriculumUsedDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="postcurriculumuseddescriptor"></a>
# **PostCurriculumUsedDescriptor**
> void PostCurriculumUsedDescriptor (EdFiCurriculumUsedDescriptor edFiCurriculumUsedDescriptor)
...
namespace Example
{
    public class PostCurriculumUsedDescriptorExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new CurriculumUsedDescriptorsApi(config);
            var edFiCurriculumUsedDescriptor = new EdFiCurriculumUsedDescriptor(); // EdFiCurriculumUsedDescriptor | The JSON representation of the \"curriculumUsedDescriptor\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostCurriculumUsedDescriptor(edFiCurriculumUsedDescriptor);
            }
            catch (ApiException  e)
            {
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostCurriculumUsedDescriptorWithHttpInfo(edFiCurriculumUsedDescriptor);
}
catch (ApiException e)
{
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **edFiCurriculumUsedDescriptor** | [**EdFiCurriculumUsedDescriptor**](EdFiCurriculumUsedDescriptor.md) | The JSON representation of the \&quot;curriculumUsedDescriptor\&quot; resource to be created or updated. |  |
...
<a id="putcurriculumuseddescriptor"></a>
# **PutCurriculumUsedDescriptor**
> void PutCurriculumUsedDescriptor (string id, EdFiCurriculumUsedDescriptor edFiCurriculumUsedDescriptor, string ifMatch = null)
...
namespace Example
{
    public class PutCurriculumUsedDescriptorExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutCurriculumUsedDescriptor(id, edFiCurriculumUsedDescriptor, ifMatch);
            }
            catch (ApiException  e)
            {
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutCurriculumUsedDescriptorWithHttpInfo(id, edFiCurriculumUsedDescriptor, ifMatch);
}
catch (ApiException e)
{
