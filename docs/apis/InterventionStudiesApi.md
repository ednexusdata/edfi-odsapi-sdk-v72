# EdFi.OdsApi.Sdk.v72.Apis.All.InterventionStudiesApi
...
<a id="deleteinterventionstudybyid"></a>
...
namespace Example
{
    public class DeleteInterventionStudyByIdExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new InterventionStudiesApi(config);
...
#### Using the DeleteInterventionStudyByIdWithHttpInfo variant
...
{
    // Deletes an existing resource using the resource identifier.
    apiInstance.DeleteInterventionStudyByIdWithHttpInfo(id, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling InterventionStudiesApi.DeleteInterventionStudyByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="deletesinterventionstudies"></a>
# **DeletesInterventionStudies**
> List&lt;TrackedChangesEdFiInterventionStudyDelete&gt; DeletesInterventionStudies (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class DeletesInterventionStudiesExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiInterventionStudyDelete> result = apiInstance.DeletesInterventionStudies(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
#### Using the DeletesInterventionStudiesWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiInterventionStudyDelete>> response = apiInstance.DeletesInterventionStudiesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
{
    Debug.Print("Exception when calling InterventionStudiesApi.DeletesInterventionStudiesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="getinterventionstudies"></a>
# **GetInterventionStudies**
> List&lt;EdFiInterventionStudy&gt; GetInterventionStudies (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string interventionStudyIdentificationCode = null, long educationOrganizationId = null, long interventionPrescriptionEducationOrganizationId = null, string interventionPrescriptionIdentificationCode = null, string deliveryMethodDescriptor = null, string interventionClassDescriptor = null, string id = null, int participants = null, bool useSnapshot = null)
...
#### Using the GetInterventionStudiesWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiInterventionStudy>> response = apiInstance.GetInterventionStudiesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, interventionStudyIdentificationCode, educationOrganizationId, interventionPrescriptionEducationOrganizationId, interventionPrescriptionIdentificationCode, deliveryMethodDescriptor, interventionClassDescriptor, id, participants, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling InterventionStudiesApi.GetInterventionStudiesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="getinterventionstudiesbyid"></a>
# **GetInterventionStudiesById**
> EdFiInterventionStudy GetInterventionStudiesById (string id, string ifNoneMatch = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetInterventionStudiesByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiInterventionStudy result = apiInstance.GetInterventionStudiesById(id, ifNoneMatch, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the GetInterventionStudiesByIdWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiInterventionStudy> response = apiInstance.GetInterventionStudiesByIdWithHttpInfo(id, ifNoneMatch, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling InterventionStudiesApi.GetInterventionStudiesByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="keychangesinterventionstudies"></a>
# **KeyChangesInterventionStudies**
> List&lt;TrackedChangesEdFiInterventionStudyKeyChange&gt; KeyChangesInterventionStudies (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class KeyChangesInterventionStudiesExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiInterventionStudyKeyChange> result = apiInstance.KeyChangesInterventionStudies(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling InterventionStudiesApi.KeyChangesInterventionStudies: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the KeyChangesInterventionStudiesWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiInterventionStudyKeyChange>> response = apiInstance.KeyChangesInterventionStudiesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling InterventionStudiesApi.KeyChangesInterventionStudiesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="postinterventionstudy"></a>
# **PostInterventionStudy**
> void PostInterventionStudy (EdFiInterventionStudy edFiInterventionStudy)
...
namespace Example
{
    public class PostInterventionStudyExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new InterventionStudiesApi(config);
            var edFiInterventionStudy = new EdFiInterventionStudy(); // EdFiInterventionStudy | The JSON representation of the \"interventionStudy\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostInterventionStudy(edFiInterventionStudy);
            }
            catch (ApiException  e)
            {
...
#### Using the PostInterventionStudyWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostInterventionStudyWithHttpInfo(edFiInterventionStudy);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling InterventionStudiesApi.PostInterventionStudyWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="putinterventionstudy"></a>
# **PutInterventionStudy**
> void PutInterventionStudy (string id, EdFiInterventionStudy edFiInterventionStudy, string ifMatch = null)
...
namespace Example
{
    public class PutInterventionStudyExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutInterventionStudy(id, edFiInterventionStudy, ifMatch);
            }
            catch (ApiException  e)
            {
...
#### Using the PutInterventionStudyWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutInterventionStudyWithHttpInfo(id, edFiInterventionStudy, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling InterventionStudiesApi.PutInterventionStudyWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
