# EdFi.OdsApi.Sdk.v72.Apis.All.PostSecondaryEventsApi
...
> List&lt;TrackedChangesEdFiPostSecondaryEventDelete&gt; DeletesPostSecondaryEvents (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class DeletesPostSecondaryEventsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiPostSecondaryEventDelete> result = apiInstance.DeletesPostSecondaryEvents(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiPostSecondaryEventDelete>> response = apiInstance.DeletesPostSecondaryEventsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
> List&lt;EdFiPostSecondaryEvent&gt; GetPostSecondaryEvents (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string postSecondaryEventCategoryDescriptor = null, DateOnly eventDate = null, string studentUniqueId = null, long postSecondaryInstitutionId = null, string id = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetPostSecondaryEventsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiPostSecondaryEvent> result = apiInstance.GetPostSecondaryEvents(offset, limit, minChangeVersion, maxChangeVersion, totalCount, postSecondaryEventCategoryDescriptor, eventDate, studentUniqueId, postSecondaryInstitutionId, id, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiPostSecondaryEvent>> response = apiInstance.GetPostSecondaryEventsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, postSecondaryEventCategoryDescriptor, eventDate, studentUniqueId, postSecondaryInstitutionId, id, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> EdFiPostSecondaryEvent GetPostSecondaryEventsById (string id, string ifNoneMatch = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetPostSecondaryEventsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiPostSecondaryEvent result = apiInstance.GetPostSecondaryEventsById(id, ifNoneMatch, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiPostSecondaryEvent> response = apiInstance.GetPostSecondaryEventsByIdWithHttpInfo(id, ifNoneMatch, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiPostSecondaryEventKeyChange&gt; KeyChangesPostSecondaryEvents (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class KeyChangesPostSecondaryEventsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiPostSecondaryEventKeyChange> result = apiInstance.KeyChangesPostSecondaryEvents(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiPostSecondaryEventKeyChange>> response = apiInstance.KeyChangesPostSecondaryEventsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> void PostPostSecondaryEvent (EdFiPostSecondaryEvent edFiPostSecondaryEvent)
...
namespace Example
{
    public class PostPostSecondaryEventExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new PostSecondaryEventsApi(config);
            var edFiPostSecondaryEvent = new EdFiPostSecondaryEvent(); // EdFiPostSecondaryEvent | The JSON representation of the \"postSecondaryEvent\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostPostSecondaryEvent(edFiPostSecondaryEvent);
            }
            catch (ApiException  e)
            {
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostPostSecondaryEventWithHttpInfo(edFiPostSecondaryEvent);
}
catch (ApiException e)
{
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **edFiPostSecondaryEvent** | [**EdFiPostSecondaryEvent**](EdFiPostSecondaryEvent.md) | The JSON representation of the \&quot;postSecondaryEvent\&quot; resource to be created or updated. |  |
...
> void PutPostSecondaryEvent (string id, EdFiPostSecondaryEvent edFiPostSecondaryEvent, string ifMatch = null)
...
namespace Example
{
    public class PutPostSecondaryEventExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutPostSecondaryEvent(id, edFiPostSecondaryEvent, ifMatch);
            }
            catch (ApiException  e)
            {
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutPostSecondaryEventWithHttpInfo(id, edFiPostSecondaryEvent, ifMatch);
}
catch (ApiException e)
{
