# EdFi.OdsApi.Sdk.v72.Apis.All.BellSchedulesApi
...
namespace Example
{
    public class DeleteBellScheduleByIdExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new BellSchedulesApi(config);
...
#### Using the DeleteBellScheduleByIdWithHttpInfo variant
...
{
    // Deletes an existing resource using the resource identifier.
    apiInstance.DeleteBellScheduleByIdWithHttpInfo(id, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling BellSchedulesApi.DeleteBellScheduleByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="deletesbellschedules"></a>
# **DeletesBellSchedules**
> List&lt;TrackedChangesEdFiBellScheduleDelete&gt; DeletesBellSchedules (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class DeletesBellSchedulesExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiBellScheduleDelete> result = apiInstance.DeletesBellSchedules(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
#### Using the DeletesBellSchedulesWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiBellScheduleDelete>> response = apiInstance.DeletesBellSchedulesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
{
    Debug.Print("Exception when calling BellSchedulesApi.DeletesBellSchedulesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class GetBellSchedulesExample
    {
        public static void Main()
        {
            ...
            var maxChangeVersion = 789L;  // long | Used in synchronization to set sequence maximum ChangeVersion (optional) 
            var totalCount = false;  // bool | Indicates if the total number of items available should be returned in the 'Total-Count' header of the response.  If set to false, 'Total-Count' header will not be provided. (optional)  (default to false)
            var bellScheduleName = "bellScheduleName_example";  // string | Name or title of the bell schedule. (optional) 
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiBellSchedule> result = apiInstance.GetBellSchedules(offset, limit, minChangeVersion, maxChangeVersion, totalCount, bellScheduleName, schoolId, alternateDayName, endTime, id, startTime, totalInstructionalTime, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the GetBellSchedulesWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiBellSchedule>> response = apiInstance.GetBellSchedulesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, bellScheduleName, schoolId, alternateDayName, endTime, id, startTime, totalInstructionalTime, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling BellSchedulesApi.GetBellSchedulesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="getbellschedulesbyid"></a>
# **GetBellSchedulesById**
> EdFiBellSchedule GetBellSchedulesById (string id, string ifNoneMatch = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetBellSchedulesByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiBellSchedule result = apiInstance.GetBellSchedulesById(id, ifNoneMatch, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the GetBellSchedulesByIdWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiBellSchedule> response = apiInstance.GetBellSchedulesByIdWithHttpInfo(id, ifNoneMatch, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling BellSchedulesApi.GetBellSchedulesByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="keychangesbellschedules"></a>
# **KeyChangesBellSchedules**
> List&lt;TrackedChangesEdFiBellScheduleKeyChange&gt; KeyChangesBellSchedules (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, bool useSnapshot = null)
...
namespace Example
{
    public class KeyChangesBellSchedulesExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiBellScheduleKeyChange> result = apiInstance.KeyChangesBellSchedules(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling BellSchedulesApi.KeyChangesBellSchedules: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the KeyChangesBellSchedulesWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiBellScheduleKeyChange>> response = apiInstance.KeyChangesBellSchedulesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling BellSchedulesApi.KeyChangesBellSchedulesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="postbellschedule"></a>
# **PostBellSchedule**
> void PostBellSchedule (EdFiBellSchedule edFiBellSchedule)
...
namespace Example
{
    public class PostBellScheduleExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new BellSchedulesApi(config);
            var edFiBellSchedule = new EdFiBellSchedule(); // EdFiBellSchedule | The JSON representation of the \"bellSchedule\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostBellSchedule(edFiBellSchedule);
            }
            catch (ApiException  e)
            {
...
#### Using the PostBellScheduleWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostBellScheduleWithHttpInfo(edFiBellSchedule);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling BellSchedulesApi.PostBellScheduleWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="putbellschedule"></a>
# **PutBellSchedule**
> void PutBellSchedule (string id, EdFiBellSchedule edFiBellSchedule, string ifMatch = null)
...
namespace Example
{
    public class PutBellScheduleExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutBellSchedule(id, edFiBellSchedule, ifMatch);
            }
            catch (ApiException  e)
            {
...
#### Using the PutBellScheduleWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutBellScheduleWithHttpInfo(id, edFiBellSchedule, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling BellSchedulesApi.PutBellScheduleWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
