# EdFi.OdsApi.Sdk.v72.Apis.All.ClassPeriodsApi
...
<a id="deletesclassperiods"></a>
# **DeletesClassPeriods**
> List&lt;TrackedChangesEdFiClassPeriodDelete&gt; DeletesClassPeriods (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, bool? useSnapshot = null)
...
namespace Example
{
    public class DeletesClassPeriodsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiClassPeriodDelete> result = apiInstance.DeletesClassPeriods(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiClassPeriodDelete>> response = apiInstance.DeletesClassPeriodsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
<a id="getclassperiods"></a>
# **GetClassPeriods**
> List&lt;EdFiClassPeriod&gt; GetClassPeriods (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? classPeriodName = null, long? schoolId = null, string? id = null, bool? officialAttendancePeriod = null, bool? useSnapshot = null)
...
namespace Example
{
    public class GetClassPeriodsExample
    {
        public static void Main()
        {
            ...
            var officialAttendancePeriod = true;  // bool? | Indicator of whether this class period is used for official daily attendance. Alternatively, official daily attendance may be tied to a section. (optional) 
            var useSnapshot = false;  // bool? | Indicates if the configured Snapshot should be used. (optional)  (default to false)

            try
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiClassPeriod> result = apiInstance.GetClassPeriods(offset, limit, minChangeVersion, maxChangeVersion, totalCount, classPeriodName, schoolId, id, officialAttendancePeriod, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiClassPeriod>> response = apiInstance.GetClassPeriodsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, classPeriodName, schoolId, id, officialAttendancePeriod, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="getclassperiodsbyid"></a>
# **GetClassPeriodsById**
> EdFiClassPeriod GetClassPeriodsById (string id, string? ifNoneMatch = null, bool? useSnapshot = null)
...
namespace Example
{
    public class GetClassPeriodsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiClassPeriod result = apiInstance.GetClassPeriodsById(id, ifNoneMatch, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiClassPeriod> response = apiInstance.GetClassPeriodsByIdWithHttpInfo(id, ifNoneMatch, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="keychangesclassperiods"></a>
# **KeyChangesClassPeriods**
> List&lt;TrackedChangesEdFiClassPeriodKeyChange&gt; KeyChangesClassPeriods (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, bool? useSnapshot = null)
...
namespace Example
{
    public class KeyChangesClassPeriodsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiClassPeriodKeyChange> result = apiInstance.KeyChangesClassPeriods(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiClassPeriodKeyChange>> response = apiInstance.KeyChangesClassPeriodsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="postclassperiod"></a>
# **PostClassPeriod**
> void PostClassPeriod (EdFiClassPeriod edFiClassPeriod)
...
namespace Example
{
    public class PostClassPeriodExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new ClassPeriodsApi(config);
            var edFiClassPeriod = new EdFiClassPeriod(); // EdFiClassPeriod | The JSON representation of the \"classPeriod\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostClassPeriod(edFiClassPeriod);
            }
            catch (ApiException  e)
            {
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostClassPeriodWithHttpInfo(edFiClassPeriod);
}
catch (ApiException e)
{
...
<a id="putclassperiod"></a>
# **PutClassPeriod**
> void PutClassPeriod (string id, EdFiClassPeriod edFiClassPeriod, string? ifMatch = null)
...
namespace Example
{
    public class PutClassPeriodExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutClassPeriod(id, edFiClassPeriod, ifMatch);
            }
            catch (ApiException  e)
            {
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutClassPeriodWithHttpInfo(id, edFiClassPeriod, ifMatch);
}
catch (ApiException e)
{
