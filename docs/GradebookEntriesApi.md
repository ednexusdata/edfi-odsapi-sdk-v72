# EdFi.OdsApi.Sdk.v72.Apis.All.GradebookEntriesApi
...
> List&lt;TrackedChangesEdFiGradebookEntryDelete&gt; DeletesGradebookEntries (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, bool? useSnapshot = null)
...
namespace Example
{
    public class DeletesGradebookEntriesExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiGradebookEntryDelete> result = apiInstance.DeletesGradebookEntries(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiGradebookEntryDelete>> response = apiInstance.DeletesGradebookEntriesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
namespace Example
{
    public class GetGradebookEntriesExample
    {
        public static void Main()
        {
            ...
            var gradebookEntryTypeDescriptor = "gradebookEntryTypeDescriptor_example";  // string? | The type of the gradebook entry. (optional) 
            ...
            var dueTime = "dueTime_example";  // string? | The time the assignment, homework, or assessment is due. (optional) 
            var id = "id_example";  // string? |  (optional) 
            var maxPoints = 1.2D;  // double? | The maximum number of points  that can be earned for the submission. (optional) 
            var sourceSectionIdentifier = "sourceSectionIdentifier_example";  // string? | The local identifier assigned to a section. (optional) 
            var title = "title_example";  // string? | The name or title of the activity to be recorded in the gradebook entry. (optional) 
            var useSnapshot = false;  // bool? | Indicates if the configured Snapshot should be used. (optional)  (default to false)
...
> EdFiGradebookEntry GetGradebookEntriesById (string id, string? ifNoneMatch = null, bool? useSnapshot = null)
...
namespace Example
{
    public class GetGradebookEntriesByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiGradebookEntry result = apiInstance.GetGradebookEntriesById(id, ifNoneMatch, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiGradebookEntry> response = apiInstance.GetGradebookEntriesByIdWithHttpInfo(id, ifNoneMatch, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="keychangesgradebookentries"></a>
# **KeyChangesGradebookEntries**
> List&lt;TrackedChangesEdFiGradebookEntryKeyChange&gt; KeyChangesGradebookEntries (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, bool? useSnapshot = null)
...
namespace Example
{
    public class KeyChangesGradebookEntriesExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiGradebookEntryKeyChange> result = apiInstance.KeyChangesGradebookEntries(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling GradebookEntriesApi.KeyChangesGradebookEntries: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the KeyChangesGradebookEntriesWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiGradebookEntryKeyChange>> response = apiInstance.KeyChangesGradebookEntriesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling GradebookEntriesApi.KeyChangesGradebookEntriesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
# **PostGradebookEntry**
> void PostGradebookEntry (EdFiGradebookEntry edFiGradebookEntry)
...
namespace Example
{
    public class PostGradebookEntryExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new GradebookEntriesApi(config);
            var edFiGradebookEntry = new EdFiGradebookEntry(); // EdFiGradebookEntry | The JSON representation of the \"gradebookEntry\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostGradebookEntry(edFiGradebookEntry);
            }
            catch (ApiException  e)
            {
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostGradebookEntryWithHttpInfo(edFiGradebookEntry);
}
catch (ApiException e)
{
...
# **PutGradebookEntry**
> void PutGradebookEntry (string id, EdFiGradebookEntry edFiGradebookEntry, string? ifMatch = null)
...
namespace Example
{
    public class PutGradebookEntryExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutGradebookEntry(id, edFiGradebookEntry, ifMatch);
            }
            catch (ApiException  e)
            {
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutGradebookEntryWithHttpInfo(id, edFiGradebookEntry, ifMatch);
}
catch (ApiException e)
{
