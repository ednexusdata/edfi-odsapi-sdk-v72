# EdFi.OdsApi.Sdk.v72.Apis.All.GraduationPlansApi
...
<a id="deletegraduationplanbyid"></a>
...
namespace Example
{
    public class DeleteGraduationPlanByIdExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new GraduationPlansApi(config);
...
#### Using the DeleteGraduationPlanByIdWithHttpInfo variant
...
{
    // Deletes an existing resource using the resource identifier.
    apiInstance.DeleteGraduationPlanByIdWithHttpInfo(id, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling GraduationPlansApi.DeleteGraduationPlanByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="deletesgraduationplans"></a>
# **DeletesGraduationPlans**
> List&lt;TrackedChangesEdFiGraduationPlanDelete&gt; DeletesGraduationPlans (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, bool? useSnapshot = null)
...
namespace Example
{
    public class DeletesGraduationPlansExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiGraduationPlanDelete> result = apiInstance.DeletesGraduationPlans(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
#### Using the DeletesGraduationPlansWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiGraduationPlanDelete>> response = apiInstance.DeletesGraduationPlansWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
{
    Debug.Print("Exception when calling GraduationPlansApi.DeletesGraduationPlansWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="getgraduationplans"></a>
# **GetGraduationPlans**
> List&lt;EdFiGraduationPlan&gt; GetGraduationPlans (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? graduationPlanTypeDescriptor = null, long? educationOrganizationId = null, int? graduationSchoolYear = null, string? totalRequiredCreditTypeDescriptor = null, string? id = null, bool? individualPlan = null, double? totalRequiredCreditConversion = null, double? totalRequiredCredits = null, bool? useSnapshot = null)
...
namespace Example
{
    public class GetGraduationPlansExample
    {
        public static void Main()
        {
            ...
            var individualPlan = true;  // bool? | An indicator of whether the graduation plan is tailored for an individual. (optional) 
            var totalRequiredCreditConversion = 1.2D;  // double? | Conversion factor that when multiplied by the number of credits is equivalent to Carnegie units. (optional) 
            var totalRequiredCredits = 1.2D;  // double? | The value of credits or units of value awarded for the completion of a course. (optional) 
            var useSnapshot = false;  // bool? | Indicates if the configured Snapshot should be used. (optional)  (default to false)
...
#### Using the GetGraduationPlansWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiGraduationPlan>> response = apiInstance.GetGraduationPlansWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, graduationPlanTypeDescriptor, educationOrganizationId, graduationSchoolYear, totalRequiredCreditTypeDescriptor, id, individualPlan, totalRequiredCreditConversion, totalRequiredCredits, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling GraduationPlansApi.GetGraduationPlansWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="getgraduationplansbyid"></a>
# **GetGraduationPlansById**
> EdFiGraduationPlan GetGraduationPlansById (string id, string? ifNoneMatch = null, bool? useSnapshot = null)
...
namespace Example
{
    public class GetGraduationPlansByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiGraduationPlan result = apiInstance.GetGraduationPlansById(id, ifNoneMatch, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the GetGraduationPlansByIdWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiGraduationPlan> response = apiInstance.GetGraduationPlansByIdWithHttpInfo(id, ifNoneMatch, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling GraduationPlansApi.GetGraduationPlansByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="keychangesgraduationplans"></a>
# **KeyChangesGraduationPlans**
> List&lt;TrackedChangesEdFiGraduationPlanKeyChange&gt; KeyChangesGraduationPlans (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, bool? useSnapshot = null)
...
namespace Example
{
    public class KeyChangesGraduationPlansExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiGraduationPlanKeyChange> result = apiInstance.KeyChangesGraduationPlans(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling GraduationPlansApi.KeyChangesGraduationPlans: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the KeyChangesGraduationPlansWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiGraduationPlanKeyChange>> response = apiInstance.KeyChangesGraduationPlansWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling GraduationPlansApi.KeyChangesGraduationPlansWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="postgraduationplan"></a>
# **PostGraduationPlan**
> void PostGraduationPlan (EdFiGraduationPlan edFiGraduationPlan)
...
namespace Example
{
    public class PostGraduationPlanExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new GraduationPlansApi(config);
            var edFiGraduationPlan = new EdFiGraduationPlan(); // EdFiGraduationPlan | The JSON representation of the \"graduationPlan\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostGraduationPlan(edFiGraduationPlan);
            }
            catch (ApiException  e)
            {
...
#### Using the PostGraduationPlanWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostGraduationPlanWithHttpInfo(edFiGraduationPlan);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling GraduationPlansApi.PostGraduationPlanWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="putgraduationplan"></a>
# **PutGraduationPlan**
> void PutGraduationPlan (string id, EdFiGraduationPlan edFiGraduationPlan, string? ifMatch = null)
...
namespace Example
{
    public class PutGraduationPlanExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutGraduationPlan(id, edFiGraduationPlan, ifMatch);
            }
            catch (ApiException  e)
            {
...
#### Using the PutGraduationPlanWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutGraduationPlanWithHttpInfo(id, edFiGraduationPlan, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling GraduationPlansApi.PutGraduationPlanWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
