# EdFi.OdsApi.Sdk.v72.Apis.All.StudentProgramAttendanceEventsApi
...
<a id="deletestudentprogramattendanceeventbyid"></a>
...
namespace Example
{
    public class DeleteStudentProgramAttendanceEventByIdExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new StudentProgramAttendanceEventsApi(config);
...
#### Using the DeleteStudentProgramAttendanceEventByIdWithHttpInfo variant
...
{
    // Deletes an existing resource using the resource identifier.
    apiInstance.DeleteStudentProgramAttendanceEventByIdWithHttpInfo(id, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling StudentProgramAttendanceEventsApi.DeleteStudentProgramAttendanceEventByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="deletesstudentprogramattendanceevents"></a>
# **DeletesStudentProgramAttendanceEvents**
> List&lt;TrackedChangesEdFiStudentProgramAttendanceEventDelete&gt; DeletesStudentProgramAttendanceEvents (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, bool? useSnapshot = null)
...
namespace Example
{
    public class DeletesStudentProgramAttendanceEventsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiStudentProgramAttendanceEventDelete> result = apiInstance.DeletesStudentProgramAttendanceEvents(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
#### Using the DeletesStudentProgramAttendanceEventsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiStudentProgramAttendanceEventDelete>> response = apiInstance.DeletesStudentProgramAttendanceEventsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
...
{
    Debug.Print("Exception when calling StudentProgramAttendanceEventsApi.DeletesStudentProgramAttendanceEventsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="getstudentprogramattendanceevents"></a>
# **GetStudentProgramAttendanceEvents**
> List&lt;EdFiStudentProgramAttendanceEvent&gt; GetStudentProgramAttendanceEvents (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? attendanceEventCategoryDescriptor = null, DateOnly? eventDate = null, long? educationOrganizationId = null, long? programEducationOrganizationId = null, string? programName = null, string? programTypeDescriptor = null, string? studentUniqueId = null, string? educationalEnvironmentDescriptor = null, string? attendanceEventReason = null, double? eventDuration = null, string? id = null, int? programAttendanceDuration = null, bool? useSnapshot = null)
...
#### Using the GetStudentProgramAttendanceEventsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiStudentProgramAttendanceEvent>> response = apiInstance.GetStudentProgramAttendanceEventsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, attendanceEventCategoryDescriptor, eventDate, educationOrganizationId, programEducationOrganizationId, programName, programTypeDescriptor, studentUniqueId, educationalEnvironmentDescriptor, attendanceEventReason, eventDuration, id, programAttendanceDuration, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling StudentProgramAttendanceEventsApi.GetStudentProgramAttendanceEventsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="getstudentprogramattendanceeventsbyid"></a>
# **GetStudentProgramAttendanceEventsById**
> EdFiStudentProgramAttendanceEvent GetStudentProgramAttendanceEventsById (string id, string? ifNoneMatch = null, bool? useSnapshot = null)
...
namespace Example
{
    public class GetStudentProgramAttendanceEventsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiStudentProgramAttendanceEvent result = apiInstance.GetStudentProgramAttendanceEventsById(id, ifNoneMatch, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the GetStudentProgramAttendanceEventsByIdWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiStudentProgramAttendanceEvent> response = apiInstance.GetStudentProgramAttendanceEventsByIdWithHttpInfo(id, ifNoneMatch, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling StudentProgramAttendanceEventsApi.GetStudentProgramAttendanceEventsByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="keychangesstudentprogramattendanceevents"></a>
# **KeyChangesStudentProgramAttendanceEvents**
> List&lt;TrackedChangesEdFiStudentProgramAttendanceEventKeyChange&gt; KeyChangesStudentProgramAttendanceEvents (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, bool? useSnapshot = null)
...
namespace Example
{
    public class KeyChangesStudentProgramAttendanceEventsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiStudentProgramAttendanceEventKeyChange> result = apiInstance.KeyChangesStudentProgramAttendanceEvents(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling StudentProgramAttendanceEventsApi.KeyChangesStudentProgramAttendanceEvents: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the KeyChangesStudentProgramAttendanceEventsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiStudentProgramAttendanceEventKeyChange>> response = apiInstance.KeyChangesStudentProgramAttendanceEventsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling StudentProgramAttendanceEventsApi.KeyChangesStudentProgramAttendanceEventsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="poststudentprogramattendanceevent"></a>
# **PostStudentProgramAttendanceEvent**
> void PostStudentProgramAttendanceEvent (EdFiStudentProgramAttendanceEvent edFiStudentProgramAttendanceEvent)
...
namespace Example
{
    public class PostStudentProgramAttendanceEventExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new StudentProgramAttendanceEventsApi(config);
            var edFiStudentProgramAttendanceEvent = new EdFiStudentProgramAttendanceEvent(); // EdFiStudentProgramAttendanceEvent | The JSON representation of the \"studentProgramAttendanceEvent\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostStudentProgramAttendanceEvent(edFiStudentProgramAttendanceEvent);
            }
            catch (ApiException  e)
            {
...
#### Using the PostStudentProgramAttendanceEventWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostStudentProgramAttendanceEventWithHttpInfo(edFiStudentProgramAttendanceEvent);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling StudentProgramAttendanceEventsApi.PostStudentProgramAttendanceEventWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="putstudentprogramattendanceevent"></a>
# **PutStudentProgramAttendanceEvent**
> void PutStudentProgramAttendanceEvent (string id, EdFiStudentProgramAttendanceEvent edFiStudentProgramAttendanceEvent, string? ifMatch = null)
...
namespace Example
{
    public class PutStudentProgramAttendanceEventExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutStudentProgramAttendanceEvent(id, edFiStudentProgramAttendanceEvent, ifMatch);
            }
            catch (ApiException  e)
            {
...
#### Using the PutStudentProgramAttendanceEventWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutStudentProgramAttendanceEventWithHttpInfo(id, edFiStudentProgramAttendanceEvent, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling StudentProgramAttendanceEventsApi.PutStudentProgramAttendanceEventWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
