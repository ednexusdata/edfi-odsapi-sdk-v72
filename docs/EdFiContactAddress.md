# EdFi.OdsApi.Sdk.v72.Models.All.EdFiContactAddress
...
**Periods** | [**List&lt;EdFiContactAddressPeriod&gt;**](EdFiContactAddressPeriod.md) | An unordered collection of contactAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address. | [optional] 
**Ext** | **Object** | Extensions to the ContactAddress entity. | [optional] 
